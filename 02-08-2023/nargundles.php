...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/170x60-logo.jpg" type="image/x-icon">
  <meta name="description" content="School and college Management Software">
  
  
  <title>Evi Institute Management Application</title>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu2 cid-thKgVwkeGX" once="menu" id="menu2-0">
    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container">
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="https://mobiri.se">
                        <img src="assets/images/170x60-logo.jpg" alt="Mobirise" style="height: 3rem;">
                    </a>
                </span>
                <span class="navbar-caption-wrap"><a class="navbar-caption text-black text-primary display-7" href="tel:8050482213">E VISION INFOTECH&nbsp; ( 8050482213 )</a></span>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black text-primary display-4" href="https://docs.google.com/forms/d/e/1FAIpQLSeNmAzsAr08mOn_rsR2IkvWhR261Pr4IsWSAzQ5liYHeVhsXA/viewform" target="_blank">
                            Signup</a></li>
                    
                    <li class="nav-item"><a class="nav-link link text-black text-primary display-4" href="https://smsoft.in/demo/school-login.php" target="_blank">&nbsp;Login</a>
                    </li></ul>
                
                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-primary display-4" href="assets/files/evi-OnlineStudentManagmentBroucher.pdf">
                        Download Now</a></div>
            </div>
        </div>
    </nav>
...
<section data-bs-version="5.1" class="header15 cid-thKhmgkgdi" id="header15-2">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md">
                <div class="text-wrapper">
                    <h2 class="mbr-section-title mb-3 mbr-fonts-style display-2"><strong>E VISION INFOTECH</strong></h2>
                    <p class="mbr-text mb-3 mbr-fonts-style display-7"><strong>Institute Management
</strong><br>Software for School and Collage
<br>Start Your Digital Journey.<br><br><br><br></p>
                    <div class="mbr-section-btn"><a class="btn btn-primary display-4" href="assets/files/evi-OnlineStudentManagmentBroucher.pdf">More</a></div>
                </div>
            </div>
            <div class="mbr-figure col-12 col-md-7"><iframe class="mbr-embedded-video" src="https://www.youtube.com/embed/msaHcx85aZM?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0" width="1280" height="720" frameborder="0" allowfullscreen></iframe></div>
        </div>
    </div>
</section>

<section data-bs-version="5.1" class="video3 cid-thKh7mOFjW" id="video3-1">
    
    
    <div class="container">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style mb-0 display-2"><strong>Demo of Modules</strong></h4>
            
        </div>
        <div class="row mt-4">
            <div class="col-12 col-md-6 video-block">
                <div class="video-wrapper"><iframe class="mbr-embedded-video" src="https://www.youtube.com/embed/j-DcVj61Kec?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0" width="1280" height="720" frameborder="0" allowfullscreen></iframe></div>
                <p class="mbr-text pt-2 mbr-fonts-style display-4">
                    Fees Management Section</p>
            </div>
            <div class="col-12 col-md-6 video-block">
                <div class="video-wrapper"><iframe class="mbr-embedded-video" src="https://www.youtube.com/embed/EGRGvJ8H5h8?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0" width="1280" height="720" frameborder="0" allowfullscreen></iframe></div>
                <p class="mbr-text pt-2 mbr-fonts-style display-4">
                    Student Management Section</p>
            </div>
        </div>
    </div>
</section>

<section data-bs-version="5.1" class="content4 cid-thRizOxgHR" id="content4-6">
        ...
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2">
                    <strong>Click Here for :&nbsp;<a href="assets/files/Brouchers-KS..pdf" class="text-primary">More Details&nbsp;</a></strong><br></h3>
...
<section data-bs-version="5.1" class="gallery2 cid-thKn7pBBni" id="gallery2-4">
    
    
    <div class="container">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>&nbsp;Documents</strong></h4>
            <h5 class="mbr-section-subtitle mbr-fonts-style align-center mb-0 mt-2 display-7">
                ( These certificates can modify according to your requirements)&nbsp;</h5>
        </div>
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/tc1.png" alt="" data-slide-to="0" data-bs-slide-to="0">
                    </div>
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="assets/files/TC-ORLC.pdf" class="btn btn-primary item-btn display-7" target="_blank">View</a></div>
                </div>
            </div>
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/bonified1.png" alt="" data-slide-to="1" data-bs-slide-to="1">
                    </div>
                    <div class="item-content">
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="assets/files/Bonifide-Certificate.pdf" class="btn btn-primary item-btn display-7" target="_blank">View</a></div>
                </div>
            </div>
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/conductcertificate.png" alt="" data-slide-to="2" data-bs-slide-to="2">
                    </div>
                    <div class="item-content">
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="assets/files/Conduct-certificate.pdf" class="btn btn-primary item-btn display-7" target="_blank">View</a></div>
                </div>
            </div>
            <div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/study-certificate.png" alt="" title="" data-slide-to="3" data-bs-slide-to="3">
                    </div>
                    <div class="item-content">
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="assets/files/Study-Certificate.pdf" class="btn btn-primary item-btn display-7" target="_blank">View</a></div>
                </div>
            </div><div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/no-objection-certificate.png" alt="" title="" data-slide-to="4" data-bs-slide-to="4">
                    </div>
                    <div class="item-content">
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="assets/files/NO-OBJECTIONCERTIFICATE.pdf" class="btn btn-primary item-btn display-7" target="_blank">View</a></div>
                </div>
            </div><div class="item features-image сol-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/sms.png" alt="" title="" data-slide-to="5" data-bs-slide-to="5">
                    </div>
                    <div class="item-content">
                    ...
                    <div class="mbr-section-btn item-footer mt-2"><a href="assets/files/sms.pdf" class="btn btn-primary item-btn display-7" target="_blank">View</a></div>
                </div>
            </div>
        </div>
    </div>
...
<section data-bs-version="5.1" class="footer6 cid-thRerv6xhk" once="footers" id="footer6-5">
    ...
    <div class="container">
        <div class="row content mbr-white">
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                ...
                <p class="mbr-text mbr-fonts-style display-7">Navanagar - Hubli</p> <br>
                <h5 class="mbr-section-subtitle mbr-fonts-style mb-2 mt-4 display-7">
                    <strong>Contacts</strong>
                </h5>
                <p class="mbr-text mbr-fonts-style mb-4 display-7">
                    Email: info@evisioninfotech@gmail.com<br>Phone: +8050482213<br>
                    Fax: + 8951182860</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <h5 class="mbr-section-subtitle mbr-fonts-style mb-2 display-7">
                    <strong>Our other Products</strong></h5>
                <ul class="list mbr-fonts-style mb-4 display-4">
                    <li class="mbr-text item-wrap"><a href="https://evisioninfotech.in/" class="text-primary">Hardware Products</a></li>
                    <li class="mbr-text item-wrap"><a href="https://eviengapp.in/" class="text-primary">English Learning app&nbsp;</a></li>
                    <li class="mbr-text item-wrap"><a href="http://job.evisioninfotech.in/" class="text-primary">Teacher Job Placement</a></li>
                </ul>
            ...
            <div class="col-12 col-md-6">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCZI5F_k6S1k46ujh0SNrapM89f7mJxd30&amp;q= namoruth hubli near Navanagar, Hubballi, Karnataka" allowfullscreen=""></iframe></div>
            </div>
            <div class="col-md-6">
