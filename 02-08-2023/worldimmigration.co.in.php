    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if (isset($_GET["cat_id"])) {
                ...
                $record = $obj->selectDataAll("gallery", $where);
            ...
            ?>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        ...
                        <p>
                            ...
                            <a href="images/<?php echo $row["img"]; ?>" rel="lightbox-journey"> <img style="width:100%;border-radius:10px;height:300px;object-fit: cover;" src="images/<?php echo $row["img"]; ?>" alt="Thumb-1"></a>
