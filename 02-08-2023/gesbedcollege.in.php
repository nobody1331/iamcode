...
<html>
<head>
<title>GOKAK EDUCATION SOCIETY’S, COLLEGE OF EDUCATION (B.ED), GOKAK </title>
		...
		<div class="header">
		   ...
		   <div class="menu">
				<ul>
				 ...
				 <li><a href="Documents.html">Gallery </a></li>
					...
					<div class="html_carousel">
						<div id="foo3">
							<div class="slide">
								...
								<div>
									<h4>Wel come to College</h4>
									<p>Weling to the college by Principal</p>
								</div>
							</div>
							<div class="slide">
								...
								<div>
									<h4>Take the oath </h4>
									<p>Take the oath of beging </p>
								</div>
							</div>
							<div class="slide">
								<img src="images/e3.jpg" alt="carousel 3" width="1000" height="450" />
								<div>
									<h4>Celebration of the Festival</h4>
									<p>Celebration with Lighten</p>
								</div>
							</div>
							<div class="slide">
								...
								<div>
									...
									<p>Opening Ceremony    civilization Function</p>
							</div>
						</div>
						</div>
						</div>
   		...
   		<div class="about-top">
   			<div class="about-left">
   			   ...
   			   <div class="left-img">
   			    ...
   			    <div class="left-desc">
   			    	<p>Our esteemed Gokak Education Society was established in 1965 by Shri. Siddaram Swamiji of Savalagimath, Shri Shivand Swamiji of Arabhavimath, Shri Pavadeppa Swamiji of Maradimath and Philanthropic people like Shri D. R. Jadhav, Shri. B. S. Munavalli, Shri. S. R. Patil, Dr. A. R. Kadakol, Dr. B. C. Ajari and Dr. C. P. Pattanshetty of Gokak for the noble cause of disseminating knowledge. G.E.S “COLLEGE OF EDUCATION”  </p>
   			    </div>
   			   <p>The college has equipped Science & Mathematics Resource Center , Psychology Resource Center , ICTE Resource Center and many more . Each laboratory is having the capacity of accommodating nearly 50 students to undertake the practical work at a time. It has also established the Computer Laboratory, possessing 25 set of systems to conduct the Practical  for students.  The college has wi-fi zone and latest technology interactive boards for teaching</p>
   			   <div class="border"> </div>
   			    <div class="left-bot-img">
   			    	<h3>Aims & Objectives </h3>
   			   	 	<p>To establish Colleges, Schools and other educational institutions of various kinds in important places as may be determined from time to time by the society at a meeting of the general body by a majority vote of 2/3rd of members present, subject to the approval of Board of Trustees..</p>
   			   	 	
   			   	 	<div class="icon">
   			   	 		<img src="images/a.png" alt=""/>
   			   	 	</div>
   			   	 	<div class="icon-desc">
   			   	 		<p>Local Self Government for purposes of subject to the approval of the Board of Trustees.	</p>
   			   	 	</div>
   			   	 	<div class="clearfix"></div>
   			   	 	...
   			   	 	<div class="icon-desc">
   			   	 		...
   			   	 		<p>To spread education in general and impart institution in any branch of knowledge, wherever and whenever feasible.</p>
   			   	 	</div>
   			   </div>
   			   <div class="left-desc">
   			   	    <h3>Mission & Goals</h3>
   			   	    <img src="images/pic5.jpg" alt=""/>
   			    	<p>To generate knowledge by providing higher education for rural youths particularly to the downtrodden  section of the society and women . Committed to develop employability skills among youths.</p>
   		    ...
   		    <div class="about-right">
   			   ...
   			   <p>The college is established in 2005 ,it is situated on the slope of  Mallikarjun Hill bank of Ghataprabha river with beautiful nature . The college has well qualified teaching staff  and beautiful building , with well equipped all academic laboratories. with 3700 no of books and Journals, periodicals and magazines .In our college we have many associations and club to develop the all round development of students.</p>
   			    <div class="border"> </div>
				
   			      
				  
   			      <h4><a href="founder.html" target="_blank class="link1">Founders</a><br></h4>
				  <BR>
				  <h4><a href="OtherInstitutes.html" target="_blank class="link1">Other Institutes</a><br></h4>
				  <BR>
				  <h4><a href="Dcouments1\College Emblem.pdf" target="_blank class="link1">College Emblem</a><br></h4>
				  <BR>
				   <h4><a href="Dcouments1\Cell Info.pdf" target="_blank class="link1">Departments </a><br></h4>	
				   <BR>
				   <h4><a href="Dcouments1\LiBRARY Management.pdf" target="_blank class="link1">LIBRARY  </a><br></h4>
...
<div class="wrap">
	<div class="footer-text">
		<div class="copy">
	         <p>&copy; 2016 All rights Reserved | Design by <a href="http://evisioninfotech.in">E vision infotech</a></p>
        </div>
	<div class="subcribe">
