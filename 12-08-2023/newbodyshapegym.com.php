...
<head>
<meta charset="utf-8">
<title>Welcom ToNew Body Shape Gym and Fitness Center - nava vadaj, Ahmedabad</title>
	<?php include('links.php') ?>
	 <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css" />

	  <style type="text/css">
  	.featured-block-two  .text, .news-block-three .text{
   overflow: hidden;
   display: -webkit-box;
    ...
    <section class="main-slider-two">
        ...
        <div class="main-slider-carousel owl-carousel owl-theme">
            ...
            <div class="slide" style="background-image:url(images/main-slider/image-3.jpg)">
                ...
                <div class="auto-container">
					...
					<div class="content-boxed">
						...
						<h1>Best Gyms<br>New Body Shape Gym <br>and Fitness Center</h1>
            ...
            <div class="slide" style="background-image:url(images/main-slider/image-2.jpg)">
                ...
                <div class="auto-container">
					...
					<div class="content-boxed">
						<div class="title">Runner’s Life</div>
						<h1>Strong , is <br> The New <br> .Skinny</h1>
						<div class="link-box clearfix">
							<div class="btn-one-outer"><a href="#" class="theme-btn btn-style-one"><span class="txt">Join Us Now</span></a></div>
						</div>
						<!-- <a href="https://www.youtube.com/watch?v=kxPCFljwJws" class="lightbox-image video-box"><span class="fa fa-play"><i class="ripple"></i></span></a> -->
			...
			<div class="slide" style="background-image:url(images/main-slider/image-4.jpg)">
                ...
                <div class="auto-container">
					...
					<div class="content-boxed">
						<div class="title">Runner’s Life</div>
						<h1>Life is short <br> Lift heavy <br> .Things</h1>
						<div class="link-box clearfix">
							<div class="btn-one-outer"><a href="#" class="theme-btn btn-style-one"><span class="txt">Join Us Now</span></a></div>
						</div>
						<!-- <a href="https://www.youtube.com/watch?v=kxPCFljwJws" class="lightbox-image video-box"><span class="fa fa-play"><i class="ripple"></i></span></a> -->
		...
		<div class="social-box">
			<ul>
				...
				<li><a href="https://www.facebook.com/newbodyshapegym/?id=100088309854579"><i class="fa-brands fa-facebook-f"></i></a></li>
				<li><a href="https://www.instagram.com/newbodyshapegym/?fbclid=IwAR1k4HYCDVg2MvG_KaKJ44IWHiRtRDNPUkPQyKDtkOSo_P-y3_uvbA0Hwtc"><i class="fa-brands fa-instagram"></i></a></li>
				<!-- <li><a href="https://www.facebook.com/profile.php?id=100088309854579"><i class="fa-brands fa-whatsapp"></i></a></li> -->
					...
					<div class="form-column col-lg-8 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="default-form style-three">
								...
								<!-- Default Form -->
									...
									<div class="row clearfix">
										...
										<div class="form-group col-lg-4 col-md-6 col-sm-12">
											<div class="btn-two-outer"><button class="theme-btn btn-style-two" id="submit" onclick="calculate();"><span class="txt">Calculate</span></button></div>
										</div>
							...
							<div class="result">
								            ...
								            <p class="col-md-4">Your BMI is</p>
								            <div class="col-md-4" id="result">00.00</div>
								            </div>
								            <p class="comment"></p>
								        </div>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="images-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="info-box">
							<h3><a href="services.php">Cardio <br> Training</a></h3>
							<a class="more" href="services.php">More <span class="arrow fa fa-arrow-circle-right"></span></a>
							<div class="icon flaticon-stationary-bike"></div>
						</div>
						
						<div class="info-box style-two">
							<h3><a href="services.php">Fitness <br> Training</a></h3>
							<a class="more" href="services.php">More <span class="arrow fa fa-arrow-circle-right"></span></a>
					...
					<div class="inner-column">
						...
						<div class="featured-block">
							<div class="block-inner">
								...
								<strong>State-of-the-art equipment that's always clean and well-maintained</strong>
								<!-- <div class="feature-text">State-of-the-art equipment that's always clean and well-maintained.</div> -->
							</div>
						</div>
						...
						<div class="featured-block">
							<div class="block-inner">
								...
								<strong>Expert personal trainers to guide and motivate you</strong>
						...
						<div class="featured-block">
							<div class="block-inner">
								...
								<strong>Convenient location and hours to fit your busy schedule</strong>
								<!-- <div class="feature-text">Our personal trainers will help you find a perfect workout.</div> -->
							</div>
						</div>
      	...
      	<!-- Featured Block Two -->
				<div class="featured-block-two ">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<a href="services-detail.php?slug=<?php echo $row['p_id']; ?>"><img src="admin/upload/<?php echo$row['parts_image']; ?>" alt="" /></a>
						
						</div>
						<div class="lower-content">
							<div class="title"><?php echo $row['status']; ?></div>
							<h4><a href="services-detail.php?slug=<?php echo $row['p_id']; ?>"><?php echo $row['short_desc']; ?></a></h4>
							<div class="text"><?php echo $row['desc']; ?></div>
							<a class="read-more" href="services-detail.php?slug=<?php echo $row['p_id']; ?>">Read More</a>
						</div>
					</div>
				</div>
			...
			<div class="inner-container">
				...
				<div class="fact-counter">
					<div class="row clearfix">
						...
						<!-- Column -->
						<div class="column counter-column col-lg-3 col-md-6 col-6">
							...
							<div class="inner wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
								<div class="content">
									...
									<div class="count-outer count-box alternate">
										<span class="count-text" data-speed="2500" data-stop="10000">0</span>+
									</div>
						...
						<div class="column counter-column col-lg-3 col-md-6 col-6">
							<div class="inner wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
								<div class="content">
									...
									<div class="count-outer count-box">
										<span>Exclusive branch</span>
									</div>
									<!--<div class="counter-title">Exclusive branch</div>-->
								</div>
							</div>
						</div>
					...
					<div class="table-inner">
						...
						<div class="timetable-tabs tabs-box">
							...
							<ul class="tab-btns tab-buttons clearfix">
								<li data-tab="#prod-cardio" class="tab-btn active-btn">Time</li>
								...
								<div class="tab active-tab" id="prod-cardio">
									<div class="content">
										<div class="clearfix">
											...
											<div class="time-box">
												<div class="box-inner">
													<div class="time">GYM OPEN <span>6:00 am  -  1:30 pm<br>5:00 pm  -  10:00 pm</span></div>
												</div>
											</div>
											...
											<div class="time-box">
												<div class="time" style="color:red; font-size: 26px; font width: bold; padding-left: 10px">Close</div>
											</div>
							...
							<div class="single-item-carousel owl-carousel owl-theme">
								...
								<div class="testimonial-block-two">
									<div class="inner-box">
										...
										<div class="text">This is my first experience in gym and it totally worth it when I spend my time doing exercises and further the gym trainers are so humble with everyone. If you really wanna join the best gym near you newbody shape is best because it have a big balcony and they have much space and I suggest that you should join this gym it’s totally worth it. </div>
									</div>
								</div>
								...
								<div class="testimonial-block-two">
									<div class="inner-box">
										...
										<div class="quote-icon flaticon-right-quote"></div>
										<div class="text">The thing i appreciate about the gym that they push me to my limits and i really that the thing
										Seeing after reviews  i will say do matter but what matter the most is trainer who is helping  me to get in shape
										Its just an excuse by complaining about equipment and trainers untill an unless we are willing to work out seriously</div>
									</div>
								</div>
								...
								<div class="testimonial-block-two">
									<div class="inner-box">
										...
										<div class="quote-icon flaticon-right-quote"></div>
										<div class="text">Good gym great facility
												Good result proper guidance
												100% recommended</div>
								...
								<div class="testimonial-block-two">
									<div class="inner-box">
										...
										<div class="quote-icon flaticon-right-quote"></div>
										<div class="text">best gym I have experience, before this gym I already did my workout in some other gyms too, but was not satisfied.
											always recommended to those who wants perfect result</div>
									</div>
								</div>
								...
								<div class="testimonial-block-two">
									<div class="inner-box">
										...
										<div class="quote-icon flaticon-right-quote"></div>
										<div class="text">New body Shape gym... Really magical way to get into shape. and I personally felt it. I joined 3 different gyms but in this gym my experience was "WOW".  I reduced my 12 and half KG in this gym in just 2 and half months. I was really happy with the results. Thank you for giving me this happy light weight life. :😊👍Mostly good think is gyms trainers specially mr. Kalpesh sir they all are really helpful in reducing weight loss ...thank you so much</div>
									</div>
								</div>
								...
								<div class="testimonial-block-two">
									<div class="inner-box">
										...
										<div class="quote-icon flaticon-right-quote"></div>
										<div class="text">I have increased 10 kg in last 4 months, definitely got result, best trainers and staff.
										Good gym</div>
									</div>
								</div>
							</div>
	...
	<section class="pricing-section">
		...
		<div class="auto-container">
			...
			<div class="sec-title light centered">
				...
				<h2>We Offer you  <br> Our Plans</h2>
			</div>
			<div class="row clearfix">
					...
					<div class="inner-box" style="background-image:url(images/resource/price-3.jpg)">
						<h4>Pakage</h4>
						<div class="title">For 1 Month</div>
						...
						<div class="btn-one-outer"><a href="contact.php" class="theme-btn btn-style-one" type="submit"><span class="txt">Join Now</span></a></div>
					</div>
				</div>
				...
				<div class="pricing-block col-lg-3 col-md-6 col-sm-12">
					...
					<h4>Pakage</h4>
						<div class="title">For 3 Months</div>
				...
				<div class="pricing-block col-lg-3 col-md-6 col-sm-12">
					...
					<h4>Pakage</h4>
						<div class="title">For 6 Months</div>
				...
				<div class="pricing-block col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box" style="background-image:url(images/resource/price-3.jpg)">
					<h4>Pakage</h4>
						<div class="title">For 1 Year</div>
		...
		<div class="auto-container">
			...
			<?php
		                  $sql="SELECT * FROM `blog` order by id desc limit 3";
		                    ...
		                    {
		                ?>
						<div class="col-md-4 news-block-three">
							<div class="inner-box">
								<div class="image">
									<a href="blog-single.php?slug=<?php echo $row['id']; ?>"><img src="admin/upload/<?php echo$row['image']; ?>" alt="" /></a>
								</div>
								<div class="lower-content">
									<ul class="post-meta">
										
										<li><span class="icon flaticon-user-1"></span> By <?php echo $row['post_by']; ?></li>
										
										<li><span class="icon flaticon-calendar-1"></span> <?php echo $row['post_date']; ?></li>
									</ul>
									<h3><a href="blog-single.php?slug=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a></h3>
									<div class="text"><?php echo $row['post_desc']; ?></div>
									<a class="read-more" href="blog-single.php?slug=<?php echo $row['id']; ?>">Read More</a>
								</div>
							</div>
						</div>
					  <?php } ?>	
...
function calculate(){
  ...
  if(height.value==''){
    ...
    modalText.innerHTML = `Please Enter Your height`;
}
  else if(weight.value==''){
  	 modal.style.display = "block";
    modalText.innerHTML = `Please Enter Your weight`;
  }
  else if(age.value==''){
  	 modal.style.display = "block";
    modalText.innerHTML = `Please Enter Your Age`;
  }
  else if((male.selected==false && female.selected==false)){
  	 modal.style.display = "block";
    modalText.innerHTML = `Please Enter Gender`;
  }
 else{
    countBmi();
  }
