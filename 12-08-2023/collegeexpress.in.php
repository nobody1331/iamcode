...
<head>
    ...
    <meta name="author" content="College Express">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">

    <title>College Express | Home</title>
                    ...
                    <div class="section-heading">
                        <h2 class="section__title text-white fs-55 lh-60 pb-3 cd-headline zoom">
                            ...
                            <span class="cd-words-wrapper">
                                <b class="is-visible">Engineering</b>
                                <b>Medical</b>
                                <b>Arts & Humanities</b>
                        ...
                        <p class="section__desc text-white pb-4">A One-Stop Solution for Your Education Needs!
                        </p>
            ...
            <div class="row feature-content-wrap">
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <h3 class="info__title">Free counselling</h3>
                        <p class="info__text">Get free counselling for the initial sessions regarding your higher education dreams. </p>
                    </div>
                    <!-- end info-box -->
                </div>
                <!-- end col-lg-3 -->
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <h3 class="info__title">Expert Mentorship</h3>
                        <p class="info__text">We provide one on one mentorship to all your high education doubts. Get in touch with experienced professionals. </p>
                    </div>
                    <!-- end info-box -->
                </div>
                <!-- end col-lg-3 -->
                <div class="col-lg-4 responsive-column-half">
                    <div class="info-box">
                        ...
                        <h3 class="info__title">Admission Guidance</h3>
                        <p class="info__text">Are you seeking guidance for getting admitted to the college of your dreams? We can help you out.</p>
                    </div>
                    <!-- end info-box -->
                </div>
                <!-- end col-lg-3 -->
    ...
    <section class="category-area pb-90px">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-9">
                    <div class="category-content-wrap">
                        <div class="section-heading">
                            <h5 class="ribbon ribbon-lg mb-2">Courses</h5>
                ...
                <div class="col-lg-3">
                    <div class="category-btn-box text-right">
                        <a href="courses.php" class="btn theme-btn">All Courses <i class="la la-arrow-right icon ml-1"></i></a>
                    </div>
            ...
            <div class="category-wrapper mt-30px">
                <div class="row">
                <?php
                    $sql_category="select * from category where status=1 limit 0,8";
                    $query_category=mysqli_query($conn,$sql_category);
                    if(mysqli_num_rows($query_category)>0){
                        while($res_category=mysqli_fetch_array($query_category)){
                            ?>
                    <div class="col-lg-3 responsive-column-half">
                        <div class="category-item category-item-layout-2">
                            <a href="colleges.php?cat_id=<?php echo $res_category['id']; ?>" class="category-content">
                                <div class="icon-element icon-element-md shadow-sm text-color">
                                    <div class="streamIcon" style="background-image:url(upload/category/<?php echo $res_category['img']; ?>);     background-size: 40px 40px;"></div>
                                </div>
                                <h3 class="cat__title"><?php echo $res_category['name']; ?></h3>
    ...
    <section class="course-area pb-120px">
        <div class="container">
            <div class="section-heading text-center">
                <h5 class="ribbon ribbon-lg mb-2">Choose your dream college</h5>
        ...
        <div class="card-content-wrapper bg-gray pt-50px pb-50px">
            <div class="container">
                <div class="row">
                    <?php
                    $sql_college="select * from college where status=1 limit 0,9";
                    $query_college=mysqli_query($conn,$sql_college);
                    if(mysqli_num_rows($query_college)>0){
                        while($res_college=mysqli_fetch_array($query_college)){
                            $colleges = strtolower($res_college['name']);

                            $college = cleanStr($colleges) . '-' . $res_college['id'];
                            ?>
                                <div class="col-lg-4 responsive-column-half">
                        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_2_<?php echo $res_college['id']; ?>">
                            <div class="card-image">
                                <a href="details.php?college=<?php echo $college; ?>" class="d-block">
                                    <img class="card-img-top lazy" src="upload/college/<?php echo $res_college['img'] ; ?>" data-src="upload/college/<?php echo $res_college['img'] ; ?>" alt="<?php echo $res_college['name']; ?>">
                                </a>
                            </div>
                            <!-- end card-image -->
                            <div class="card-body">
                                <h5 class="card-title text-capitalize"><a href="details.php?college=<?php echo $college; ?>"><?php echo $res_college['name'] ; ?></a></h5>
                            </div>
                            <!-- end card-body -->
                        </div>
                        <!-- end card -->
                ...
                <div class="more-btn-box mt-4 text-center">
                    <a href="colleges.php" class="btn theme-btn">Browse all Colleges <i class="la la-arrow-right icon ml-1"></i></a>
                </div>
                <!-- end more-btn-box -->
            </div>
            <!-- end container -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-3">30</h4>
                        <p class="counter__meta">Connected Colleges</p>
                    </div>
                    <!-- end counter-item -->
                </div>
                <!-- end col-lg-3 -->
                <div class="col-lg-3 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-4">250</h4>
    ...
    <section class="cat-area pt-80px pb-80px bg-gray position-relative">
        ...
        <div class="container">
            <div class="cta-content-wrap text-center">
                <div class="section-heading">
                    <h5 class="ribbon ribbon-lg mb-2">Ask with our experts</h5>
                    <h2 class="section__title fs-45 lh-55">Consult with our best mentor to choose <br>Best College </h2>
                </div>
                <!-- end section-heading -->
                <div class="cat-btn-box mt-28px">
                    <a href="contact.php" class="btn theme-btn"> Consult Now <i class="la la-arrow-right icon ml-1"></i></a>
                </div>
                <!-- end cat-btn-box -->
            </div>
            ...
            <div class="testimonial-carousel owl-action-styled">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <!-- end media -->
                        <p class="card-text">
                            My children and I LOVE College Express! The courses are fantastic and the instructors are so fun and knowledgeable. I only wish we found it sooner.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <!-- end media -->
                        <p class="card-text">
                            No matter what you want to learn, you’ll find an amazing selection of courses here. The instructors are so knowledgable while being fun and interesting. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad blanditiis consectetur
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <!-- end media -->
                        <p class="card-text">
                            I really recommend this site to all my friends and anyone who’s willing to learn real skills. This platform gives you the opportunity to learn from experts at a convenient time.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <!-- end media -->
                        <p class="card-text">
                            Thank you College Express! You've renewed my passion for learning and my dream of becoming a web developer.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <!-- end media -->
                        <p class="card-text">
                            I came across this site when I had no funds to pay for a college education. This site has literally been a lifesaver as I can now earn from freelance working using the skills I learned from here.
                        </p>
                    </div>
                    <!-- end card-body -->
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content pb-5">
                        <div class="section-heading">
                            ...
                            <h2 class="section__title">College Express</h2>
                            <span class="section-divider"></span>
                            <p class="section__desc">
                            College Express is your one stop solution for all your higher education needs. Our expert team of professionals helps you select the right path by evaluating your academic strengths and aligning them with your choice of course and colleges. 
                            </p>
                        </div>
                        <!-- end section-heading -->
                        <div class="row pt-4 pb-3">
                            <div class="col-lg-4 responsive-column-half">
                                <div class="info-icon-box mb-3">
                                    ...
                                    <h4 class="fs-20 font-weight-semi-bold pt-3">Free counselling</h4>
                                </div>
                                <!-- end info-icon-box -->
                            </div>
                            <!-- end col-lg-4 -->
                            <div class="col-lg-4 responsive-column-half">
                                <div class="info-icon-box mb-3">
                                    ...
                                    <h4 class="fs-20 font-weight-semi-bold pt-3">Expert Mentorship</h4>
                                </div>
                                <!-- end info-icon-box -->
                            </div>
                            <!-- end col-lg-4 -->
                            <div class="col-lg-4 responsive-column-half">
                                <div class="info-icon-box mb-3">
                                    ...
                                    <h4 class="fs-20 font-weight-semi-bold pt-3">Admission Guidance</h4>
                                </div>
                                <!-- end info-icon-box -->
                            </div>
                            <!-- end col-lg-4 -->
                        ...
                        <!-- end row -->
                        <div class="btn-box">
                            <a href="#" class="btn theme-btn">Consult Now <i class="la la-arrow-right icon ml-1"></i></a>
                        </div>
                        <!-- end btn-box -->
                    </div>
                    <!-- end about-content -->
                ...
                <div class="col-lg-5 ml-auto">
                    <div class="generic-img-box">
                        <img src="images/img13.jpg" data-src="images/img13.jpg" alt="About image" class="img__item img__item-1 lazy">
                        <img src="images/img14.jpg" data-src="images/img14.jpg" alt="About image" class="img__item img__item-2 lazy">
                    </div>
                    <!-- end generic-img-box -->
                </div>
                <!-- end col-lg-5 -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="fs-24 font-weight-semi-bold pb-2">Talk to our expert </h3>
                ...
                <div class="col-lg-6 ml-auto">
                    <div class="register-content">
                        <div class="section-heading">
                            <h5 class="ribbon ribbon-lg mb-2">Contact</h5>
                            <h2 class="section__title">Get ahead with Learning Paths. Stay Sharp.</h2>
                            <span class="section-divider"></span>
                            <p class="section__desc">We began our journey with the sole aim of helping students find the right college and course for them, while also assisting the colleges in their student recruitment process and have successfully been following it. We believe in giving a gentle push to the future generation of our country by educating them about the pros and cons of each dimension of the college and respective higher degree courses they apply to. If you have any questions or doubts for us, we’d be happy to help. Connect with us on any of our social media channels or contact us to get your free counselling session. </p>
                        </div>
                        <!-- end section-heading -->
                        <div class="btn-box pt-35px">
                            <a href="#" class="btn theme-btn"><i class="la la-user mr-1"></i>Get Started</a>
                        </div>
                    </div>
...
================================= -->
    <section class="client-logo-area pt-50px position-relative overflow-hidden text-center">
        ...
        <div class="container">
            <div class="section-heading">
                <h5 class="ribbon ribbon-lg mb-2">Our Colleges</h5>
                <h2 class="section__title">Top Colleges choose <a href="#" class="text-color hover-underline">College Express for Courses</a> to build
            ...
            <?php
                    $sql_logo="select * from college where status=1 limit 0,8";
                    $query_logo=mysqli_query($conn,$sql_logo);
                    if(mysqli_num_rows($query_logo)>0){
                        while($res_logo=mysqli_fetch_array($query_logo)){
                            if(!empty($res_logo['logo'])){

                            
                            ?>
                <a href="#" class="client-logo-item"><img src="upload/college-logo/<?php echo $res_logo['logo']; ?>" alt="<?php echo $res_logo['name']; ?>"></a>
                <?php } } } ?>
