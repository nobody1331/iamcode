...
require_once './common/common_style.php';
require_once './style_parts/style_index.php';
require_once './common/header.php';
?>
<!-- Main Banner Area Start Here -->
<section class="main-banner-wrap-layout1 bg-common overlay-dark-30 bg--gradient-top-30" data-bg-image="https://www.newsmarttravels.com/customer/banner/kashmirvalley5.jpeg">
    <div class="container">
        <div class="main-banner-box-layout1">
            <p class="item-sub-title">Discover &amp; connect with great places around Jammu & Kashmir</p>
            <h1 class="item-title">Let’s Discover The Heaven</h1>
            <ul class="item-ctg" style="
    margin-left: -62px;
">
                <li>
                    <a class="item-icon" href="holidaypackages.php"><i class="flaticon-earth"></i></a>
                    <a href="holidaypackages.php" class="ctg-title">Packages</a>
                </li>
                <li>
                    <a class="item-icon" href="allhotels.php?type=Hotel"><i class="flaticon-hotel"></i></a>
                    <a href="allhotels.php?type=Hotel" class="ctg-title">Hotels</a>
                </li>
                <li>
                    <a class="item-icon" href="houseboatlandpage.php"><i class="flaticon-supermarket"></i></a>
                    <a href="houseboatlandpage.php" class="ctg-title">Houseboats</a>
                </li>
                <li>
                    <a class="item-icon" href="cabs.php"><i class="flaticon-search "></i></a>
                    <a href="cabs.php" class="ctg-title">Cabs</a>
                </li>
                <li>
                    <a class="item-icon" href="essentialservices.php?name=Police station"><i class="flaticon-phone-call"></i></a>
                    <a href="essentialservices.php?name=Police station" class="ctg-title">Essential Services</a>
                </li>
                <li>
                    <a class="item-icon" href="touristinfo.php"><i class="flaticon-upload"></i></a>
                    <a href="touristinfo.php" class="ctg-title">Tourist Info</a>
                </li>
...
<section class="feature-wrap-layout1 padding-top-9p6  bg--light">
    <div class="container">
        <div class="section-heading heading-dark heading-center">
            <div class="item-sub-title">Discover the top Holidays in J&K </div>
            <h2 class="item-title">Recommended Packages we offer?</h2>
        </div>

        <div class="row">
            
            <?php
            $sql = "select * from tours order by rand() limit 4";
            ...
            if ($result) {
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="feature-box-layout1">
                            ...
                            <div class="item-content">
                                 ...
                                 <h3 class="item-title"><a href="#" data-toggle="modal" data-target="#bookNow" onclick="setName('<?= $row['name']; ?>')"> <?= $row['name']; ?></a></h3>
              ...
              <a href="packagedetail.php?name=<?= $row['name']; ?>" ><h6 id="indexpackage">VIEW DETAILS</h6></a>
                    </div>
        ...
        <div class="row mt-5">
                <div class="col-12">
                    <div class=" text-center">
                        <a href="holidaypackages.php" class="btn-fill">View All Packages</a>
                    </div>
                </div>
            </div>
    </div>
...
<section class="category-wrap-layout1 padding-top-9p6  overlay-dark-70 parallaxie bg--dark"
    ...
    <div class="container">
        <div class="section-heading heading-light heading-center">
            ...
            <h2 class="item-title">Essential Services in Srinagar?</h2>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="category-box-layout1">
                    
                    <a class="item-icon" href="essentialservices.php?name=ATM"><i class="flaticon-phone-call"></i></a>
                    
                    <h3 class="item-title"><a href="essentialservices.php?name=ATM"><p id="para1">ATM</p></a></h3>
                    <!--<div class="listing-number"><p id ="list">40 Listings</p></div>-->
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="category-box-layout1">
                   <a class="item-icon" href="essentialservices.php?name=Police station"><i class="flaticon-phone-call"></i></a>
                    ...
                    <h3 class="item-title"><a href="essentialservices.php?name=Police station">Police Station</a></h3>
                    
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="category-box-layout1">
                   <a class="item-icon" href="essentialservices.php?name=Restaurant"><i class="flaticon-phone-call"></i></a>
                    <h3 class="item-title"><a href="essentialservices.php?name=Restaurant">Restaurants</a></h3>
                    
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="category-box-layout1">
                    <a class="item-icon" href="essentialservices.php?name=hospital"><i class="flaticon-phone-call"></i></a>
                    <h3 class="item-title"><a href="essentialservices.php?name=Hospital">Hospital</a></h3>
...
<section class="listing-wrap-layout1 padding-top-9p6  bg--light">
    <div class="container">
        <div class="section-heading heading-dark heading-center">
            <div class="item-sub-title">Discover our Best Hotels around J&K</div>
            <h2 class="item-title">Best Hotels We Deal</h2>
        </div>
        <div class="row" id="no-equal-gallery">

            <?php
            $sql = "select * from accommodations order by rand() limit 6";
            $result = $conn->query($sql);
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        ...
                        <div class="listing-box-grid">
                            <div class="product-box border-box">
                                <div class="item-img bg--gradient-50">
                                    ...
                                    <?php if ($row['deal'] != "") { ?>
                                        <div class="item-status status-open active"><?= $row['deal']; ?></div>
                                        <?php
                                    }
                                    ?>

                                    <img src="<?= $row['image']; ?>" alt="<?= $row['name']; ?>" class="img-fluid grid-view-img">
                                    ...
                                    <div class="item-logo"><img src="https://www.newsmart.com/customer/site logo/newsmarttravels_logo.png" alt="Logo"></div>
                                </div>
                                <div class="item-content">
                                    
                                    <h3 class="item-title"><a href="#" data-toggle="modal" data-target="#bookNow" onclick="setName('<?= $row['name']; ?>')"> <?= $row['name']; ?></a></h3>
                                    
                                   <!-- <h3 class="item-title"><a href="#"><?= $row['name']; ?></a></h3>-->
                                    <p class="item-paragraph">


                                        <?php
                                        $str = $row['description'];
                                        $small = substr($str, 0, 120);
                                        echo $small . ".......";
                                        ?> 
                                    ...
                                    <ul class="contact-info">
                                        ...
                                        <li><i class="flaticon-phone-call"></i><?= $phone; ?></li>
                                    </ul>

                                    <ul class="meta-item">
                                        <li class="item-btn"><a href="accomodationdetail.php?name=<?= $row['name']?>" class="btn-fill">Details</a></li>
                                        <li class="ctg-name"><a href="#"><i class="flaticon-chef"></i><?= $row['type']; ?></a></li>
    ...
    <div>
        <div class="row mt-5">
                <div class="col-12">
                    <div class=" text-center">
                        <a href="allhotels.php" class="btn-fill">See All Hotels</a>
                    </div>
                </div>
            </div>
    </div>
...
<section class="blog-wrap-layout1 padding-top-9p6  bg--light">
    <div class="container">
        <div class="section-heading heading-dark heading-center">
            <div class="item-sub-title">Browse the latest Things </div>
            
            
             <h3 class="item-title">Things To Do</h3>
          <!--<h2 class="item-title">Things To Do</h2>-->
        </div>
        <div class="row">
            <?php
            $sql = "select * from things_todo order by rand() limit 0,8";
            $result = $conn->query($sql);
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                    ...
                    <div class="col-md-6">
                        <div class="blog-box-layout1">
                            <div class="post-thumb">
                                <!--<a href="single-blog.html"><img src="<?= $row['name']; ?>" alt="<?= $row['name']; ?>" class="img-fluid"></a>-->
                                <a href="thingstodo.php?name=<?= $row['name']; ?>"><img src="<?= $row['image_outer']; ?>" alt="<?= $row['name']; ?>" class="img-fluid"></a>
                            </div>
                        </div>
                        <div class="post-content">
                            ...
                            <div class="content">
                                <p>
                                    <?php
                                    $str = $row['description'];
                                    $small = substr($str, 0, 180);
                                    echo $small . ".......";
                                    ?> 
                                </p>
                            </div>
                            <a href="thingstodo_detail.php?name=<?= $row['name']; ?>" class="btn-text size-sm color-dark hover-primary btn-icon">Read
        ...
        <div class="row mt-5">
                <div class="col-12">
                    <div class=" text-center">
                        <a href="thingstodo.php?name=<?= $row['name']; ?>" class="btn-fill">See All Adventures</a>
                    </div>
                </div>
            </div>
    </div>
...
<section class="testimonial-wrap-layout1 overlay-dark-70 bg-common bg--dark" data-bg-image="img/figure/figure1.jpg">
    <div class="container">
        <div class="section-heading heading-dark">
            <div class="item-sub-title">What Our Customers Say About us </div>
            
            
             <h3 class="item-title" style="color: white;">Guest Reviews </h3>
          <!--<h2 class="item-title">Things To Do</h2>-->
        </div>
        <div id="slick-carousel-wrap-nav" class="slick-carousel testimonial-thumb-wrap" data-slick='{
            ...
            <div class="nav-item"><img src="https://www.newsmarttravels.com.com/guest review images/man1.png" alt="Testimonial Img" class="img-fluid"></div>
            <div class="nav-item"><img src="https://www.newsmarttravels.com.com/guest review images/man2.png" alt="Testimonial Img" class="img-fluid"></div>
            <div class="nav-item"><img src="https://www.newsmarttravels.com.com/guest review images/man3.png" alt="Testimonial Img" class="img-fluid"></div>
            <div class="nav-item"><img src="https://newsmarttravels.com.com/customers/guest review images/man4.png" alt="Testimonial Img" class="img-fluid"></div>
            <div class="nav-item"><img src="https://newsmarttravels.com.com/customer/guest review images/man5.png" alt="Testimonial Img" class="img-fluid"></div>
            <div class="nav-item"><img src="https://newsmarttravels.com.com/customer/guest review images/man6.png" alt="Testimonial Img" class="img-fluid"></div>
            <div class="nav-item"><img src="https://newsmarttravels.com.com/customer/guest review images/man7.png" alt="Testimonial Img" class="img-fluid"></div>
        </div>
        <div id="slick-carousel-wrap-content" class="slick-carousel testimonial-content-wrap slick-navigation-layout2"
            ...
            <div class="testimonial-content">
                ...
                <h4 class="item-title">vikram dobhe</h4>
                <h5 class="item-designation">Gujrat</h5>
                <ul class="rating">
                    <li>
            ...
            <div class="testimonial-content">
                <p>Hotel orchard Tetretd is a wonderful hotel to stay in if you want the best homely feeling and location. Loved everything about our room and even came to appreciate the steps. Everyone associated with this hotel is super.</p>
                <h4 class="item-title">Ravneet Singh</h4>
                <h5 class="item-designation">Banglore</h5>
                <ul class="rating">
                    <li>
                        <i class="fas fa-star"></i>
                    </li>
            ...
            <div class="testimonial-content">
                <p>Zojila Residency Excellent hotel. Super old and historic, but very updated in terms of really nice rooms, nicely appointed bathrooms, great A/C, super clean. The owner and his staff were marvelous. Breakfast was very nice. The location of this hotel is fantastic.</p>
                <h4 class="item-title">Satwant Sodhi</h4>
                <h5 class="item-designation">Mumbai</h5>
                <ul class="rating">
                    <li>
                        <i class="fas fa-star"></i>
                    </li>
            ...
            <div class="testimonial-content">
                <p>The location is perfect. Not too far to walk from the train station and it is close to the river, and the major sights are all in walking distance. The room was not big but it was fine.</p>
                <h4 class="item-title">Farhan Qureshi</h4>
                <h5 class="item-designation">Delhi</h5>
                <ul class="rating">
                    <li>
                        <i class="fas fa-star"></i>
                    </li>
            ...
            <div class="testimonial-content">
                <p>Yes, we do believe that our travelling closet qualifies as the smallest lift in the world! We are so glad you enjoyed your stay with us. Thanks so much for taking the time to write here - we do appreciate it!.</p>
                <h4 class="item-title">kawaljit Kaur</h4>
                <h5 class="item-designation">Chandigarh</h5>
                <ul class="rating">
                    <li>
                        <i class="fas fa-star"></i>
                    </li>
            ...
            <div class="testimonial-content">
                <p>Location of vintage hotel has the perfect view,the hotel is clean and provides u great hospitality.The hotel owner is very helpful and will guide u throughout your stay.</p>
                <h4 class="item-title">Tina Hora</h4>
                <h5 class="item-designation">Hyderabad </h5>
                <ul class="rating">
                    <li>
                        <i class="fas fa-star"></i>
                    </li>
            ...
            <div class="testimonial-content">
                <p>We just had a wonderful stay at the Pine and peak which is part of, but just across the street from, the Hotel pine and peak.</p>
                <h4 class="item-title">Haider Ali</h4>
                <h5 class="item-designation">Jaipur</h5>
                <ul class="rating">
                    <li>
                        <i class="fas fa-star"></i>
                    </li>
...
<section class="event-wrap-layout1 padding-top-9p6 padding-bottom-10 bg--accent">
    <div class="container menu-list-wrapper">
        <div class="section-heading heading-dark heading-center">
            <div class="item-sub-title">Discover our cab facility.</div>
            <h2 class="item-title">Our Cab Services!</h2>
        </div>
        ...
        <div class="row menu-list">
            ...
            <?php
            $sql = "select * from cabs order by rand() limit 4";
            $result = $conn->query($sql);
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        ...
                        <div class="event-box-layout1">
                            <div class="item-content">
                                ...
                                <div class="mask-item">
                                    ...
                                    <h3 class="item-title"><a href="#" data-toggle="modal" data-target="#bookNow"> <?= $row['name']; ?></a></h3>
                                    </div>
                                    <div class="col-md-5" style="float: left">
                                    <a href="#" data-toggle="modal" data-target="#bookNow" onclick="setName('<?= $row['name']; ?>')" > <h6 id="cabbookindex">ENQUIRE NOW</h6></a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class=" text-center">
                        <a href="cabs.php" class="btn-fill">See All Cabs</a>
...
require_once './js_parts/js_index.php';
