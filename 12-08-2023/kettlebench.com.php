...
<?php if(isset($_POST['enquiry_now'])){
		
		$phone  = $_POST['phone'];
		$name    = $_POST['name'];
		$email   = $_POST['email'];
		$subject  = 'Quick Enquiry';
		$message = $_POST['num_people'];
		$sql = "INSERT INTO enquiry(name,email,subject,num_people,phone)
      ...
      <section class="home-slider-section">
         <div class="home-slider">
            ...
            <div class="home-banner-items">
               <div class="banner-inner-wrap" style="background-image: url(<?php echo $baseurl.$row['s_image1'];?>);"></div>
      ...
      <form action="" method="post">       
            <div class="trip-search-inner white-bg d-flex">
               ...
               <div class="input-group">
                  ...
                  <input type="number" name="num_people" placeholder="No. of People" required>
               </div>
               <div class="input-group">
                  <label> Phone Number </label>
                  <input type="text" name="phone" placeholder="Phone Number" required onkeypress="return onlyNumberKey(event)" minlength="10">
               </div>
               <div class="input-group">
                  <label> Email </label>
               ...
               <div class="input-group width-col-3">
                  <label class="screen-reader-text"> Submit </label>
                  <input type="submit" name="enquiry_now" value="ENQUIRE NOW">
               </div>
         ...
         <div class="container">
            <div class="section-heading">
                <div class="row">
                    ...
                    while($row = mysqli_fetch_array($result)){ ?>       
                    <div class="col-lg-6">
                        <h5 class="dash-style">WELCOME TO</h5>
                        <h2>KETTLE BENCH</h2>
                    ...
                    <div class="col-lg-6">
                        <img src="<?php echo $baseurl.$row['image'];?>">
                    </div>
                    <?php } }  ?>
               </div>
            </div>
            ...
            <div class="destination-inner destination-three-column">
                <div class="row">
                    <?php 
                    $sql= "SELECT * FROM category where type=1 order by id asc limit 6";
                    if($result=mysqli_query($conn,$sql)){    
                    while($row = mysqli_fetch_array($result)){ ?>      
                    <div class="col-sm-4">
                      <div class="desti-item overlay-desti-item">
                        <figure class="desti-image">
                           <img src="<?php echo $baseurl.$row['image'];?>" alt="">
                        </figure>
                        <div class="desti-content">
                           <h3><a href="detail.php?id=<?php echo $row['id'];?>&type=1"><?php echo $row['title'];?></a></h3>
                        </div>
                      </div>
                    </div>
                    <?php } }?>
                ...
                <div class="btn-wrap text-center">
                  <a href="destinations.php?type=1" class="button-primary">VIEW MORE </a>
                </div>
            </div>
         </div>
      </section>
      ...
      <section class="package-section">
         <div class="container">
            ...
            <div class="package-inner">
               <div class="row">
                    <?php 
                    $sql= "SELECT * FROM packages order by id asc limit 3";
                    if($result=mysqli_query($conn,$sql)){    
                    while($row = mysqli_fetch_array($result)){ ?> 
                    <div class="col-lg-4 col-md-6">
                    <div class="package-wrap">
                        <figure class="feature-image">
                           <a href="packagedetails.php?id=<?php echo $row['id'];?>">
                              <img src="<?php echo $baseurl.$row['image'];?>" alt="">
                           </a>
                        </figure>
                        <div class="package-content-wrap text-center">
                           <div class="package-content">
                              <h3 class="my-2">
                                 <a href="packagedetails.php?id=<?php echo $row['id'];?>"><?php echo $row['title'];?></a>
                              </h3>
                              <!--<p><?//php echo substr(strip_tags($row['description']),0,150);?></p>-->
                              <div class="btn-wrap">
                                 <a href="packagedetails.php?id=<?php echo $row['id'];?>" class="button-text width-6">View Detail<i class="fas fa-arrow-right"></i></a>
                              </div>
                           </div>
                        </div>
                    </div>
      ...
      <section class="callback-section">
         <div class="container">
            <div class="row no-gutters align-items-center">
                ...
                <div class="col-lg-5">
                  <div class="callback-img" style="background-image: url(<?php echo $row['image'];?>);">
                     <div class="video-button">
                        <!--<a id="video-container" data-video-id="" href="<?php echo $row['title'];?>">
                ...
                <div class="col-lg-7">
                  <div class="callback-inner">
                     <div class="section-heading section-heading-white">
                        <h5 class="dash-style">KNOW MORE</h5>
                        <h2>WHY CHOOSE US ?</h2>
...
if($result=mysqli_query($conn,$sql)){    
    while($row = mysqli_fetch_array($result)){ ?>   
                        <div class="counter-item">
                           ...
                           <div class="counter-content">
                              <span class="counter-no">
                                 <span class="counter"><?php echo $row['count_1'];?></span>+
                              </span>
                        ...
                        <div class="counter-item">
                           ...
                           <div class="counter-content">
                              <span class="counter-no">
                                 <span class="counter"><?php echo $row['count_2'];?></span>+
                              </span>
                              <span class="counter-text">
                                 Resorts & Partners
                              </span>
                        ...
                        <div class="counter-item">
                           ...
                           <div class="counter-content">
                              <span class="counter-no">
                                 <span class="counter"><?php echo $row['count_3'];?></span>+
                              </span>
                              <span class="counter-text">
                        ...
                        <div class="counter-item">
                           ...
                           <div class="counter-content">
                              <span class="counter-no">
                                 <span class="counter"><?php echo $row['count_4'];?></span>+
                              </span>
                              <span class="counter-text">
                     ...
                     <div class="support-area">
                        ...
                        <div class="support-content">
                            <h4>Contact us via call or whatsapp</h4>
                            <h3>
                            <?php 
      ...
      <section class="special-section">
         <div class="container">
            ...
            <div class="special-inner">
                <div class="row">
                    <?php 
                    $sql= "SELECT * FROM category where type=2 order by id asc limit 4";
                    if($result=mysqli_query($conn,$sql)){    
                    while($row = mysqli_fetch_array($result)){ ?>  
                    <div class="col-md-6 col-lg-3">
                      <div class="special-item">
                        ...
                        <div class="special-content">
                           <h3>
                              <a href="detail.php?id=<?php echo $row['id'];?>&type=2"><?php echo $row['title'];?></a>
                           </h3>
                        </div>
                      </div>
                    </div>
...
$sql= "SELECT * FROM gallery where title=1 order by id desc limit 2";
if($result=mysqli_query($conn,$sql)){    
    while($row = mysqli_fetch_array($result)){ ?>         
                     <div class="col-sm-6">
                        <figure class="gallery-img">
                           <img src="<?php echo $baseurl.$row['g_image'];?>" alt="">
                        </figure>
                     </div>
...
$sql= "SELECT * FROM gallery where title=1 order by id asc limit 1 ";
if($result=mysqli_query($conn,$sql)){    
    while($row = mysqli_fetch_array($result)){ ?>               
                        <figure class="gallery-img">
                           <img src="<?php echo $baseurl.$row['g_image'];?>" alt="">
   ...
   <?php } } ?>   
      ...
      <div class="client-section secondary-bg">
         <div class="container">
            <div class="client-wrap client-slider secondary-bg">
        <?php 

$sql= "SELECT * FROM multiple_images where s_id=0 and type=0";
if($result=mysqli_query($conn,$sql)){    
    while($row = mysqli_fetch_array($result)){ ?>     
    ...
    while($row = mysqli_fetch_array($result)){ ?>             
                     ...
                     <div class="testimonial-item text-center">
                        ...
                        <div class="testimonial-content">
                           ...
                           <cite>
                              <?php echo $row['title'];?>
                              <span class="company"><?php echo $row['designation'];?></span>
                           </cite>
                        </div>
                     </div>
                  <?php } } ?>
