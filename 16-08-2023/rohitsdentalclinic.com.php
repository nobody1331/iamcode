...
<head>
    ...
    <title>Rohit Dental Clinic </title>
...
<section class="home" id="home">
    ...
    <div class="image">
        <img src="image/1671435330635.jpg" alt="" >
    </div>

    <!--<div class="content">-->
    <!--    <h3>stay safe, stay healthy</h3>-->
    <!--    <p>Rohit's Dental Clinic welcomes you!</p>-->
    <!--    <a href="book.php" class="btn"> Book a Date <span class="fas fa-chevron-right"></span> </a>-->
    <!--</div>-->
...
<!--      <div class="carousel-item active">-->
         <!--<img src="image/img30.jpg" alt="Los Angeles" width="100%" height="700"> -->
<!--          <div class="title-box1">-->
<!--              <h3>stay safe, stay healthy</h3>-->
<!--        <p>Rohit Dental Clinic welcomes you!</p>-->
<!--        <a href="contact.php" class="btn"> contact us <span class="fas fa-chevron-right"></span> </a>-->
<!--            </div>-->
<!--      </div>-->
<!--      <div class="carousel-item">-->
         <!--<img src="image/img32.jpg" alt="Chicago" width="100%" height="700"> -->
...
<!--      </div>-->
<!--      <div class="carousel-item">-->
         <!--<img src="image/img9.jpg" alt="New York" width="100%" height="700"> -->
...
<!--<div id="banner-slider1" class="owl-carousel">-->
    
        <!--            <div class="carousel-inner">-->
        <!--                <div class="title-box1">-->
        <!--      <h3>stay safe, stay healthy</h3>-->
        <!--<p>Rohit Dental Clinic welcomes you!</p>-->
        <!--<a href="book.php" class="btn"> Book Now <span class="fas fa-chevron-right"></span> </a>-->
        <!--    </div>-->
        <!--            </div>-->
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content">
            <h3>we take care of your beautiful smile</h3>
            <p>Rohit Dental Clinic welcomes you! Are you looking for a perfect dental specialist or do you need the best Dental Clinic? If yes, then you are at the perfect platform.Rohit Dental Clinic is a multi-specialty Dental Clinic in Bhubaneswar offering the high-quality dental services with the most affordable packages. We are a reason for the most attractive smiles. We value our patients and our aim is to provide them with the best dental facilities. Rohit Dental Clinic knows that a beautiful smile can make you more attractive, glamorous, and presentable. We ensure the best dental health services to our patients to make them healthier and happier.</p>
...
<!-- services slider section starts  -->
<div class="container">
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-8">
            <h3 class="text-center">CASE IMAGES</h3>
            <div id="service-slider1" class="owl-carousel">
                
                <?php
                    $k = 0;
                    $sql11 = db_query("SELECT * FROM caseimage");
                     while($row10= $sql11->fetch_assoc()){
                    
                ?>
                    <div class="carousel-inner">
                        <img src="admin/uploads/<?php echo $row10['image'];?>" alt="Los Angeles" width="100%" height="300">
                    </div>
                    <?php $k++;} ?>
        ...
        <!--     <div id="service-slider2" class="owl-carousel">-->
        <!--            <div class="carousel-inner">-->
        <!--                <img src="image/img30.jpg" alt="Los Angeles" width="100%" height="300">-->
        <!--                <h4>service1</h4>-->
        <!--            </div>-->
...
<!-- services and doctor slider section starts  -->
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <h3 class="text-center">SERVICES</h3>
            <div id="service-slider3" class="owl-carousel">
                <?php
                      $j=0;
                        $sd1="SELECT * FROM services";
                          $rd1=db_query($sd1);
                          while($rr1=$rd1->fetch_assoc()){
                        ?> 
                    <div class="carousel-inner">
                        <img src="admin/uploads/<?php echo $rr1['image'];?>" alt="Los Angeles" width="100%" height="300">
                        <h4><?php echo $rr1['type']?></h4>
                    </div>
        ...
        <div class="col-md-6">
            <h3 class="text-center">DOCTORS</h3>
             <div id="service-slider4" class="owl-carousel">
                 <?php
              $i=0;
                $sd="SELECT * FROM doctors";
                  $rd=db_query($sd);
                  while($rr=$rd->fetch_assoc()){
                ?> 
                    <div class="carousel-inner">
                        <img src="admin/uploads/<?php echo $rr['image'];?>" alt="Los Angeles" width="100%" height="300">
                        <h4><?php echo $rr['name']?></h4><span><?php echo $rr['speciality']?></span>
                    </div>
                <?php $i++;} ?>
...
<!--        <div class="box">-->
<!--            <div class="image">-->
<!--                <img src="admin/uploads/<?php echo $rr1['image'];?>" alt="">-->
<!--            </div>-->
<!--            <div class="content">-->
<!--                <h2><?php echo $rr1['type']?></h2>-->
...
<!--        <div class="box">-->
<!--            <img src="admin/uploads/<?php echo $rr['image'];?>" alt="">-->
<!--            <h3><?php echo $rr['name']?> </h3>-->
<!--            <span><?php echo $rr['speciality']?></span>-->
<!--            <div class="share">-->
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="testimonial-slider" class="owl-carousel">
                    ...
                    <?php
                    $k=0;
                    $sd3="SELECT * FROM feedback";
                    $rd3=db_query($sd3);
                    while($rr3=$rd3->fetch_assoc()){
                ?> 
                    <div class="testimonial">
                        
                        <p class="description">
                            <?php echo $rr3['message']?>
                        </p>
                        <h3 class="title"><?php echo $rr3['name']?></h3>
                        
                        <small class="post">- <?php echo $rr3['type']?>
                        <?php if($rr3['type'] == '1'){ ?>
