...
<div class="panel-heading">
     ...
     <div class="panel-body">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3548.189419026763!2d77.5135243743373!3d27.213202147114703!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3973a2e2aa7e9037%3A0xd6a4a751e037e67!2sMaharani%20Shri%20Jaya%20Government%20Post%20Graduate%20College!5e0!3m2!1sen!2sin!4v1692064238332!5m2!1sen!2sin" width="100%" height="280" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
     </div>
</div>
		    ...
		    <div class=" col-xs-8">  <!-- slider ---->
		                        <div class="panel panel-uor1">                    
     <div class="panel-body">
<div id="carousel-uor" class="carousel slide" data-ride="carousel">


 <div class="carousel-inner">
 
	<?php
		$sqlquery = "SELECT * FROM tbl_slider order by id asc";
		//echo $sqlquery; die;
      ...
      <img src="images/slides/<?php echo $row['slider'];  ?>" alt="MSJ College" width="570" height="300">
  ...
  <a class="right carousel-control" href="#" data-slide="next">
    <span class="glyphicon glyphicon-chevron-right"></span>
		   ...
		   <div class="row">  <!-- 3rd row start content wail -->
		   
		  <div class="col-xs-4"> 
<div class="panel panel-uor1">
<div class="panel-heading">
          <h3 class="panel-title">College Campus</h3>
   </div>
     <div class="panel-body">
          <a href="images/campus.jpg" class="thumbnail" data-toggle="model" data-title="A random title" data-footer="A custom footer text">
             <img src="images/campus.jpg" alt="..." class="img-responsive" id="univ-map">
          </a>
     </div>
</div>
...
<li role="presentation"><a role="menuitem" tabindex="-1" href="http://www.msjcollege.in/docs/846798346callender.pdf"><span class="glyphicon glyphicon-share-alt"></span>
         <span class="glyphicon-class">  Calendar</span></a></li>
         
<li role="presentation">
    <a role="menuitem" tabindex="-1" href="const.php"><span class="glyphicon glyphicon-share-alt"></span>
          <span class="glyphicon-class"> RTI</span></a></li> 
          
<li role="presentation"><a role="menuitem" tabindex="-1" href="http://www.msjcollege.in/docs/72354572commitee.pdf"><span class="glyphicon glyphicon-share-alt"></span>
          <span class="glyphicon-class"> Community Centre</span></a></li>
          
<li role="presentation"><a role="menuitem" tabindex="-1" href="/page.php?fId=88&dId=101">
    <span class="glyphicon glyphicon-share-alt"></span>
          <span class="glyphicon-class"> Grievance Redressal Cell</span></a></li> 
          
<li role="presentation"><a role="menuitem" tabindex="-1" href="const.php"><span class="glyphicon glyphicon-share-alt"></span><span class="glyphicon-class"> Admission List</span></a></li>
          
<li role="presentation"><a role="menuitem" tabindex="-1" href="const.php">
    <span class="glyphicon glyphicon-share-alt"></span>
          <span class="glyphicon-class"> Annual Report</span></a></li>  
          
<li role="presentation"><a role="menuitem" tabindex="-1" href="/page.php?fId=0&dId=158"><span class="glyphicon glyphicon-share-alt"></span>
          <span class="glyphicon-class"> Download</span></a></li>
                 </ul>
          </div>
     </div>
</div>
...
<ul id = "myTab" class = "nav nav-tabs">
   <?php
		$sqlquery = "SELECT * FROM tbl_home_tabs where is_tab_menu='1' order by id asc";
		//echo $sqlquery; die;
		$res=mysqli_query($conn,$sqlquery);
		$counth =1;
		 while($row=mysqli_fetch_array($res)) 
		...
		?>
			<li <?php echo $class; ?> onclick="getTabContennt()"><a href = "#tab-<?php echo $row['id']; ?>" data-toggle = "tab"><?php echo $row['name']; ?></a></li>
	<?php
			$counth++;	
		}
   ?>
...
<div id = "myTabContent" class = "tab-content "style="padding:7px">

   <?php
	
		$sqlqueryc = "SELECT * FROM tbl_home_tabs where is_tab_menu='1' order by id asc";
		//echo $sqlquery; die;
		$resc=mysqli_query($conn,$sqlqueryc);
	...
	<div class = "tab-pane fade  <?php echo $class; ?>" id = "tab-<?php echo $rowc['id'];?>">
	
	<?php 
		 $sqlqueryn = "SELECT * FROM newsandevents where type_id='".$rowc['id']."' order by intId asc"; 
		//echo $sqlquery; die;
		$resn=mysqli_query($conn,$sqlqueryn);
		if(mysqli_num_rows($resn)>0)
		{
			
		
	?>
   <marquee behavior="scroll" direction="up" scrolldelay="180" onmouseover="this.stop();" onmouseout="this.start();">
	...
	<tbody>
			...
			<tr><td><a href="news.php?id=<?php echo $rown['intId']; ?>" target="_New"><?php echo $rown['title']; ?></a><span class="label label-danger">New</span></td></tr>
				<?php } ?>
  ...
  ?>
   ...
   ?>
	    ...
	    <div class="col-xs-3" style="margin-left:px;"> 
		  <div class="panel panel-uor1" style=""> 
<div class="panel-heading">
          <h3 style="color:#cf2428" class="panel-title">Latest News</h3>
   </div>
...
<img src="/images/vc.jpg"/>
	    ...
	    <div class="col-xs-3">
		  ...
		  <div class="panel panel-uor1" style="height:175px;  overflow:hidden;"> 
<div class="panel-heading">
     ...
     <div class="panel-body " >
		...
		<?php
		$sqlquery1 = "SELECT * FROM newsandevents where type_id='7' order by intId asc";
		//echo $sqlquery; die;
		...
		?>
			<p style="text-align:justify; veritcal-algin:center;"> <a  target ="_blank" href="news.php?id=<?php echo $row1['intId']; ?>"> <?php echo $row1['title']; ?></a></p>
...
<div class="panel panel-uor1" style="height:240px; overflow:hidden;">

<div class="panel-heading">
          <h3 class="panel-title">Seminar/Workshop</h3>
   </div>
   
   <?php
		$sqlSem = "SELECT * FROM newsandevents where type_id='6' order by intId asc";
		//echo $sqlquery; die;
		$resSem=mysqli_query($conn,$sqlSem);
		if(mysqli_num_rows($resSem)>0)
		{
			
		
		 while($rowSem=mysqli_fetch_array($resSem)) 
		{ 
		
		?>
		<a href="news.php?id=<?php echo $rowSem['intId']; ?>" target="_blank"> <div class="panel-body">
	   <!-- <div class="col-xs-6">
               <img src="images/semi_3.jpg"" class="img-rounded centered-rel">
          </div>-->
          <div class="col-xs-12">
	       <p style="font-size:13px;color:#000; padding-top:15px; text-align:justify;"><?php echo $rowSem['title']; ?> </p>
	...
	<?php
		...
		{
			echo "No Seminar/Workshop Found";
		}
   ?>
...
<style>
#carousel-uor{height:345px !important;}
