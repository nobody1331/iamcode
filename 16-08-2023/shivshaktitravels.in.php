...
<meta name="google-site-verification" content="eHmdiVq1XKvcySMDjljmqBgvvubFA7XmIb-_AhyLRpQ" />

<meta name="ROBOTS" CONTENT="INDEX, FOLLOW" />

<meta name="auther" content="https://plus.google.com/+ImperialvoyagesDelhi" />

<link rel="canonical" href="index.html" />

<title>Shiv Shakti Travels</title>

<meta name="description" content="Booking Tour And Travels Operators In India, I have top revied travel sites, websites tour operators, Agency, Agent in Delhi." />


<script src="https://kit.fontawesome.com/d06852a0f2.js" crossorigin="anonymous"></script>

<link href="https://fonts.googleapis.com/css?family=Bangers&display=swap" rel="stylesheet">  
<meta name="keywords" content=" Tour operators in India, Delhi Tour Operators, Tour operators in Delhi, travel agents in delhi,Booking Travels,travel sites,travel websites, indian travel agents, best tour companies , international tour operators list , delhi sightseeing, India Travel Packages." />
...
<meta name="p:domain_verify" content="6efcdd43321745de423093f438c580df" />
...
<script src="https://kit.fontawesome.com/279f022ffe.js" crossorigin="anonymous"></script>
<!-- Current Page Styles -->
...
<link id="main-style" rel="stylesheet" href="css/style.css" media="all">
...
.bg1{
    position: relative;
    background: url(images/background/mountain_PNG20.png);
    height: 100vh;
  ...
  <style type="text/css">@import url(https://fonts.googleapis.com/css?family=Pathway+Gothic+One);
...
<!-- Bootstrap core CSS -->
    ...
    <!--Plugin CSS-->
    <link href="css/plugin1.css" rel="stylesheet" type="text/css">
...
<!--<i style="font-size: 22px; margin-top:14px;" class="fa fa-share my-float"></i>-->
<!--</a>-->
<!--<ul class="ul1">-->
<!--<li><a href="#">-->
<!--<i style="font-size: 28px; margin-top:12px;" class="fab fa-facebook-f"></i>-->
<!--</a></li>-->
<!--<li><a href="#">-->
<!--<i style="font-size: 28px; margin-top:12px;"  class="fab fa-instagram"></i>-->
<!--</a></li>-->
<!--<li><a href="#">-->
<!--<i style="font-size: 28px; margin-top:12px;" class="fab fa-youtube"></i>-->
<!--</a></li>-->
<!--</ul>-->
<!--<a href="https://api.whatsapp.com/send?phone=9927712090&text=Welcome to Shiv Shakti Travels.Contact Us..." class="float1" target="_blank">-->
...
<!-- Header -->
            ...
            <div class="container">
                <div class="upper-head-inner">
                    <div class="contact-info pull-left">
                        <div class="contact-info-item"><a href="tel:9758096152"><i class="fas fa-mobile-alt"></i><p> <span class="a123">+91 9758096152</span></p></a></div>
                        <a href="mailto:info@shivshaktitravels.in"><i class="fas fa-envelope-open-text"></i><p><span class="a123">info@shivshaktitravels.in</span></p></a>
                    </div>
                ...
                <div class="header_menu">
                    ...
                    <nav class="navbar navbar-default navbar-arrow">
                        <div class="logo pull-left">
                            <a href="index.html"><img alt="Image" src="images/logo.png" class="colorlogo"></a>
                            <a href="index.html"><img alt="image" src="images/logo2.png" class="whitelogo"></a>
                        </div>
                        <div id="navbar" class="navbar-nav-wrapper">
                            <ul class="nav navbar-nav" id="responsive-menu">
                                ...
                                <li>
                                    <a href="#">Chardham Yatra<i class="fa fa-angle-down"></i></a>
                                        <ul>
                                            <li> <a href="ek-dham.html">Ek Dham Yatra</a></li>
                                            <li> <a href="do-dham.html">Do Dham Yatra</a></li>
                                            <li><a href="teen-dham.html">Teen Dham Yatra</a></li>
                                            <li><a href="chardham-package.html">Chardham Yatra</a></li>
                                            <li><a href="helicopter.html">Chardham Helicopter Yatra</a></li>
                                           
                                        </ul>
                                </li>
                                 <li>
                                    <a href="adventure-tours.html">Adventure Tours </a>
                                ...
                                <li>
                                    <a href="#">Tour Packages  <i class="fa fa-angle-down"></i></a>
                                     <ul>
                                            <li> <a href="nanital.html">Nainital</a></li>
                                            <li> <a href="dhanaulti.html">Dhanaulti</a></li>
    ...
    <!-- Banner -->
    <section id="home_banner" class="banner-style-1">
        <!-- Paradise Slider -->
        <div id="js_frm_040" class="carousel slide ps_control_hrbrarrow swipe_x ps_easeOutQuint" data-ride="carousel" data-pause="hover" data-interval="4000" data-duration="2000">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <!-- Slide Background -->
                    <img src="images/banner/banner-3.jpg" alt="js_frm_040_01" />
                </div><!-- /item -->
                <!-- End of Slide -->
                <!-- Second Slide -->
                <div class="item">
                    <!-- Slide Background -->
                    <img src="images/banner/Nainital_Uttarakhand_banner.jpg" alt="js_frm_040_02" />
                </div><!-- /item -->
                <!-- End of Slide -->
                <!-- Third Slide -->
                <div class="item">
                    <!-- Slide Background -->
                    <img src="images/banner/banner.jpg" alt="js_frm_040_03" />
                </div><!-- /item -->
                 <!-- Third Slide -->
                <div class="item">
                    <!-- Slide Background -->
                    <img src="images/banner/655256.jpg" alt="js_frm_040_03" />
                </div><!-- /item -->
                <!-- End of Slide -->
...
<script src="js/jquery-3.2.1.min.js"></script>
 ...
 <br>
  <h2 style="text-align: center; font-size: 40px; font-family: 'Solway', serif; "><b>Shiv Shakti Travels</b></h2>
<hr class="style-two">
  <!--slider--> 
<br><br> 

  <div class="container  " style="width: 100%;">
<!--   <img src="images/background/Capture.png" style="position: absolute; margin-top:230px;"> -->
   <div class="row">
    <div class="col-md-1"></div>
    <div class="col-md-10">
<h2 ><span>Popular Tour Packages</span></h2>
    ...
    <div class="image-carousel style2 flexslider" data-animation="slide" data-item-width="270" data-item-margin="30">
      ...
      <ul class="slides image-box hotel listing-style1">
        ...
        <li>
          ...
          <article class="box effect5">

            <figure> <a href="chardham-package.html" class="hover-effect a"><img  width="270" height="160" alt="Enchanting South India" title="Enchanting South India" src="images/kumarakam-pavanyathri.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 12 Days / 11 Nights </span>

              <div class="clearfix"></div><br>

              <span class="daynit" style="color: black; font-size: 15px;">Chardham Yatra Package</span>
              ...
              <p class="description">Delhi- Haridwar- Barkot- Uttarkashi- Haridwar- Delhi<br></p>
                

              <div class="action"> <a class="button btn-small" href="chardham-package.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
        ...
        <li>
          ...
          <article class="box effect5">
            ...
            <figure> <a href="badrinath-package.html" class="hover-effect a"><img width="270" height="160" alt="Rajasthan Pushkar Tour" title="Rajasthan Pushkar Tour" src="images/rajsthan.jpg"></a> </figure>

            <div class="details"> <span class="daynit">5 Days /  4 Nights </span>

              <div class="clearfix"></div><br>

              <span class="daynit" style="color: black; font-size: 15px;">Badrinath Tour Package</span>
              ...
              <p class="description">Badrinath Tour Yatra Package from Delhi - Ek Dham Yatra<br></p>

              <div class="action"> <a class="button btn-small" href="badrinath-package.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
        ...
        <li>
          ...
          <article class="box effect5">
            ...
            <figure> <a href="kedarnath-package.html" class="hover-effect a"><img src="images/gt-with-kashmir/kashmir.jpg" width="270" height="160" alt="Golden Triangle & Kashmir" title="Golden Triangle & Kashmir" ></a> </figure>

            <div class="details"> <span class="daynit"> 8 Days / 7 Nights </span>

              <div class="clearfix"></div><br>

              <span class="daynit" style="color: black; font-size: 15px;">Kedarnath Badrinath Tour</span>
              ...
              <p class="description">Do Dham Yatra Package Included Kedarnath/Badrinath Tour<br><br>

                <br>

                .</p>

              <div class="action"> <a class="button btn-small" href="kedarnath-package.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
        ...
        <li>
          ...
          <article class="box effect5">
            ...
            <figure> <a href="nanital-corbett.html" class="hover-effect a"><img width="270" height="160" alt="Shimla Honeymoon Tour" title="Shimla Honeymoon Tour" src="images/tour-package-s/Shimla-Honeymoon-Tour.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 07 Days / 06 Nights </span>

              <div class="clearfix"></div><br>

              <span class="daynit" style="color: black; font-size: 15px;" >Nainital Corbett Package</span>
              ...
              <p class="description">Nanital Corbett is one of the best tour package for tourist.<br><br>

                <br>

                .</p>

              <div class="action"> <a class="button btn-small" href="nanital-corbett.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
        ...
        <li>
          ...
          <article class="box effect5">
            ...
            <figure> <a href="mussoorie-dhanaulti.html" class="hover-effect a"><img width="270" height="160" alt="kerala with andaman Tour" title="kerala with andaman Tour" src="images/kerala-with-andaman/Andaman.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 4 Days / 3 Nights </span>

              <div class="clearfix"></div><br>

              <span class="daynit" style="color: black; font-size: 15px;">Mussoorie Dhanaulti Tour </span>
              ...
              <p class="description">Mussoorie Dhanaulti Tour Package 3Night/ 4Days Package <br></p>

              <div class="action"> <a class="button btn-small" href="mussoorie-dhanaulti.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
 ...
 <li>
          ...
          <article class="box effect5">
            ...
            <figure> <a href="haridwar-rishikesh.html" class="hover-effect a"><img width="270" height="160" alt="kerala with andaman Tour" title="kerala with andaman Tour" src="images/kerala-with-andaman/2.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 4 Days / 3 Nights </span>

              <div class="clearfix"></div><br>

              <span class="daynit" style="color: black; font-size: 15px;" >Haridwar Rishikesh Tour</small></span>
              ...
              <p class="description">Explore Beautiful Uttarakhand Haridwar/Rishikesh <br></p>

              <div class="action"> <a class="button btn-small" href="haridwar-rishikesh.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
...
<div class="col-sm-6" style="padding: 10px;">
 <h2 style="font-family: 'Bangers', cursive; font-size: 50px; color: #000; margin-top: 20%; text-align: center;">Shiv Shakti Travels</h2><hr class="style-two hr1"><br> 
 <p style="font-size: 16px; text-align: justify; color: #000;  "><strong>  Shiv Shakti Travels </strong>is one of the best leading Tour Operators and Best Travel Agency in Haridwar, Rishikesh, Dehradun,around whole Uttarakhand with offices all major cities of Uttarakhand like Haridwar, Rishikesh, Travel agent in Mussoorie, Best travel agents in Dehradun , Haldwani, etc. Shiv Shakti Travels as their Haridwar best travel travel agency for chardham Yatra , Tour Packages for Chardham Yatra, Honeymoon packages , best holidays deals maker in Haridwar, Uttarakhand ..</p><br> 
<p style="font-size: 16px; text-align: justify; color: #000;">  <strong>Are you looking these services : </strong> Included taxi in rishikesh, hotel , car rental services in haridwar, honeymoon packages, CharDham tour packages, Adventures , Rafting, tour packages .</p>
 <a href="about.html"><img   style=" padding-left: 45%;  margin-top: -25px;" src="img/read.gif"> </a>
</div>
<div class="col-sm-6">
...
<style type="text/css">.inline-svg {
...
<br><br><br>
   <section class="popular-tour-section section3"> 

<div class="container ">

            <div class="row text-center">

                <h1 class="white heading">UTTARAKHAND CHARDHAM YATRA PACKAGE</h1>

                <div class="dt-sc-small-separator"></div>

                <div class="" style="font-size: 16px;">The Char Dham is a set of four pilgrimage sites in India.  Hindus believe that visiting these sites helps achieve "Moksha". It comprises Badrinath, Dwaraka, Puri and Rameswaram. It is considered by Hindus that every Hindu must visit the char dhams during one's lifetime.</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="popular-tour">
                        ...
                        <img class="inline-svg" src="images/popular-tours/word-goa-beach-concept-holiday.jpg" alt="">

                        <div class="box-layer"></div>

                        <div class="box-content">

                            <h4 class="title">Badrinath Yatra</h4>

                            <p class="description">Badrinath is considered to be the most important of all the four Hindu pilgrimage centres, referred to as Char Dham.



</p>

                            <a href="badrinath-package.html" class="read-more">read more</a>
                  ...
                  <div class="col-md-3 col-sm-6">
                    ...
                    <div class="popular-tour">
                        ...
                        <img class="inline-svg" src="images/popular-tours/kashmir-600x700.jpg" alt="">

                        <div class="box-layer"></div>

                        <div class="box-content">

                            <h4 class="title">Kedarnath Yatra</h4>

                            <p class="description">Kedarnath is considered to be the most important of all the four Hindu pilgrimage centres, referred to as Char Dham.</p>

                            <a href="kedarnath-yatra.html" class="read-more">read more</a>
                 ...
                 <div class="col-md-3 col-sm-6">
                    ...
                    <div class="popular-tour">
                        ...
                        <img class="inline-svg" src="images/popular-tours/rajasthan-banner-600x700.jpg" alt="">

                        <div class="box-layer"></div>

                        <div class="box-content">

                            <h4 class="title">Gangotri Package</h4>

                            <p class="description">Gangotri is considered to be the most important of all the four Hindu pilgrimage centres, referred to as Char Dham</p>

                            <a href="gangotri.html" class="read-more">read more</a>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="popular-tour">
                        ...
                        <img class="inline-svg" src="images/popular-tours/south-india-tourism.jpg" alt="">

                        <div class="box-layer"></div>

                        <div class="box-content">

                            <h4 class="title">Yumunotri Package</h4>

                            <p class="description">Yumunotri Package is considered to be the most important of all the four Hindu pilgrimage centres, referred to as Char Dham</p>

                            <a href="yamunotri-yatra.html" class="read-more">read more</a>
...
<section class="destination">
      ...
      <div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper">     
       ...
       <div class="text-center title" style="font-size: 16px;">

        <h2> Top Destinations Uttarakhand </h2>

        <div class="dt-sc-small-separator"></div>

       Top 10 places to visit in Uttarakhand. Find out beautiful destinations in Uttarakhand with their complete information like best time to visit,. </div>
    ...
    <div class="container">
                ...
                <div class="destination-grid  " >
                    ...
                    <a href="#">
                       ...
                       <img src="images/destinations/rajasthan-trip.jpg" height="370" class="img-responsive wp-post-image" alt="Rajasthan"> </a>
                    ...
                    <div class="mask">
                        ...
                        <p>Plan Your Tour to Mussoorie With Us. </p>

                        <a href="mussoorie.html" class="thm-btn"> View Tours </a>

                    </div>

                    <div class="dest-name">

                        <h3 style="color: #fff;">MUSSOORIE </h3>
                ...
                <div class="destination-grid">
                    ...
                    <a href="#">
                        ...
                        <img width="370" height="370" src="images/destinations/kerala.jpg" class="img-responsive wp-post-image" alt="" >                    </a>

                    <div class="mask">

                        <h2> DHANAULTI </h2>

                        <p>Plan Your Tour to Dhanaulti With Us.</p>

                        <a href="dhanaulti.html" class="thm-btn">  View Tours </a>

                    </div>

                    <div class="dest-name">

                        <h3 style="color: #fff;"> DHANAULTI</h3>
                ...
                <div class="destination-grid">
                    ...
                    <a href="#">
                        ...
                        <img width="370" height="370" src="images/destinations/tour-370x370-6.jpg" class="img-responsive wp-post-image" alt="">                    </a>

                    <div class="mask">

                        <h2>NAINITAL </h2>

                        <p>Plan Your Tour to Nainital With Us.</p>

                        <a href="nanital.html" class="thm-btn">View Tours</a>

                    </div>

                    <div class="dest-name">

                       <h3 style="color: #fff;">NAINITAL </h3>
                ...
                <div class="destination-grid">
                    ...
                    <a href="">
                        ...
                        <img width="370" height="370" src="images/destinations/Honeymoon-Packages.jpg" class="img-responsive wp-post-image" alt="">                    </a>

                    <div class="mask">

                        <h2>AULI</h2>

                        <p>Plan Your Tour to Auli Package With Us.</p>

                        <a href="auli.html" class="thm-btn">View Tours </a>

                    </div>

                    <div class="dest-name">

                         <h3 style="color: #fff;">AULI</h3>
...
<!-- <div class="container">
<div class="row">
<h2 style="text-align: center; font-size: 40px; font-family: 'Solway', serif; "><b>Shiv Shakti Travels Car Rentals in Uttarakhand</b></h2>
<hr class="style-two">
<br><br>
  <div class="col-md-7">
<input type='radio' name='sprites' id='s1' checked>
<input type='radio' name='sprites' id='s2'>
<input type='radio' name='sprites' id='s3'>
 

<div class='sprites'>
    <div class='sprite carSprite'><img src='images/car.png'></div>
  ...
  <section class="hm-call-to-action" style="margin-top: 5%;">

  	<div class="container"> <span><h2 style="color: #fff; font-size: 30px;">Top Adventure Uttarakhand</h2></span>
 ...
 <!--         <article class="box effect5 a">-->

 <!--           <figure> <a href="camping.html" class="hover-effect a"><img width="270" height="160" alt="Enchanting South India" title="Enchanting South India" src="images/1.jpg"></a> </figure>-->

 <!--           <div class="details"> <span class="daynit"> 1 Days / 2 Nights </span>-->

 <!--             <div class="clearfix"></div><br>-->

 <!--             <span class="box-title" style="color: black; font-size: 15px;">Camping <a style="padding-left: 40%;">Rs 2500/-</a></span>-->
 ...
 <!--             </div>-->
             ...
             <!--  <p class="description">Chennai - Mahabalipuram - Trichy - Madurai - Bangalore - Mysore - Hassan - Hampi - Badami - Goa - Bombay</p>
 <!----> 
 <!--             <div class="action"> <a class="button btn-small" href="camping.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>-->
 ...
 <!--       </li>-->
        ...
        <li>
          ...
          <article class="box effect5 a">
            ...
            <figure> <a href="rafting.html" class="hover-effect a"><img width="270" height="160" alt="Enchanting South India" title="Enchanting South India" src="images/2.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 1 Days / 2 Nights </span>

              <div class="clearfix"></div><br>

              <span class="box-title" style="color: black; font-size: 15px;">Rafting <a style="padding-left: 40%;"></a></span>
             ...
             <!--  <p class="description">Chennai - Mahabalipuram - Trichy - Madurai - Bangalore - Mysore - Hassan - Hampi - Badami - Goa - Bombay</p>
 -->
              <div class="action"> <a class="button btn-small" href="rafting.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
        ...
        <li>
           ...
           <article class="box effect5 a">
            ...
            <figure> <a href="bunjeejumping.html" class="hover-effect a"><img width="270" height="160" alt="Enchanting South India" title="Enchanting South India" src="images/3.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 1 Days / 2 Nights </span>

              <div class="clearfix"></div><br>

              <span class="box-title" style="color: black; font-size: 15px;">Bunjee Jumping <a style="padding-left: 20%;"></a></span>
             ...
             <!--  <p class="description">Chennai - Mahabalipuram - Trichy - Madurai - Bangalore - Mysore - Hassan - Hampi - Badami - Goa - Bombay</p>
 -->
              <div class="action"> <a class="button btn-small" href="bunjeejumping.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
        ...
        <li>
          ...
          <article class="box effect5 a">
            ...
            <figure> <a href="trekking.html" class="hover-effect a"><img width="270" height="160" alt="Enchanting South India" title="Enchanting South India" src="images/4.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 1 Days / 2 Nights </span>

              <div class="clearfix"></div><br>

              <span class="box-title" style="color: black; font-size: 15px;">Trekking<a style="padding-left: 40%;"></a></span>
             ...
             <!--  <p class="description">Chennai - Mahabalipuram - Trichy - Madurai - Bangalore - Mysore - Hassan - Hampi - Badami - Goa - Bombay</p>
 -->
              <div class="action"> <a class="button btn-small" href="trekking.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
        ...
        <li>
           ...
           <article class="box effect5 a">
            ...
            <figure> <a href="junglesafari.html" class="hover-effect a"><img width="270" height="160" alt="Enchanting South India" title="Enchanting South India" src="images/5.jpg"></a> </figure>

            <div class="details"> <span class="daynit"> 1 Days / 2 Nights </span>

              <div class="clearfix"></div><br>

              <span class="box-title" style="color: black; font-size: 15px;">Jungle Safari <a style="padding-left: 20%;"></a></span>
             ...
             <!--  <p class="description">Chennai - Mahabalipuram - Trichy - Madurai - Bangalore - Mysore - Hassan - Hampi - Badami - Goa - Bombay</p>
 -->
              <div class="action"> <a class="button btn-small" href="junglesafari.html">DETAILS</a> <a class="button btn-small yellow js-open-modal" href="#"  data-modal-id="popup1">ENQUIRY</a> </div>
  ...
  <div class="col-md-12">
    ...
    <section class="testimonial-sect   " style="  background-image: url(img/bg.png);  height: auto;">
  ...
  <div class="container ">
      ...
      <div class="block row">
                        ...
                        <div class="col-md-12">
                            ...
                            <h2 align="center" style="font-size: 30px;"><b>BEST RATED SHIV SHAKTI TRAVEL AGENCY</b></h2>
                            ...
                            <div class="testimonial style1 box">
                                ...
                                <ul class="slides ">
                                    ...
                                    <li>
                                        ...
                                        <p class="description " style="color: #fff;">Great packages by Shiv Shakti Travels their experts help a lot & provide you with the best solutions. must consider the agency when you are planning of going out some where for a trip/tour with friends/ family members  ]</p>

                                        <div class="author clearfix">

                                              <h5 class="name t"><img src="img/news-submit.gif"></h5>
                                    ...
                                    <li>
                                        ...
                                        <p class="description" style="color: #fff;">Shiv Shakti Travels best Travel agency my char dham trip nice...  All sightseeing places covered. Thanks Shiv Shakti Travels</p>

                                        <div class="author clearfix">

                                                 <h5 class="name t"><img src="img/news-submit2.gif"></h5>
                                    ...
                                    <li>
                                        ...
                                        <p class="description" style="color: #fff;"> Shiv Shakti Travels is a best travel agency in Haridwar and for Chardham package...i have done many tour and Events with Shiv Shakti Travels Team....he make our tour so enjoyfull .Every person are very helpful ...service was so good .. </p>

                                        <div class="author clearfix">

                                            

                                            <h5 class="name t"><img src="img/news-submit3.gif"></h5>
 ...
 <li>
                                        ...
                                        <p class="description" style="color: #fff;"> Shiv Shakti Travels is best travel service provider in haridwar they have provide good service all over the places in uttarakhand and they are amezing with all kind of your. </p>

                                        <div class="author clearfix">

                                            

                                            <h5 class="name t"><img src="img/news-submit4.gif"></h5>
 ...
 <li>
                                        ...
                                        <p class="description" style="color: #fff;"> Shiv Shakti Travels provided a good SERVICE in char dham yara the have excellent staff whor work together for your better experience with them. They have all kind of information regarding your tour package in uttarakhand. </p>

                                        <div class="author clearfix">

                                            

                                            <h5 class="name t"><img src="img/news-submit5.gif"></h5>
 ...
 <footer id="footer">
    ...
    <!----------- Footer ------------>
          ...
          <div class="col-md-3 footer-brantd animated fadeInLeft "><br><br>
              <h2 style="color: #fdb714;">Shiv Shakti Travels</h2>
                <p style="font-size: 14px; color: #fff;">Booking, reviews and advices on hotels, resorts, flights, vacation rentals, travel packages, and lots more!</p>
                  <ul class="social-icons clearfix">

              <li class="twitter"><a title="twitter" href="#" data-toggle="tooltip"  rel="nofollow"><i class="soap-icon-twitter"></i></a></li>

              <li class="googleplus"><a title="googleplus" href="#" data-toggle="tooltip" rel="nofollow"><i class="soap-icon-googleplus"></i></a></li>

              <li class="facebook"><a title="facebook" href="#" data-toggle="tooltip" rel="nofollow"><i class="soap-icon-facebook"></i></a></li>

              <li class="linkedin"><a title="linkedin" href="#" data-toggle="tooltip" rel="nofollow"><i class="soap-icon-linkedin"></i></a></li>

            </ul>
            </div>
          <div class="col-md-4 footer-nav animated fadeInUp"><br><br>
              <h4 style="color: #fdb714; font-size: 12px;">Our Services</h4>
               
                    <ul class="pages">
                        <li><a href="chardham-package.html">Chardham Packages</a></li>
                        <li><a href="adventure-tours.html">Adventure Tours</a></li>
                        <li><a href="teendham.html">Teen Dham Yatra </a></li>
                          <li><a href="nanital.htmll">Nainital Tour</a></li>
                          <li><a href="mussoorie.html">Mussoorie Packages</a></li>
                    </ul>
          

            </div>
          <div class="col-md-3 footer-social animated fadeInDown"><br><br>
              <h4 style="color: #fdb714; font-size: 14px;">Quick Links-</h4>
              <ul>
          ...
          <div class="col-md-2 footer-ns animated fadeInRight"><br><br>
              <h4 style="color: #fdb714; font-size: 14px;">Contact Info</h4>
              
                 <p style="color: white; font-size: 14px;"><i class="fas fa-map-marker-alt"></i>&nbsp;Address:&nbsp;Haridwar,<br>Uttarakhand </a></p><br>
             <p style="color: white; font-size: 14px;"><i class="fas fa-phone-volume"></i>&nbsp;+91 9758096152</a></p><br>
             <p style="color: white; font-size: 14px;">&nbsp;info@shivshaktitravels.in</p><br>
    ...
    <div class="bottom" style="background-color: #000;">

      <div class="container" >
 
        <div class="pull-left" style="font-size: 16px; color: #fdb714"> <a href="index.html" title="imperialvoyages - home"> </a> &nbsp;   &nbsp;   &nbsp; <br>&copy; 2020   Copyright Shiv Shakti Travel </div>
...
<div id="popup1" class="modal-box">
  ...
  <header> <a href="#" class="js-modal-close close"> <img src="images/close.png" class="img-responsive" alt="Close Btn" title="Close Btn"> </a> <span>Enquiry now or Call us  +91 9758096152 </span> </header>
...
<style type="text/css"> 
 ...
 input#s1:checked ~ label:nth-of-type(1) {
   box-shadow: 2px 4px rgba(0, 0, 0, .1) inset, 0 0 0 200px rgba(0, 0, 0, .2) inset;
}
 input#s1:checked ~ .sprites .sprite:nth-child(1) {
   display: block;
}
 input#s2:checked ~ label:nth-of-type(2) {
   box-shadow: 2px 4px rgba(0, 0, 0, .1) inset, 0 0 0 200px rgba(0, 0, 0, .2) inset;
}
 input#s2:checked ~ .sprites .sprite:nth-child(2) {
   display: block;
}
 input#s3:checked ~ label:nth-of-type(3) {
   box-shadow: 2px 4px rgba(0, 0, 0, .1) inset, 0 0 0 200px rgba(0, 0, 0, .2) inset;
}
 input#s3:checked ~ .sprites .sprite:nth-child(3) {
   display: block;
}
 input#s4:checked ~ label:nth-of-type(4) {
   box-shadow: 2px 4px rgba(0, 0, 0, .1) inset, 0 0 0 200px rgba(0, 0, 0, .2) inset;
}
 input#s4:checked ~ .sprites .sprite:nth-child(4) {
   display: block;
}
 ...
 .carSprite > img {
   ...
   top: 0;
   left: 0;
   animation: 5.6666666667s carSpriteAnim infinite step-end;
}
...
$("form#ftcontact").submit(function(event) {
...
<script type="text/javascript">
            ...
            function closeForm(){
                ...
                setTimeout('$("#messageSent").hide();$("#emailForm").slideUp("slow")', 2000);
...
<!-- Mirrored from www.imperialvoyages.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Jan 2020 11:02:39 GMT -->
</html>
