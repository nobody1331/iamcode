...
<head>
	...
	<title>Laurel Children Academy - Leading Primary Educational Institutions of Lucknow</title>
	<meta name="description"
		content="The main aim of the school is education to kids specially the poor and the most abandoned children." />
	<meta name="keywords" content="Leading Primary Educational Institutions of Lucknow, playgroup school in Lucknow" />
	<meta name="author" content="Laurel Children Academy">
	<meta name="robots" content="index, follow">
	<meta name="revisit-after" content="3 days">
	<link rel="shortcut icon" href="titel.png">
	...
	<div class="container" id="wrapper">
		...
		<header>
			...
			<nav role="navigation">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul>
						<li><a href="admission-form.pdf" target="_blank" class="text">Admission Form</a></li>
						<li class="active"><a href="index.html">Home</a></li>
						<li><a href="about.html">About us</a></li>
						<li><a href="blog.html">Admission Info</a></li>
						<li><a href="Important_info.html">Info for parents</a></li>
		...
		<section id="featured">
			...
			<div id="wowslider-container1">
				<div class="ws_images">
					<ul>
						<!-- <li><img src="images/wowslider/slide5.png" alt="This is the title" title="Education Is The Destiny" id="wows1_0"/>Give your child a new dynamic atmosphere</li>
							<li><img src="images/wowslider/slide1.png" alt="Another title" title="Education Is The Power" id="wows1_1"/>High class education with specialized teachers</li>
							<li><img src="images/wowslider/slide6.png" alt="Third title" title="Education Is The Light" id="wows1_2"/>We pour wisdom in little heads</li> -->

						<li>
							<img src="images/wowslider/1-lca-slide.png" alt="This is the title"
								title="Education Is The Destiny" id="wows1_0" />
							Give your child a new dynamic atmosphere
						</li>
						<li>
							<img src="images/wowslider/2-lca-slide.png" alt="Another title"
								title="Education Is The Power" id="wows1_1" />
							High class education with specialized teachers
						</li>
						<li>
							<img src="images/wowslider/3-lca-slide.png" alt="Third title" title="Education Is The Light"
								id="wows1_2" />
							We pour wisdom in little heads
						</li>
		...
		<section id="content" class="col-lg-7 col-md-8 col-sm-12">
			...
			<div class="cloud1" id="home12">
				<h1>Home</h1>
			</div>

			<div class="content-bg">

				<p> &nbsp; &nbsp; Welcome to the Laurel Children Academy. Education is meant to prepare the citizens of
					tomorrow and these future citizens take up their career under the guidance of learned teachers
					according to the aptitude and flair they possess. This institution is an integral part of the
					community addressing the needs of children living in the city. Laurel Children Academy (LCA) has the
					quality of relationship which makes it a happy school with a supportive and welcoming environment
					for all students. As a result, children grow in confidence and are able to participate in the wide
					range of opportunities available at our school.</p>

				<p> &nbsp; &nbsp; We encourage our students to follow their interests, develops new skills and most
					importantly to fully enjoy all the aspects of school life. The task of choosing a school that is
					right for your child is no doubt uppermost in your mind. At LCA, we quite simply want to provide the
					best education in the broadest sense for all our students.</p>

				<p style="text-align:center;"> <a target="_blank" class="prospectus" href="prospectus.pdf">View Our
						Prospectus</a> </p>
				<style>
					.prospectus {
						background: #C80007;
		...
		<div class="footer-menu">
			<div class="container">
				<div class="col-lg-6 col-md-6 col-sm-12 fa social-media">
					<a href="https://www.facebook.com/Laurel-children-academy-423230031158180/"
						target="_blank">&#xf082;</a>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12 footer-links">

					<a href="admission-form.pdf">Admission Form</a> /
					<a href="index.html">Home</a> /
					<a href="about.html">About</a> /
					<a href="blog.html">Admission Info</a> /
					<a href="Important_info.html">Info for parents</a> /
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="col-lg-12 col-md-12">
					<div class="para">
						<p style="color:#678aeb">Copyright &copy; 2014 Laurel Children Academy.All Rights Reserved.</p>
					</div>
					<div class="bottom_menu">
						<ul>
							<li><a href="terms.html">Terms &amp; Conditions</a></li>
							<li><a class="bordernone" href="privacy-policy.html">Privacy Policy</a></li>
							<li><a href="http://www.atqits.com" target="_blank"><img src="images/cmlogo.png"
										width="50%/"></a></li>
						</ul>
					</div>
					<div class="clear"> </div>
