...
$seo=$dbf->fetchSingle("seo_tbl","*","id=1");
?>
<!DOCTYPE html>
...
<meta name="keywords" content="<?php echo stripslashes($seo['meta_keywords']); ?>">
...
<?php $ban1=$dbf->fetchSingle("banner","*","id<>0");?>
<div class="item active">

<img src="banner/thumb/<?php echo $ban1['img']; ?>" alt="<?php echo $ban1['img']; ?>" />

<div class="fw_al_009_slide">
<h2 data-animation="animated fadeInRight"><?php echo $ban1['content1']; ?></h2>
<h4 data-animation="animated fadeInLeft"><?php echo $ban1['content2']; ?></h4>
<a href="#" class="mt_btn_yellow" data-animation="animated fadeInRight">Apply Now</a>
</div>
</div>

<?php foreach($dbf->fetch("banner","id<>'$ban1[id]'") as $ban2){ ?>
<div class="item">

<img src="banner/thumb/<?php echo $ban2['img']; ?>" alt="<?php echo $ban2['img']; ?>" />

<div class="fw_al_009_slide">
<h2 data-animation="animated fadeInRight"><?php echo $ban2['content1']; ?></h2>
<h4 data-animation="animated fadeInLeft"><?php echo $ban2['content2']; ?></h4>
<a href="#" class="mt_btn_yellow" data-animation="animated fadeInRight">Apply Now</a>
</div>
</div>
<?php } ?>
...
<?php $abt=$dbf->fetchSingle("pages","*","id=1"); ?>
<section id="mt_about">
<div class="container">
...
<div class="col-sm-4">
<div class="">
<img src="pages/thumb/<?php echo $abt['img']; ?>" alt="<?php echo $abt['img']; ?>" class="abt_im_1">
</div>
</div>
<div class="col-sm-8">
...
<h3>About RCI</h3>
<h2 class="mar-0"><?php echo $abt['title']; ?></h2>
</div>
<p><?php echo substr($abt['description'],0,200); ?>
</p>
<a href="about.php" class="mt_btn_yellow">Learn More</a>
</div>
</div>
</div>
</div>
...
<div class="row slider-ft-course asen_maw">
<?php foreach($dbf->fetch("courses","id<>0") as $crs){ ?>
<div class="col-sm-4">
<div class="featured-item">
<div class="feat-img">
<img src="course/thumb/<?php echo $crs['img']; ?>" alt="<?php echo $crs['img']; ?>">
<div class="th-name">

<h5><?php echo $crs['course_name']; ?></h5>
</div>
<div class="overlayPort">
<ul class="info text-center list-inline">
<li>
<a href="course-details.php?id=<?php echo $crs['id']; ?>">View Detail</a>
</li>
</ul>
</div>
</div>
...
<div class="col-md-12 col-sm-12 col-xs-12 facts_col">
<!--<div class="search-box-wrap" style="display: block;">
<div class="searchform" role="search">
<form class="search-form" method="get" action="https://htmldesigntemplates.com/html/RCI/bootstrap3/.">
<input type="text" name="s" id="ch" placeholder="What do you want to learn today..." value="" class="search-field">
...
<p class="fun-facts_figure timer" data-to="7" data-speed="3000"></p>
<span class="fun-facts_title"> AWARDS </span>
</div>
<div class="fun-facts_wrapper">
<i class="fa fa-graduation-cap"></i>
<p class="fun-facts_figure timer" data-to="782" data-speed="3000"></p>
<span class="fun-facts_title"> STUDENTS </span>
</div>
<div class="fun-facts_wrapper">
<i class="fa fa-university"></i>
<p class="fun-facts_figure timer" data-to="5" data-speed="3000"></p>
...
<section id="educate-team" class="ed_team_ie">
<div class="container">
<div class="row">
<div class="col-md-4 col-sm-6">

<div class="inner-heading">
<div class="inh_eduteam">
<h3>Our Teachers</h3>
<h2>Meet our expert teachers</h2>
<div class="testimonial-abt">
<p>We have best faculty with great experiance. Best quality and guranteed success with perfect guidence.</p>
</div>
</div>
</div>
</div>
<div class="col-md-8 col-sm-6">
<div class="row edu_team_slider3 slider-educteam">
<?php foreach($dbf->fetch("faculty","id<>0") as $fac){ ?>
<div class="col-md-4 col-sm-6 col-xs-12 item">
<div class="team_member">
<figure class="effect-julia">
<img src="faculty/thumb/<?php echo $fac['img']; ?>" alt="team">
</figure>
<div class="member_name">
<h3><?php echo $fac['faculty_name']; ?></h3>
<span><?php echo $fac['designation']; ?></span>
</div>
</div>
</div>
<?php } ?>
...
<?php foreach($dbf->fetch("testimonial","id<>0") as $test){ ?>
<div class="col-sm-4">
 <div class="item">
<div class="testimonial_main">
<p><?php echo $test['message']; ?></p>
<div class="client-pic"><img src="testimonial/thumb/<?php echo $test['img']; ?>" alt="<?php echo $test['img']; ?>"></div>
<h4>
<a href="#" class="text-uppercase"><?php echo $test['name']; ?></a>
<span><?php echo $test['designation']; ?></span>
</h4>
</div>
</div>
</div>
...
<div class="row">
<?php foreach($dbf->fetch("gallery","id<>0 LIMIT 0,6") as $gal){ ?>
<div class="col-sm-4 mix">
<div class="item port-popup">
<a href="gallery/thumb/<?php echo $gal['img']; ?>" title="">
<img src="gallery/thumb/<?php echo $gal['img']; ?>" alt="">
...
<div class="row">
<?php  foreach($dbf->fetch("blog","id<>0 ORDER BY blog_date DESC") as $blog){
		$cnt_comm=$dbf->countRows("blog_comments","blog_id='$blog[id]' AND status=1");
?>
<div class="col-md-4 col-sm-12 col-xs-12 grid-item-a">
<div class="blog-post_wrapper front-wrapper">
<div class="blog-post-inner_wrapper">
<div class="blog-post-image">
<div class="clearfix">
<div class="img detail-im">
<img src="blog/thumb/<?php echo $blog['img']; ?>" alt="<?php echo $blog['img']; ?>" class="img-responsive center-block post_img" />
</div>
</div>
</div>
...
<div class="post-date">
<p><?php echo date("M Y",strtotime($blog['blog_date'])); ?></p>
</div>
<h3 class="post-title entry-title">
<a href="blog-details.php?id=<?php echo $blog['id']; ?>"><?php echo $blog['title']; ?></a>
</h3>

<div class="post_bottom">
<div class="bottom_list user_info_base">

<p><?php echo $blog['auther_name']; ?></p>
</div>
<div class="bottom_list user_post_cmt">
<a href="#"><i class="ion-ios-chatbubble-outline"></i>&nbsp;
Comments (<?php echo $cnt_comm; ?>)</a>
</div>
</div>
</div>
</div>
...
<script type="text/javascript">(function(){window['__CF$cv$params']={r:'6aaebaba78b30ef0',m:'73Hzh_dyfTy5JTuz2fGMA7K5bjC4b9O2_fkWYOkyUH8-1636373754-0-AdqxM1Vt87qq54dskk/3EjLJCfMes/i+33odyXbUsrOE07CZEkTrFSuecCsMqPYntyHgSjqqsKgRIcPi3JFvestsyxo6//3ssa00Cq6DrdHQT88k8PIMSgXZyfluExZZ2/nOCgcYAtfBK3bRS9/mwhGzqOobPEV3NwDKIcZrAoVr',s:[0x6cd8119948,0x3eb6c078ae],u:'/cdn-cgi/challenge-platform/h/b'}})();</script></body>
