...
<html>
<head>
<title>Welcome Flightsreserve LLC </title>
...
<div class="carousel-inner" role="listbox">
	...
	<div class="item active ">
			...
			<img src="paradise/images/slider/flightbanner.jpg" alt="portfolio_078_01">
				
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
						<h1><a href="domestic-holidays.php">BOOK YOUR FLIGHT</a></h1>		
			...
			<img src="paradise/images/slider/holidaybanner.jpg" alt="portfolio_078_01">
				
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				
						<h1><a href="international-holidays.php">BOOK YOUR HOLIDAY</a></h1>
...
if(notEmpty(destination, "Please enter your destination", "errDestination")){
if(notEmpty(traveldate, "Please enter your Message", "errTraveldate")){
...
return false;
    ...
    <div class="dtlpgright222">
	 <form method="post" action="hotelaction.php" onsubmit='return formValidator()' >
<h1 id="Req"></h1>
...
<input type="text" name="phone" id="phone" value="" placeholder="Your Mobile No." class="setme"><br/>
<span id="errPhone" class="errmsg"></span>
</div>

<div class="halfinput">
 <p>Email id<span></span></p>
<input type="text" name="email" id="email" value="" placeholder="Your Email Id" class="setme"><br/>
<span id="errEmail" class="errmsg"></span>
</div>


<div class="halfinput">
 <p>No. of Pax<span>*</span></p>
<input type="number" name="pax" id="pax" value="" placeholder="No. of Pax" class="setme"><br/>
<span id="errPax" class="errmsg"></span>
</div>

<div class="halfinput">
 <p>From<span>*</span></p>
<input type="text" name="from" id="from" value="" placeholder="Flight From where" class="setme"><br/>
<span id="errFrom" class="errmsg"></span>
</div>

<div class="halfinput">
 <p>To<span>*</span></p>
<input type="text" name="to" id="to" value="" placeholder="Where to go" class="setme"><br/>
...
<div class="halfinput">
 <p> Date of Departure<span>*</span></p>
<input type="date" name="bookingD" class="datepicker" value="" placeholder="Flight Booking Date" class="setme"><br/>
<span id="errBooking" class="errmsg"></span>
</div>
  	

<div class="halfinput">
 <p> Date of Coming<span>*</span></p>
<input type="date" name="bookingC" class="datepicker" value="" placeholder="Flight Booking Date" class="setme"><br/>
<span id="errBooking" class="errmsg"></span>
</div>

<div class="halfinput">
 <p>Flight Timing<span>*</span></p>
<select  type="time" name="time"  id="time" value="time">
<option value="04:00 AM to 08:00 AM">04:00 AM to 08:00 AM </option>
<option value="08:00 AM to 12:30 PM">08:00 AM to 12:30 PM</option>
<option value="12:30 PM to 04:00 PM">12:30 PM to 04:00 PM</option>
<option value="04:30 PM to 7:30 PM">04:30 PM to 7:30 PM</option>
<option value="08:00 PM to 11:30 PM">08:00 PM to 11:30 PM</option>
</select>
</div>

<div class="text-right">
<input type='submit' name='submit' value='Submit' class="theme-btn rounded-btn-bluue" />
</div>
  ...
  <div class="service-box">
    <div class="service-box01 center">
	  <img src="image/unsolddeals.png">
	  <h4>Call Us for Unsold Flights Deals</h4>
	  <p>Get unsold flight deals with Flightsreserv.</p>

	</div>
	<div class="service-box01 center">
		  <img src="image/24support.png">
	  <h4> 24/7 Help & Support</h4>
	  <p>We will provide you Live 24/7 Support.</p>

	</div>
	<div class="service-box01 center">
	  <img src="image/promo.png">
	  <h4>Big Savings + Great Coupon Codes</h4>
	  <p>Money Savings + Discounted Coupon Codes</p>
	</div>
	
	<div class="service-box01 center">
	  <img src="image/flighticon.png">
	  <h4>Fly in comfort</h4>
	  <p>Fly in Comfort and get special offers on over 500 Airlines</p>
	...
	<div class="controller">
    <div class="pilgrimagesection">
	<h1>Featured Flight Deals</h1>
<h2>We serve many more flights from your hub</h2>
	
     
	 <div class="pilgrimagebox1">    
  <a href="#"><img src="image/parisflight.jpg"></a>
	    <h1>Paris</h1>	 
		<h2>London To Paris</h2>	
		<h3>One Way Flight</h3>
		<h4>20% off</h4>
		<h5><a href="index.php#Req">Book Flight</a></h5>		
	</div>	
	
	    <div class="pilgrimagebox2"> 
     <a href="#"><img src="image/londonflight.jpg"></a>	
   <h1>Spain</h1>	
        <h2>Dubai To Spain</h2>	
		<h3>Round Trip Flight</h3>
		<h4>8% off</h4>
<h5><a href="index.php#Req">Book Flight</a></h5>	
	</div>	
	
	    <div class="pilgrimagebox3">     
  <a href="#"><img src="image/australiafligth.jpg"></a>
   <h1>Australia</h1>
       <h2>Bangkok To Australia</h2>	
		<h3>One Way Flight</h3>
		<h4>12% off</h4>
<h5><a href="index.php#Req">Book Flight</a></h5>	
	</div>	
		...
		<div id="kenburns_061111" class="carousel slide ps_indicators_txt_icon ps_control_txt_icon kbrns_zoomInOut thumb_scroll_x swipe_x ps_easeOutQuart" data-ride="carousel" data-pause="hover" data-interval="4000" data-duration="2000">
<div class="carousel-inner" role="listbox">
			...
			<img src="paradise/images/slider/bottombanner.jpg" alt="portfolio_078_01">
		...
		<p>ENJOY AFFORDABLE TRAVEL OPTIONS</p>
		<h1><a href="index.php#Req">Send A Request</a></h1>
		</div>
...
<h1 id="h">Top Selling Holiday Deals</h1>
<h2>We serve many more Travel Holiday Themes</h2>


<div class="holidaychild-1">
<a href="usa-holiday-packages.php"><img src="image/usa.jpg"></a>
<h1>USA</h1>	
</div>


<div class="holidaychild-2">
<a href="europe-holiday-packages.php"><img src="image/europe.jpg"></a>
<h1>EUROPE</h1>	
</div>	

<div class="holidaychild-4">
<a href="spain-holiday-packages.php"><img src="image/spain.jpg"></a>
<h1>SPAIN</h1>	
</div>	


<div class="holidaychild-3">
<a href="canada-holiday-packages.php"><img src="image/canada.jpg"></a>
<h1>CANADA</h1>	
</div>		
