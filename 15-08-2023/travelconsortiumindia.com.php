...
<div class="mainslider">
        ...
        top: 0px; left: 0px; width: 1330px; height:500px; overflow: hidden;">
            <!-- Loading Screen -->

            <!-- Slides Container -->
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1330px; height: 500px; overflow: hidden;">
                <div>
                    <img u="image" src="img/1920/Slider_01.jpg" />
                </div>
                <div>
                    <img u="image" src="img/1920/Slider_02.jpg" />
                </div>
                <div>
                    <img u="image" src="img/1920/Slider_03.jpg" />
                </div>
				<div>
                    <img u="image" src="img/1920/Slider_04.jpg" />
                </div>
				<div>
                    <img u="image" src="img/1920/Slider_05.jpg" />
                </div>
				<div>
                    <img u="image" src="img/1920/Slider_06.jpg" />
                </div>
				<div>
                    <img u="image" src="img/1920/Slider_07.jpg" />
                </div>
				<div>
                    <img u="image" src="img/1920/Slider_08.jpg" />
                </div>
				<div>
                    <img u="image" src="img/1920/Slider_09.jpg" />
                </div>
				<div>
                    <img u="image" src="img/1920/Slider_10.jpg" />
                </div>
            </div>
...
<div id="testimonials">
		<div id="test_container">
			<div class="testimonial">
				<h3 class="testimonial_name">Your reliable travel partner of your journey</h3>
			</div>
			<div class="testimonial">
				<h3 class="testimonial_name">A complete Travel & Hospitality solutions</h3>
			</div>
			<div class="testimonial">
				<h3 class="testimonial_name">Be the eye witness of India, Sri Lanka, Bhutan, Nepal & Myanmar</h3>
			</div>
			<div class="testimonial">
				<h3 class="testimonial_name">Experience world class services in India</h3>
			</div>
			<div class="testimonial">
				<h3 class="testimonial_name">The Travel Expert Team over 12 year's experienced</h3>
			</div>


<div class="testimonial">
				<h3 class="testimonial_name">Excellence in Customised Tours</h3>
			</div>

<div class="testimonial">
				<h3 class="testimonial_name">Secure & Easy mode of payment</h3>
			</div>


<div class="testimonial">
				<h3 class="testimonial_name">Guaranteed for Best Price</h3>
			</div>


<div class="testimonial">
				<h3 class="testimonial_name">Unforgettable tours to Wild Life, Heritage, Beauty, Culture & Diversity</h3>
			</div>
<div class="testimonial">
				<h3 class="testimonial_name">Experience our unique Worldwide International Tours</h3>
			</div>
		</div>
</div>

 <p class="welcome01">
  <br>Deeply ingrained in tourism, Travel Consortium India is a B2B Destination
Management Company specialized in every aspect of travel which offers the exciting
range of tour packages of India and its subcontinent. The company has its own ground
service offices network in major destinations in India branch offices in the Sri
Lanka, Nepal, Bhutan, Maldives, Myanmar and Bangaladesh.
Our team provides the round the clock service with the priority of customer
satisfaction. Travel Consortium India focuses on all Individual group traveler. Our
experienced and well trained staff are masters in designing the Tailor Made Leisure,
Cultural, Historical, Wild Life, Adventures, Charters and Cruises Tours.
<br><br>Travel Consortium India provides a wide ranges of experiences, the Wi-Fi-equipped
modern transport fleet, and selected experienced deep knowledgeable guides from
the panel at each destination to our each clients.
 </p>
</div>
<div class="three_banner">
<div class="banner01">
<div class="zitem">
	<a href="http://travelconsortiumindia.com/tours_detail.php?id=45"><img src="img/first banner.jpg" alt="Cycliner" title="" width="360" height="250"/></a>
</div>
</div>
<div class="banner02">
<div class="zitem">
	<a href="http://travelconsortiumindia.com/tours_detail.php?id=58"><img src="img/second banner.jpg" alt="Cycliner" title="" width="360" height="250"/></a>
</div>
</div>
<div class="banner02">
<div class="zitem">
	<a href="http://travelconsortiumindia.com/tours_detail.php?id=61"><img src="img/third banner.jpg" alt="Cycliner" title="" width="360" height="250"/></a>
</div>
</div>
</div>
...
<div class="right_pack">
    ...
    <h3 class="show_p_heading">Our Most Selling Tours</h3>
	
	 <?php $qry1="select * from subcategory where category='7'";
   $ss1=mysql_query($qry1);
   while($dat=mysql_fetch_array($ss1))
   {
	   ?>
   <div class="first_p">
   <div class="zitem1">
	<img src="image/<?php echo $dat['image'];?>" alt="Cycliner" title="" width="140" height="110"/>
    </div>
	   <div class="first_pcc">
	     <p class="first_pd"><?php echo $dat['subcat'];?></p>
	      <div class="first_ppee"><?php echo $dat['dest'];?> </div>
	  
	   </div>
  <a href="tours.php?tours=<?php echo $dat['id'];?>" class="read_more">See Details<img src="images/link spot.png" class="l_spot"/></a>
   </div>
   <?php } ?>
   ...
   <h3 class="show_p_heading02">Indian Sub Continent</h3>
   
    <?php $qry2="select * from subcategory where category='8'";
   $ss2=mysql_query($qry2);
   while($dat1=mysql_fetch_array($ss2))
   {
   ...
   <div class="first_p">
      <div class="zitem1">
	   <img src="image/<?php echo $dat1['image'];?>" alt="Cycliner" title="" width="140" height="110"/>
      </div>
	   <div class="first_pcc">
	     <p class="first_pd"><?php echo $dat1['subcat'];?></p>
	    	     <div class="first_ppee"><?php echo $dat1['dest'];?> </div>
	
	   </div>
 <a href="tours.php?tours=<?php echo $dat1['id'];?>" class="read_more">See Details<img src="images/link spot.png" class="l_spot"/></a>
   </div>
   <?php } ?>
