...
<html>
<head>
<title>WELCOME TO DESTINY TRIPS</title>
...
<div id="kenburns_061" class="carousel slide ps_indicators_txt_icon ps_control_txt_icon kbrns_zoomInOut thumb_scroll_x swipe_x ps_easeOutQuart" data-ride="carousel" data-interval="2000" data-duration="2000">
...
<div class="carousel-inner" role="listbox">
		...
		<div class="item">
			...
			<img src="paradise/images/slider/slider2.webp" alt="portfolio_078_01">
				...
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				<h1><a href="#">MICE TOUR</a></h1>
						<h2>Meeting | Incentives | Conference | Events</h2>				
...
<div class="cantentara6">

		<h1>MICE | TRADE FAIRS | HOLIDAYS</h1>
	
			<h2>DESTINY TRIPS</h2>
<p>
Business groups anticipate getting the best and most spectacular business trips in addition to pleasure holidays 
as the tourism industry is constantly evolving. Destiny Trips has created MICE tour packages for organisations and groups, 
offering them well crafted programmes based on a range of themes and subjects. Meetings, Incentives, Conferences, and 
Exhibitions (MICE) are referred to together as these events. We strive to offer business organisations the most affordable 
and desired packages because we are aware of their objectives and needs.
<br><br>
...
if(notEmpty(service, "", "errService")){
if(notEmpty(traveller, "", "errTraveller")){
...
<div class="form">
  <div class="form-head">
    <h6 id="form">SUBMIT A REQUEST</h2>
  </div>
  <div class="form01">
...
<div class="fieeld-label">What you need?<span class="req">*</span></div>
<select  type="service" name="service"  id="service" value="service">
	   <option>Trade Fairs</option>
	   <option>International Holiday</option>
	   <option>Domestic Holiday</option>
	   <option>Family Holiday</option>
	   <option>Honeymoon Trips</option>
	   	<option>Mice Tour</option>
...
<input type='submit' name='submit' value='Submit' class="theme-btn roundedd-btn-bblue" />
...
<div class="controller">
	<div class="indextradesectioncontroll">	
	    <h1>UPCOMING BUSINESS TRADE FAIRS</h1>	
			    <h2>Join the Business Delegation from India</h2>
		
		<div class="tradeindexsction1">
		<a href="index.php#form"><img src="image/k.webp"></a>
		<h1><a href="index.php#form">Send Request</a></h1>	
	    <h2>K Expo 2023</h2>
		  <h3>Germany</h3>
		...
		<div class="tradeindexsction2">
		<a href="index.php#form"><img src="image/interpack.webp"></a>
		<h1><a href="index.php#form">Send Request</a></h1>	
		<h2>Interpack 2023</h2>	
		 <h3>Germany</h3>
     
		</div>
		
		
			<div class="tradeindexsction3">
		<a href="index.php#form"><img src="image/hannovermesse.webp"></a>
		<h1><a href="index.php#form">Send Request</a></h1>	
		<h2>Hannover 2023</h2>
		 <h3>Germany</h3>
					...
					<div class="tradeindexsction4">
		<a href="index.php#form"><img src="image/itma.webp"></a>
		<h1><a href="index.php#form">Send Request</a></h1>	
		<h2>Itma 2023</h2>
        <h3>Italy</h3>		
...
<div class="controller">
	<div class="indextradesectioncontroll">	
	    <h1>TOP HOLIDAY DEALS</h1>	
			    <h2>Family Tours | Honeymoon Tours | Business Tours</h2>
		
		<div class="tradeindexsction1">
		<a href="thailand-holiday-package.php"><img src="image/thailandindex.webp"></a>
	    <h2>Thailand</h2>
		...
		<div class="tradeindexsction2">
		<a href="singapore-holiday-package.php"><img src="image/singaporeindex.webp"></a>
		...
		<h2>Singapore</h2>	
			...
			<div class="tradeindexsction3">
		<a href="dubai-holiday-package.php"><img src="image/dubaiindex.webp"></a>
		...
		<h2>Dubai</h2>
					...
					<div class="tradeindexsction4">
		<a href="europe-holiday-package.php"><img src="image/europeindex.webp"></a>
		...
		<h2>Europe</h2>
			...
			<div class="footerfullimage">
	  <img src="image/indexfooterbanner.webp">
	 </div> 	
