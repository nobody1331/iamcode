...
<html>
<head>
<title>WELCOME TO STEP HOLIDAYS</title>
...
return false;
	  ...
	  <div class="top-pattiauto">
    <div class="dtlpgright222">
	  <h2 id="send">Online Booking Request</h2>
	 <form method="post" action="contactaction1.php" onsubmit='return formValidator()' >
...
<div class="halfinput">
 <p><span>*</span> Destination</p>
<input type="text" name="destination" id="destination" value="" placeholder="Destination" class="setme"><br/>
<span id="errDestination" class="errmsg"></span>
</div>

<div class="halfinput">
 <p><span>*</span>How Many Pax</p>
<select name="pax">
<option selected>No of Pax</option>
...
<div class="halfinput">
 <p><span>*</span> Travel Date</p>
<input type="date" name="date" id="date" value="" placeholder="Travel Date" class="setme"><br/>
<span id="errDate" class="errmsg"></span>
</div>
<div class="halfinputt">
  <p><span>*</span> Special Remarks</p>
<textarea name="message" id="message" placeholder="Your Message" class="setme"></textarea><br/>
<span id="errRemarks" class="errmsg"></span>
</div>
...
<div class="cantantareaa">
	...
	<h1 id="dom">Special Interest Domestic Packages</h1>
		<p>We are serving the best affordable discounted deals & offer on domestic Packages</p>
		  	 <div class="maincontroller">	
			<div class="wrapper2">
	...
	<div class="couple_ox">
					<a href="index.php#send"><img src="images/kashmirpkg1.jpg"></a>
						<h1>Glorious Kashmir</h1>
						<h3>Starting from:</br><span>Rs. 11,999/-</span></h3>
      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
				</div>
				
				
								<div class="couple_ox">
					<a href="index.php#send"><img src="images/kashmirexplore.png"></a>
						<h1>Kashmir A Paradise</h1>
						<h3>Starting from:</br><span>Rs. 15,000/-</span></h3>
	      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
				</div>
				
				<div class="couple_ox">
					<a href="index.php#send"><img src="images/exploreladakh.png"></a>
						<h1>Explore Ladakh</h1>
						<h3>Starting from:</br><span>Rs. 18,500/-</span></h3>
				      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
				</div>		
				...
				<div class="couple_ox">
					<a href="index.php#send"><img src="images/ladakhpkg1.jpg"></a>
						<h1>Ladakh Outing</h1>
						<h3>Starting from:</br><span>Rs. 21,999/-</span></h3>
      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
				</div>
...
<div class="content1">
    <div class="heading">
	   <h1 id="int">Top Selling International Destinations</h1>
	   <p>We are serving the best affordable discounted deals & offer on International holidays</p>
	</div>

  	 <div class="maincontroller">
<div class="roww">
    <div class="box1">
       <img src="images/dubaiblog.jpg">
	   
	<div class="overlay">
       <h1>Dubai</h1>
	   <h2>4 Nights / 5 Days</h2>
	   <h3>Starting @ 22,990/-</h3>
      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
	</div>
     ...
     <div class="box1">
       <img src="images/singporeblog.jpg">
	   
	<div class="overlay">
       <h1>Singpore</h1>
	   <h2>4 Nights / 5 Days</h2>
	   <h3>Starting @ 24,500/-</h3>
      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
	</div>
    ...
    <div class="box1">
       <img src="images/thaialndblog.jpg">
	   
	<div class="overlay">
       <h1>Thailand</h1>
	   <h2>5 Nights / 6 Days</h2>
	   <h3>Starting @ 22,999/-</h3>
      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
	</div>
	    ...
	    <div class="box1">
       <img src="images/srilankablog.jpg">
	   
	<div class="overlay">
       <h1>Srilanka</h1>
	   <h2>4 Nights / 5 Days</h2>
	   <h3>Starting @ 17,500/-</h3>
      <h4><a href="index.php#send">SEND A QUOTE</a></h4>
	</div>
...
<div class="row2">
    ...
    <div class="box3">
	   <div class="col1">
		...
		<h1>Holidays Deals</h1>
		<p>Step holiday provides best to best possible cheapest Domestic and International holiday package Deals on discount to our clients</p>
			<h2><a href="index.php#send">Book Now</a></h2>
	   </div>
	   ...
	   <div class="col1">
		...
		<p>Step holiday bring to you mind-blowing hotel offers and an array of hotel deals on domestic as well as international hotels.</p>
			<h2><a href="index.php#send">Book Now</a></h2>
	   </div>
	   ...
	   <div class="col1">
		...
		<p>Step holiday has brought many firsts to its customers, providing them ease of flight booking along with best budget options.</p>
					<h2><a href="index.php#send">Book Now</a></h2>
	   </div>
	   ...
	   <div class="col1">
		...
		<h1>Visa Services</h1>
		<p>Step holiday will help you with the visa process: right from getting the documents ready to going for the actual visa interview</p>
			<h2><a href="index.php#send">Book Now</a></h2>
	   </div>
	</div>
