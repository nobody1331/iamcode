...
<html>
<head>
<title>Welcome To Swastik Security Solution</title>
	...
	<div class="carousel-inner" role="listbox">
			...
			<img src="paradise/images/slider/1.jpg" alt="portfolio_078_01">
				...
				<h1>ACCESS CONTROL SOLUTION</h1>
					...
					<a href="access-control-solution.php">View Details</a>
				</div>
            ...
            <div class="item active">
				...
				<div class="kenburns_061_slide" data-animation="animated fadeInLeft">
					...
					<a href="cctv-security.php">View Details</a>
				</div>
			...
			<div class="item">
				...
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
					...
					<h1>ELECTRO MEGNETIC LOCKS</h1>
					
					<a href="Em-lock/electro-magnetic-lock-with-feedback.php">View Details</a>
				</div>
			...
			<div class="item">
				...
				<div class="kenburns_061_slide" data-animation="animated fadeInLeft">
					...
					<a href="fire-alarm.php">View Details</a>
				</div>
...
<div class="cantantarea">
	...
	<h1>WELCOME TO SWASTIK SECURITY SOLUTION</h1>
	<p>Locks & Accessories | Access Control System | CCTV Security| Fire Alarm</p>
	
	<div class="wrapper">
		
			<div class="container1">
				<a href="assaabloy.php"><img src="image/d1.png"></a>
				<h1><a href="assaabloy.php">ASSAABLOY </a></h1>

			</div>
			
			<div class="container1">
				<a href="electro-megneti-locks.php"><img src="image/d3.png"></a>
				<h1><a href="locks-accessories.php">LOCKS & ACCESSORIES</a></h1>

			</div>
			
			<div class="container1">
				<a href="biometric-rfid-terminals.php"><img src="image/d2.png"></a>
				<h1><a href="biometric-products.php">BIOMATRICS / VIRDI </a></h1>

			</div>
			
			<div class="container1">
				<a href="access-control-system-image.php"><img src="image/d4.png"></a>
				<h1><a href="access-control-system.php">ACCESS CONTROL SYSTEM </a></h1>

			</div>
			
			<div class="container1">
				<a href="cctv-image.php"><img src="image/d5.png"></a>
				<h1><a href="cctv-security.php">CCTV SECURITY </a></h1>

			</div>
			
			<div class="container1">
				<a href="fire-alarm-image.php"><img src="image/d6.png"></a>
				<h1><a href="fire-alarm.php">FIRE ALARM SYSTEM </a></h1>
...
<div class="box">
	<img src="image/cctv.jpg">
	<h1>GET THE BEST QUALITY PRODUCTS</h1>
	<p>
	Locks & Accessories | Virdi | Biometrics | Access Control Systems | CCTV | Fire Alarm</p>
...
<div id="portfolio_078_mov_all_col_4" class="carousel slide portfolio_078 portfolio_078_control_button portfolio_078_indicators thumb_scroll_x swipe_x ps_easeOutCubic" data-ride="carousel" data-pause="hover" data-interval="5000" data-duration="2000">
				...
				<div class="row"> 
					...
					<div class="col-xs-12 col-sm-6 col-md-3 portfolio_078_grid"> 
						<div class="portfolio_078_wrapper"> 
							...
							<!-- Image -->
							<img src="paradise/images/cctv.png" alt="portfolio_078_01">
						<!-- <div class="linebox"><h1>Beach Tour</h1></div> -->
						<!-- <div class="linebox1"><h1>3 Days 2 Nights</h1></div> -->

							<div class="portfolio_078_content portfolio_078_content_col_4">
									<div class="portfolio_078_link"> <!-- Icons -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 portfolio_078_grid"> 
						<div class="portfolio_078_wrapper"> 
							<!-- Image -->
						<img src="paradise/images/cctv1.png" alt="portfolio_078_01">
						<!-- <div class="linebox"><h1>Beach Tour</h1></div> -->
						<!-- <div class="linebox1"><h1>3 Days 2 Nights</h1></div> -->

							<div class="portfolio_078_content portfolio_078_content_col_4">
							
								<div class="portfolio_078_link"> 
					...
					<div class="col-xs-12 col-sm-6 col-md-3 portfolio_078_grid"> 
						<div class="portfolio_078_wrapper"> 
							...
							<!-- Image -->
							<img src="paradise/images/cctv2.png" alt="portfolio_078_01">
						<!-- <div class="linebox"><h1>Beach Tour</h1></div> -->
						<!-- <div class="linebox1"><h1>3 Days 2 Nights</h1></div> -->
							<div class="portfolio_078_content portfolio_078_content_col_4">
					...
					<div class="col-xs-12 col-sm-6 col-md-3 portfolio_078_grid"> 
						<div class="portfolio_078_wrapper"> 
							...
							<!-- Image -->
							<img src="paradise/images/cctv3.png" alt="portfolio_078_01">
					<!-- <div class="linebox"><h1>Beach Tour</h1></div> -->
						<!-- <div class="linebox1"><h1>3 Days 2 Nights</h1></div> -->
							<div class="portfolio_078_content portfolio_078_content_col_4">
				...
				<div class="row"> 
					...
					<div class="col-xs-12 col-sm-6 col-md-3 portfolio_078_grid"> 
						<div class="portfolio_078_wrapper"> 
							...
							<!-- Image -->
							<img src="paradise/images/banner11.JPG" alt="portfolio_078_01">
						<!-- <div class="linebox"><h1>Beach Tour</h1></div> -->
						<!-- <div class="linebox1"><h1>3 Days 2 Nights</h1></div> -->
					...
					<div class="col-xs-12 col-sm-6 col-md-3 portfolio_078_grid"> 
						<div class="portfolio_078_wrapper"> 
							...
							<!-- Image -->
						<img src="paradise/images/camera_tter.jpg" alt="portfolio_078_01">
						<!-- <div class="linebox"><h1>Beach Tour</h1></div> -->
						<!-- <div class="linebox1"><h1>3 Days 2 Nights</h1></div> -->
							<div class="portfolio_078_content portfolio_078_content_col_4">
					...
					<div class="col-xs-12 col-sm-6 col-md-3 portfolio_078_grid"> 
						<div class="portfolio_078_wrapper"> 
							...
							<!-- Image -->
						<img src="paradise/images/biomatric.jpg" alt="portfolio_078_01">
					<!-- <div class="linebox"><h1>Beach Tour</h1></div> -->
						<!-- <div class="linebox1"><h1>3 Days 2 Nights</h1></div> -->
