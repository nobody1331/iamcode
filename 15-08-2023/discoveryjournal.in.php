...
$sql = "SELECT `content`,`extras` FROM `pages` WHERE page='home' AND type='about'";
...
<head>
  ...
  <title>Discovery Journal - Index</title>
  <meta content="Discovery Journal" name="description">
...
<br>
 <!-- ======= Portfolio Details Section ======= -->
    <section id="portfolio-details" class="portfolio-details">
        <marquee><b> <?php echo $extras?></b></marquee>
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-3">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <?php
                        $sql = "SELECT `img` FROM `pages` WHERE type='slider' ORDER BY id DESC ";
                        $result = $con->query($sql);
                        if ($result->num_rows > 0) {
                        	while($row = $result->fetch_assoc()) {
                echo'<div class="swiper-slide">
                  <img src="/dashboard1/'.$row['img'].'" alt="">
                </div>';
           	}}?>
              </div>
   ...
   <?php echo $content?>
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              <h5 style="color:#4B0082;font-weight: bold;font-size: 25px;">Announcements</h5>
              <ul>
                  <?php
                 $sql = "SELECT `id`, `title`,`file` FROM `notice` ORDER BY id DESC LIMIT 5";
                        $result = $con->query($sql);
                        if ($result->num_rows > 0) {
                        	while($row = $result->fetch_assoc()) {
                        	    echo'<li>'.$row['title'].': <a href="'.$file.'">Click Here</a></li>';
                        	}}
                    ?>
                </ul>
                 <ul style="line-height: 1.0; font-size: 20px;">
                  <li><a href="https://discoveryjournal.in/user/login.php"><small>Login</small></a></li>
                   <li><a href="https://discoveryjournal.in/user/register.php"><small>Register</small></a></li>
                  <li><a href="https://discoveryjournal.in/current-issue.php"><small>Current Issue</small></a></li>
                  <li><a href="https://discoveryjournal.in/past-issue.php"><small>Past Issue</small></a></li>
                  <li><a href="https://discoveryjournal.in/special-issue.php"><small>Special Issue</small></a></li>
                  <li><a href="https://discoveryjournal.in/user/login.php"><small>Submit Your Paper</small></a></li>
                  <li><a href="https://discoveryjournal.in/user/register.php"><small>Join Editorial Board </small></a></li>
                  <li><a href="https://discoveryjournal.in/user/register.php"><small>Join Reviewer Board </small></a></li>
              </ul>
            </div>
             </div>
          </div>
      ...
      <div class="container">
          <?php
                 $sql = "SELECT `content`,`extras` FROM `pages` WHERE type='idx' AND page='home'";
                        $result = $con->query($sql);
                        if ($result->num_rows > 0) {
                        	while($row = $result->fetch_assoc()) {
                        	    echo $row['content'];
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2 id="animated_rainbow_1">Our committee</h2>
        </div>
        <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper">
        <?php
       $sql = "SELECT user.name,user.username,user.role,commitee.designation,commitee.qualification,commitee.img,commitee.subject FROM user INNER JOIN commitee ON user.username=commitee.username WHERE user.status=1 ORDER BY user.id DESC;";
		$result = $con->query($sql);
            ...
            echo'<div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <a href="member.php?username='.$row['username'].'" class="btn btn-primary">Profile Link</a>
                </p>
                <img src="user/'.$row['img'].'" class="testimonial-img" alt="">
                <h3>'.$row['name'].'</h3>
                <h4>'.$row['role'].'</h4>
              </div>
            </div>';}
