...
<html>
<head>
<title>ALPINE MUSK - Luxury Stay</title>
...
<div id="kenburns_061" class="carousel slide ps_indicators_txt_icon ps_control_txt_icon kbrns_zoomInOut thumb_scroll_x swipe_x ps_easeOutQuart" data-ride="carousel" data-pause="hover" data-interval="4000" data-duration="2000">
	...
	<div class="carousel-inner" role="listbox">
				...
				<img src="paradise/images/slider/111.webp" alt="portfolio_078_01">
			...
			<div class="item">
				<img src="paradise/images/slider/222.webp" alt="portfolio_078_01">
					...
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
						...
						<div class="item">
				<img src="paradise/images/slider/11.webp" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				
							<h1 id="form"><span style="color:#fff;">Luxury</span>Stay</h1>
				...
				<div class="item">
				<img src="paradise/images/slider/5.webp" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				
							<h1 id="form"><span style="color:#fff;">Hotel</span>Reception</h1>
							<h2>24/7 Helpdesk</h2>
				...
				<img src="paradise/images/slider/1.webp" alt="portfolio_078_01">
					...
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
							...
							<h1 id="form"><span style="color:#fff;">Deluxe</span> Room</h1>
							<h2>With Balcony Valley View</h2>
			...
			<div class="item">
				<img src="paradise/images/slider/2.webp" alt="portfolio_078_01">
					...
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
							...
							<h1 id="form"><span style="color:#fff;">Super Deluxe</span>Room</h1>
							<h2>with terrace Balcony-Valley view</h2>
				...
				<img src="paradise/images/slider/3.webp" alt="portfolio_078_01">
					...
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
							...
							<h1 id="form"><span style="color:#fff;">Premium</span>Room</h1>
							<h2>with Valley view</h2>
						...
						<div class="item">
				<img src="paradise/images/slider/4.webp" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				
							<h1 id="form"><span style="color:#fff;">Superior</span>Room</h1>
							<h2>Without Balcony</h2>
		...
		<div class="item">
				<img src="paradise/images/slider/7.webp" alt="portfolio_078_01">
				
				
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				
							<h1 id="form">Breakfast<span style="color:#fff;"></span></h1>
							...
							<div class="item">
				<img src="paradise/images/slider/8.webp" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				
							<h1 id="form">Our<span style="color:#fff;"> Restaurant</span></h1>
...
<div class="wrapper_contro">
		...
		<div class="hotels-pack">
		        <h1>Welcome to Alpine Musk</h1>
				<h2>Relaxe in Our Hotel</h2>
				<p>
				The Alpine Musk is one of Uttarakhand's most prestigious establishments. The hotel is at the prime location 
				in Kanatal, which is conveniently located between Rishikesh, Uttarakhand, and Mussoorie.
				The Alpine Musk, because of its advantageous location, offers breathtaking views that are sure to bring serenity 
				and tranquility to the guests staying at our humble establishment.
				The Alpine Musk is one of Kanatal's finest hotels, with a variety of accommodation options to suit your needs. Each accommodation type is furnished with top-of-the-line amenities and conveniences, ensuring a luxurious stay. The Alpine Musk offers a variety of room categories with a variety of amenities, stunning views, a perfect location, and a list of soothing and recreational activities for an amazing visit. Experience comfort and joy in one place!
               </p>
		</div>
		
		
		<div class="boxx1">	
			<img src="image/alpineviewpic1.webp">
		</div>
		
		<div class="boxx2">	
			<img src="image/alpineviewpic2.webp">
		</div>
		
		<div class="boxx3">	
			<img src="image/alpineviewpic3.webp">
		</div>
...
<div class="wrapper_contro">
	<div class="trangal">
	<h1>ACCOMMODATION</h1>
	<h2>Experience comfort, Luxury & joy in one place!</h2>
	
		<div class="trangal1">
			<a href="standard-room-without-balcony.php"><img src="image/01-badroom.webp"></a>
		
			<div class="box">
	
				<a href="standard-room-without-balcony.php"><h2>Standard Hotel Room without balcony</h2></a>
					<h3><img src="image/alpineicon3.png"></h3>
			</div>
		...
		<div class="trangal1">
			<a href="deluxe-room-with-balcony-valley-view.php"><img src="image/02-badroom.webp"></a>
		
			<div class="box">
							<a href="deluxe-room-with-balcony-valley-view.php"><h2>Deluxe with balcony valley view</h2></a>
								<h3><img src="image/alpineicon3.png"></h3>
			</div>
		...
		<div class="trangal1">
			<a href="super-deluxe-room-with-terrace-balcony-valley-view.php"><img src="image/03-badroom.webp"></a>
		
			<div class="box">
			
				<a href="super-deluxe-room-with-terrace-balcony-valley-view.php"><h2>Super deluxe with terrace Balcony Valley view</h2></a>
				<h3><img src="image/alpineicon3.png"></h3>
			</div>
				...
				<div class="trangal1">
			<a href="premium-room-valley-view.php"><img src="image/04-badroom.webp"></a>
		
			<div class="box">
			
				<a href="premium-room-valley-view.php"><h2>Premium Alpine Room with Valley View</h2></a>
				<h3><img src="image/alpineicon3.png"></h3>
			</div>
...
<div class="row2">
    ...
    <div class="box3">
	   <div class="col1">
	    <div class="colimg">
       <img src="image/alpineiconnew.png">
		</div>
		<h1>Prices </h1>
		<p>You can't beat!</p>
...
<div class="our_rroom">
	...
	<div class="tawar">
		<h1>Our Gallery</h1>
		<h2>Hotel Alpine Musk in Quick View</h2>
		<img src="image/alpineicon3.png">
		
		<div class="container_demo">
		
			<div class="container_01">
				<img src="image/pic1.jpg" alt="badroom" class="image">
			
			
			</div>
			
			<div class="container_01">
				<img src="image/pic2.jpg" alt="badroom" class="image">
			
	
			</div>
			
			<div class="container_01">
				<img src="image/pic3.jpg" alt="badroom" class="image">
			
		
			</div>
			
			<div class="container_01">
				<img src="image/pic4.jpg" alt="badroom" class="image">
			...
			<div class="container_01">
				<img src="image/pic5.jpg" alt="badroom" class="image">
				...
				<div class="container_01">
				<img src="image/pic6.jpg" alt="badroom" class="image">
		...
		<h3><a href="alpine-musk-gallery.php">VIEW GALLERY</a></h3>		
	...
	<div class="tawarr">
		<h1>Hotel Alpine Musk</h1>
		<h2>A Quick View of Alpine Musk</h2>
						<img src="image/alpineicon3.png">
		
			<div id="video"> 			
            <iframe src="https://www.youtube.com/embed/Blp9K7tBUgw?autoplay=1" frameborder="0" allowfullscreen> </iframe>
          </div>			
	</div>	
  ...
  <div class="wrapper_contro">	
       <div class="tiebox">
	    ...
	    <div class="tiebox1">
       <a href="https://www.booking.com/hotel/in/alpine-musk.html"><img src="image/bookingicon.png"></a>
		</div>		

		
		  <div class="tiebox1">
        <a href="https://www.goibibo.com/hotels/alpine-musk-hotel-in-tehri-5443947627991469620/"><img src="image/goibiboicon.png"></a>
		</div>
		
				  <div class="tiebox1">
        <a href="https://www.tripadvisor.co.uk/Hotel_Review-g7805807-d23621173-Reviews-Hotel_Alpine_Musk-Kanatal_Tehri_Garhwal_District_Uttarakhand.html"><img src="image/tripadvisor.png"></a>
		</div>
		
		
			 <div class="tiebox1">
        <a href="https://www.makemytrip.com/hotels/hotel-listing/?_uCurrency=INR&checkin=10052021&checkout=10072021&city=CTXAL&country=IN&locusId=CTXAL&locusType=city&regionNearByExp=3&roomStayQualifier=2e0e&searchText=Kanatal%2C%20Uttarakhand%2C%20India&topHtlId=202108041301484714&visitorId=7f36756e-eac7-4e9b-a8d2-f865cca25235"><img src="image/makemytripicon.png"></a>
		</div>
		
				    <div class="tiebox1">
       <img src="image/agodaicon.png">
		</div>
