...
<div id="kenburns_061" class="carousel slide ps_indicators_txt_icon ps_control_txt_icon kbrns_zoomInOut thumb_scroll_x swipe_x ps_easeOutQuart" data-ride="carousel" data-pause="hover" data-interval="2000" data-duration="2000">
...
<div class="carousel-inner" role="listbox">
		...
		<!-- First Slide -->
			...
			<img src="paradise/images/slider/slider1.webp" alt="portfolio_078_01">
			...
			<img src="paradise/images/slider/slider2.webp" alt="portfolio_078_01">
				
					<div class="controller">
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				   				    <h1>Get free Consultation</h1>
					<h2><span>STUDY</span>Abroad</h2>
					<h3>Beabroad Immigration Consultancy</h3>
			...
			<img src="paradise/images/slider/slider3.webp" alt="portfolio_078_01">
				
					<div class="controller">
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
							    <h1>Get free Consultation</h1>
					<h2><span>WORK</span>Abroad</h2>
					<h3>Beabroad Immigration Consultancy</h3>
			...
			<img src="paradise/images/slider/slider4.webp" alt="portfolio_078_01">
				
					<div class="controller">
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
								    <h1>Get free Consultation</h1>
					<h2><span>JOBS</span>Abroad</h2>
				<h3>Beabroad Immigration Consultancy</h3>
			...
			<img src="paradise/images/slider/slider5.webp" alt="portfolio_078_01">
				
					<div class="controller">
				<div class="kenburns_061_slide" data-animation="animated fadeInRight">
				    <h1>Worldwide</h1>
					<h2><span>TRAVEL</span>Abroad</h2>
				<h3>Beabroad Immigration Consultancy</h3>
 ...
 <div class="tg-askquestion">
								<div class="tg-heading">
									...
									<h3>ASSISTANCE WILL CALL YOU IN FEW HOURS</h3>
								</div>
								<form class="tg-formtheme tg-formaskquestions" method="POST"
									action="../formaction.php" id="smart-form2">
									<input type="hidden" name="url" id="url" value="CANTON-housing.org"
										class="gui-input">
									<input type="hidden" name="check" value="g_ok">
									<input type="hidden" name="cname" id="cname" value='CANTON' class="gui-input">
									<input type="hidden" name="cid" id="cid" value='830' class="gui-input">
									<input type="hidden" name="agentid" id="agentid" value='14' class="gui-input">
									<input type="hidden" name="ctype" id="ctype" value='1' class="gui-input">
									<fieldset>
										<div class="form-group">
											<input type="text" name="g_guestname" id="r_name" class="form-control"
												placeholder="Full Name">
										</div>
										<div class="form-group">
											<input type="email" name="g_guestemail" id="r_email" class="form-control"
												placeholder="Email">
										</div>
										<div class="form-group">
											<input type="text" name="g_guestelephone" id="r_phone" class="form-control"
												placeholder="Phone">
										</div>
										<div class="form-group">
												<select name="g_delegates" id="r_delegates" class="gui-input">
			...
			$("#i_checkout").datepicker({
				...
				onClose: function (selectedDate) {
					$("#i_checkin").datepicker("option", "maxDate", selectedDate);
							...
							<script type="text/javascript">
		$(".tg-askquestion .btn").click(function () {
			var rfirstname = $("#r_name").val();
			var remail = $("#r_email").val();
			var rtelephone = $("#r_phone").val();
			var rhot_cat = $("#r_hot_cat").val();
			var rdelegates = $("#r_delegates").val();
			var rtradefair = $("#r_tradefair").val();
			var roccupation = $("#r_occupation").val();
			var emailPattern = /^[a-zA-Z0-9._-]+@[a-zA-Z.-]+.[a-zA-Z]{2,4}$/;
			var mobilePattern = /^(+d{1,3}[- ]?)?d{10,}$/;

			if (rfirstname == "") {
				document.getElementById('r_name').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_name").focus();
				return false;
			} else {
				document.getElementById('r_name').style.backgroundColor = '#ccc';
			}

			if (remail == "") {
				document.getElementById('r_email').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_email").focus();
				return false;
			} else if (!emailPattern.test(remail)) {
				document.getElementById('r_email').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_email").focus();
				return false;
			} else {
				document.getElementById('r_email').style.backgroundColor = '#ccc';
			}

			var len = rtelephone;
			if (len.length < 5) {
				document.getElementById('r_phone').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_phone").focus();
				return false;
			} else if (!mobilePattern.test(rtelephone)) {

				document.getElementById('r_phone').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_phone").focus();
				return false;
			} else {
				document.getElementById('r_phone').style.backgroundColor = '#ccc';
			}
			if (rhot_cat == "") {

				document.getElementById('r_hot_cat').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_hot_cat").focus();

				return false;
			} else {
				document.getElementById('r_hot_cat').style.backgroundColor = '#ccc';
			}

			if (rdelegates == "") {
				document.getElementById('r_delegates').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_delegates").focus();
				return false;
			} else {

				document.getElementById('r_delegates').style.backgroundColor = '#ccc';
			}

			if (rtradefair == "") {

				document.getElementById('r_tradefair').style.backgroundColor = '#ffc6c6';
				document.getElementById("r_tradefair").focus();

				return false;
			} else {
				document.getElementById('r_tradefair').style.backgroundColor = '#ccc';
			}

			if (roccupation == "") {

				document.getElementById('r_occupation').style.backgroundColor = '#ffc6c6';
				document.getElementById('r_occupation').focus();

				return false;
			} else {
				document.getElementById('r_occupation').style.backgroundColor = '#ccc';
			}
		});
	</script>
...
<div class="indexheadingsection1">
<a href="study-abroad.php"><img src="image/studyvisaservice.webp"></a>
<h2>Study Abroad</h2>
</div>

<div class="indexheadingsection1">
<a href="settle-abroad.php"><img src="image/workvisaservice.webp"></a>
<h2>Settle Abroad</h2>
</div>	

<div class="indexheadingsection1">
<a href="travel-abroad.php"><img src="image/touristvisaservices.webp"></a>
<h2>Travel Abroad</h2>
</div>	

<div class="indexheadingsection1">
<a href="jobs-abroad.php"><img src="image/businessvisaservices.webp"></a>
<h2>Jobs Abroad</h2>
</div>
...
<div class="indexfullsection">

<div class="controller">

<div class="indexfullsection-box1">
<h1>30</h1>
<h2>Countries</h2>
</div>
...
<div class="indexservice-left">
<h1>Guidance And Immigration Services</h1>
<p>Beabroad (A brand of CWI consultancy Pvt Ltd) is a one-stop solution provider for all your immigration and overseas education needs. We believe in building a life-long relationship with all our clients. Building strong relationships and providing innovative solutions to our clients is of utmost priority to us. Our team of experts assesses and reviews every case assiduously, ensuring proper client representation while maintaining individuality and personal touch.
We keep an eye on all immigration law updates and developments. Simultaneously, making sure clients receive all available options to make the most informed decisions. We provide all immigration, permanent residency, and overseas study assistance for Canada, Australia, and the UK. Furthermore, all visas, travel, loans, and IELTS guidance are undertaken by us.
</p>
</div>

<div class="indexsection2-box1">
<img src="image/guidenceimg.webp">
</div>
...
<h1><a href="index.php#form">Book A Consultation</a></h1>
<h3>Beabroad Immigration</h3>
<h2><b>NEED A CONSULTATION? </b>Call us today at Toll Free <a href="tel: 1800-121-9002">1800-121-9002</a> or email us: Support@beabroad.in</h2>
</div>
</div>
...
<div class="visacontainer1">

<div class="visasection1"> 
<h2>Student Visa | Business Visa | Tourist Visa</h2>
<h1>TOP RATED VISA COUNTRIES WE SERVE !</h1>
</div>
...
<div class="visacontainer2">

<div class="visaservicesblog1">
<img src="image/australia.webp">
...
<div class="visaservicesblog1">
<img src="image/usa.webp">
<h1>USA VISA</h1>
	
</div>

<div class="visaservicesblog1">
<img src="image/uk.webp">
<h1>UK VISA</h1>

</div>

<div class="visaservicesblog1">
<img src="image/germany.webp">
<h1>GERMANY VISA</h1>
...
<div class="controller">
<!-- Paradise Slider -->
	<div id="testimonial_093_mov_1_col_2" class="carousel slide testimonial_093 testimonial_093_control_button two_coloumns swipe_x ps_easeOutQuart" data-ride="carousel" data-pause="hover" data-interval="1000" data-duration="1500">

		<!-- Header of Slider -->
		<div class="testimonial_093_header">
			<h5>Testimonials</h5>
		...
		<div class="carousel-inner" role="listbox">
			...
			<!-- 1st Box -->
			<div class="item active">
				<div class="col-xs-12 col-sm-6 col-md-6 testimonial_093_grid"> <!-- Grid -->
					<div class="testimonial_093_wrapper testimonial_093_wrapper_col_2"> <!-- Wrapper -->

						<!-- Image -->
						<div class="testimonial_093_image">
							<img src="paradise/images/jayantrajesh.webp" alt="testimonial_093_01">
						</div> <!-- /Image -->
						<div class="testimonial_093_names"> <!-- Names -->
							<h5><a href="#">Jayant Rajesh</a></h5>
							<h6><a href="#">Business Head</a></h6>
						</div> <!-- /Names -->
						<p>"Shifting to other countries was a simple task because of Beabroad. But when it came to shifting my family as well they made the process as simple and fast as it was for me, the experience was great and I can say they are leading consultants for a reason. "</p>
						<ul> <!-- Rating -->
					...
					</div> <!-- /.testimonial_093_wrapper -->
				</div> <!-- /.testimonial_093_grid -->
			</div> <!-- /item -->
			<!-- End of 1st Box -->
			...
			<div class="item">
				<div class="col-xs-12 col-sm-6 col-md-6 testimonial_093_grid"> <!-- Grid -->
					<div class="testimonial_093_wrapper testimonial_093_wrapper_col_2"> <!-- Wrapper -->
						...
						<!-- Image -->
						<div class="testimonial_093_image">
							<img src="paradise/images/sakshamtahapa.webp" alt="testimonial_093_02">
						</div> <!-- /Image -->
						<div class="testimonial_093_names"> <!-- Names -->
							<h5><a href="#">Saksham thapa</a></h5>
							<h6><a href="#">Consultant</a></h6>
						</div> <!-- /Names -->
						<p>" I got my business listed in Canada in just a few steps here and there. I would strongly suggest Beabroad for those who are willing to Migrate their business to other countries. All thanks to Beabroad and the entire team. "</p>
						<ul> <!-- Rating -->
							<li><span class="fa fa-star"></span></li>
							<li><span class="fa fa-star"></span></li>
							<li><span class="fa fa-star"></span></li>
			...
			<div class="item">
				<div class="col-xs-12 col-sm-6 col-md-6 testimonial_093_grid"> <!-- Grid -->
					<div class="testimonial_093_wrapper testimonial_093_wrapper_col_2"> <!-- Wrapper -->
						...
						<!-- Image -->
						<div class="testimonial_093_image">
							<img src="paradise/images/jatinkumar.webp" alt="testimonial_093_02">
						</div> <!-- /Image -->
						<div class="testimonial_093_names"> <!-- Names -->
							<h5><a href="#">Jatin Kumar</a></h5>
							<h6><a href="#">Customer</a></h6>
						</div> <!-- /Names -->
						<p>"I really would like to appreciate Beabroad and the entire team, especially Mrs. Kunal Sood for helping me get my student visa for Brunel University. He helped me all way to find the University & the right course. He was there for me through the entire process. "</p>
						<ul> <!-- Rating -->
							<li><span class="fa fa-star"></span></li>
							<li><span class="fa fa-star"></span></li>
							<li><span class="fa fa-star"></span></li>
