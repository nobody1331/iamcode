...
<div id="kenburns_061" class="carousel slide ps_indicators_txt_icon ps_control_txt_icon kbrns_zoomInOut thumb_scroll_x swipe_x ps_easeOutQuart" data-ride="carousel" data-pause="hover" data-interval="4000" data-duration="3000">

	<div class="carousel-inner" role="listbox">

			<div class="item active">
				<img src="paradise/images/slider/2.jpg" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInLeft">				
					<h1>COLOR'S OF INDIA</h1>
					</div>				
			</div>
			
         	<div class="item">
				<img src="paradise/images/slider/1.jpg" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInLeft">				
					<h1>HERITAGE TOURS OF INDIA</h1>
					</div>
			</div>
				<div class="item">
				<img src="paradise/images/slider/3.jpg" alt="portfolio_078_01">
				...
				<div class="item">
				<img src="paradise/images/slider/4.jpg" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInLeft">				
					<h1>SOUTH INDIA'S SPICE</h1>
					</div>
			</div>
			<div class="item">
				<img src="paradise/images/slider/5.jpg" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInLeft">				
					<h1>HIMACHAL A PARADISE</h1>
					</div>
			</div>
			<div class="item">
				<img src="paradise/images/slider/6.jpg" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInLeft">				
					<h1>Tamilnadu Tour</h1>
					</div>
			</div>
			<div class="item">
				<img src="paradise/images/slider/7.jpg" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInLeft">				
					<h1>KASHMIR A INDIAN SWISS</h1>
					</div>
			</div>
				<div class="item">
				<img src="paradise/images/slider/8.jpg" alt="portfolio_078_01">
				...
				<div class="item">
				<img src="paradise/images/slider/9.jpg" alt="portfolio_078_01">
			...
			<div class="item">
				<img src="paradise/images/slider/10.jpg" alt="portfolio_078_01">
				...
				<div class="item">
				<img src="paradise/images/slider/11.jpg" alt="portfolio_078_01">
				
					<div class="kenburns_061_slide" data-animation="animated fadeInLeft">				
					<h1>MAHARASTRA Tours</h1>
					</div>
			</div>
...
<div class="cantantarea">
	<h1>Swagat In India</h1>
		<p>We Are Specialized In -</p>
		
		<div class="control">
		 <div class="wrapper">
		
			<div class="class-services">
				<img src="image/d1.png">
					<h1>WORLDWIDE HOTEL BOOKING</h1>
						<p>Swagat bring to you mind-blowing hotel offers and an array of hotel deals on domestic as well as international hotels.</p>	
					<h2><a href="online-booking-form.php">Book Now</a></h2>
			</div>
	
			<div class="class-services">
				<img src="image/d11.png">
					<h1>WORLDWIDE FLIGHT BOOKING</h1>
						<p>Swagat has brought many firsts to its customers, providing them ease of flight booking along with best budget options.</p>	
				<h2><a href="online-booking-form.php">Book Now</a></h2>
			</div>
	
			<div class="class-services">
				<img src="image/d111.png">
					<h1>VISA ASSISTANCE</h1>
						<p>Swagat will help you with the visa process: right from getting the documents ready to going for the actual visa interview</p>	
				<h2><a href="online-booking-form.php">Book Now</a></h2>
			</div>
			
			<div class="class-services">
				<img src="image/d11111.png">
					<h1>TRAVEL INSURANCE</h1>
						<p>Wherever you go, we keep you protected. Our Insurance plans takes care of any problem that might arise during your journey</p>	
				<h2><a href="online-booking-form.php">Book Now</a></h2>
			</div>
			
			<div class="class-services">
				<img src="image/d5.png">
					<h1>WORLDWIDE TRAIN BOOKING</h1>
						<p>Swagat have now made booking a train ticket much easier for you. & have a dedicated team to help you for group bookings</p>	
				<h2><a href="online-booking-form.php">Book Now</a></h2>
			</div>
			
			<div class="class-services">
				<img src="image/d1111.png">
					<h1>LUXURY CRUISE BOOKING</h1>
						<p>Our Cruise Tours gives you unlimited options of comfort, entertainment. Cuise Deals like as Dream | Alaska | Star Cruise...  </p>	
				<h2><a href="online-booking-form.php">Book Now</a></h2>
			</div>
...
<div class="cantantareaa">
	<h1>Best Tours to Explore in India </h1>
			
		<div class="wrapper1">	
		
			<div class="disk">
				<img src="image/easternindia.jpg" alt="pick-01" class="image">
				
					<h3>Eastern India</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
							<div class="text1"><a href="eastern-india-tour.php">View More</a></div>
						</div>
			</div>
			
			<div class="disk">
				<img src="image/pick-02.jpg" alt="pick-02" class="image">
				
					<h3>Classical India</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
							<div class="text1"><a href="classical-india.php">View More</a></div>
						</div>
			</div>
			
			<div class="disk">
				<img src="image/mistyhimahcal.jpg" alt="pick-03" class="image">
			
					<h3>Misty Himachal</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
							<div class="text1"><a href="misty-himachal.php">View More</a></div>
						</div>
			</div>
			
			
			<div class="disk">
				<img src="image/wildliferajasthan.jpg" alt="pick-04" class="image">
					
					<h3>Wildlife Rajasthan</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
							<div class="text1"><a href="wildlife-rajasthan.php">View More</a></div>
						</div>
			</div>
			
			<div class="disk">
				<img src="image/kashmirpic.jpg" alt="pick-05" class="image">
				
					<h3>Kashmir & Ladakh</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
								<div class="text1"><a href="kashmir-ladakh.php">View More</a></div>
						</div>
			</div>
			
			<div class="disk">
				<img src="image/pick-06.jpg" alt="pick-06" class="image">
				
					<h3>Footstep of Buddha</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
								<div class="text1"><a href="footstep-of-buddha.php">View More</a></div>
						</div>
			</div>
			
			
				<div class="disk">
				<img src="image/gujaratpic.jpg" alt="pick-06" class="image">
				
					<h3>Grand Gujarat</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
								<div class="text1"><a href="grand-gujarat.php">View More</a></div>
						</div>
			</div>
			
			
				<div class="disk">
				<img src="image/footstepbodha.jpg" alt="pick-06" class="image">
				
					<h3>Buddhist Circuit With Taj</h3>
						<div class="overlay">
							<div class="text"><a href="online-booking-form.php">Book Now</a></div>
								<div class="text1"><a href="buddhist-circuit-with-taj.php">View More</a></div>
						</div>
			</div>
...
<!-- Paradise Slider -->
	<div id="portfolio_076_mov_all_col_2" class="carousel slide portfolio_076 portfolio_076_control_button two_coloumns swipe_x ps_easeOutCirc" data-ride="carousel" data-pause="hover" data-interval="2000" data-duration="1000">
		
		<!-- Header of Slider -->
		<div class="portfolio_076_header">
			<h1>Hot Destinations In India</h1>			
			</div>
		<!-- /Header of Slider -->
		...
		<div class="carousel-inner" role="listbox">
			...
			<!-- 1st Box -->
			<div class="item active">
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->

						 <!-- Image -->
						<img src="image/pick-04.jpg" alt="portfolio_076_01">

			<div class="boler">
							<h1><a href="amazing-bhutan.php"> Amazing Bhutan </a></h1>
								<h2>8 Days & 7 Nights</h2>
								<h3>Starting from:</br><span>Rs. 52,000/-*</span></h3>
								<h3>All Above cost Per Person basis</h3>
							</div>		
			...
			<div class="item">
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 <!-- Image -->						 
					<img src="image/pick-07.jpg" alt="portfolio_076_02">
                       <div class="boler">
							<h1><a href="explore-andaman.php"> Explore Andman </a></h1>
								<h2>8 Days & 7 Nights</h2>
								<h3>Starting from:</br><span>Rs. 29,000/-*</span></h3>
									<h3>All Above cost Per Person basis</h3>
		...
		<div class="item">
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 ...
						 <!-- Image -->
						<img src="image/pick-08.jpg" alt="portfolio_076_02">
<div class="boler">
							<h1><a href="south-india-spice-tours.php"> South India Spice </a></h1>
								<h2>11 Days & 10 Nights</h2>
								<h3>Starting from:</br><span>Rs. 89,000/-*</span></h3>
									<h3>All Above cost Per Person basis</h3>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 ...
						 <!-- Image -->
						<img src="image/pick-09.jpg" alt="portfolio_076_02">
<div class="boler">
							<h1><a href="beaches-of-goa.php"> Beaches of Goa </a></h1>
								<h2>6 Days & 5 Nights</h2>
								<h3>Starting from:</br><span>Rs. 19,000/-*</span></h3>
									<h3>All Above cost Per Person basis</h3>
			...
			<div class="item">
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 ...
						 <!-- Image -->
						<img src="image/pick-10.jpg" alt="portfolio_076_02">
<div class="boler">
							<h1><a href="shirdi-sai-tour.php"> Sirdi Sai Tour </a></h1>
								<h2>5 Days & 4 Nights</h2>
								<h3>Starting from:</br><span>Rs. 12,000/-*</span></h3>
									<h3>All Above cost Per Person basis</h3>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 <!-- Image -->
						<img src="image/pick-13.jpg" alt="portfolio_076_02">
                        <div class="boler">
							<h1><a href="buddha-pilgrimage-tour.php"> Buddhist Pilgrimage Tour </a></h1>
								<h2>07 Days & 06 Nights</h2>
								<h3>Starting from:</br><span>Rs. 48,000/-*</span></h3>
									<h3>All Above cost Per Person basis</h3>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 ...
						 <!-- Image -->
						<img src="image/pick-14.jpg" alt="portfolio_076_02">
<div class="boler">
							<h1><a href="yoga-meditation-tour.php"> Yoga & Meditation Tour </a></h1>
								<h2>7 Days & 6 Nights</h2>
								<h3>Starting from:</br><span>Rs. 18,000/-*</span></h3>
								<h3>All Above cost Per Person basis</h3>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 ...
						 <!-- Image -->
						<img src="image/pick-11.jpg" alt="portfolio_076_02">
<div class="boler">
							<h1><a href="marvelous-kashmir.php"> Marvelous Kashmir </a></h1>
								<h2>5 Days & 4 Nights</h2>
								<h3>Starting from:</br><span>Rs. 19,500/-*</span></h3>
									<h3>All Above cost Per Person basis</h3>
			...
			<div class="item">
				<div class="col-xs-12 col-sm-6 col-md-6 portfolio_076_grid"> <!-- Grid -->
					<div class="portfolio_076_wrapper"> <!-- Wrapper -->
						 ...
						 <!-- Image -->
						<img src="image/pick-12.jpg" alt="portfolio_076_02">
<div class="boler">
							<h1><a href="rann-utsav-gujarat.php"> Rann Utsav Gujarat </a></h1>
								<h2>3 Days & 2 Nights</h2>
								<h3>Starting from:</br><span>Rs. 19,999/-*</span></h3>
								<h3>All Above cost Per Person basis</h3>
...
<!-- Left Control -->
		<a class="left carousel-control" href="#portfolio_076_mov_all_col_2" role="button" data-slide="prev">
			<span class="fa fa-long-arrow-left"></span>
		</a>

		<!-- Right Control -->
		<a class="right carousel-control" href="#portfolio_076_mov_all_col_2" role="button" data-slide="next">
...
<div class="cantantareaa">
	<h1>Special Interest Tours of India</h1>
		<p>Heritage Tours | Cultural Tours | Adventure Tours | Wildlife Tours | Beach Tours | Honeymoon Tours | Buddhist Tours | Pilgrim Tours</p>
					<div class="control">
			<div class="wrapper2">
			
				<div class="couple_ox">
					<a href="heritage-tours-in-india.php"><img src="image/heritage.jpg"></a>
						<h1>Heritage Tours in India</h1>
						<h3><a href="online-booking-form.php">Click Here For Best Deal</a></h3>
					<h4><a href="heritage-tours-in-india.php">View Detail</a></h4>
				</div>
				
				<div class="couple_ox">
					<a href="kerala-tour-package.php"><img src="image/keralatour.jpg"></a>
						<h1>Kerala Tour Package</h1>
						<h3><a href="online-booking-form.php">Click Here For Best Deal</a></h3>
					<h4><a href="kerala-tour-package.php">View Detail</a></h4>
				</div>
				
				<div class="couple_ox">
					<a href="tea-tour-in-india.php"><img src="image/teatour.jpg"></a>
						<h1>Tea Tour in India</h1>
					<h3><a href="online-booking-form.php">Click Here For Best Deal</a></h3>
						<h4><a href="tea-tour-in-india.php">View Detail</a></h4>
				</div>
				
	<div class="couple_ox">
					<a href="golden-triangle-tour.php"><img src="image/goldentour.jpg"></a>
						<h1>Golden Triangle Tour</h1>
					<h3><a href="online-booking-form.php">Click Here For Best Deal</a></h3>
					<h4><a href="golden-triangle-tour.php">View Detail</a></h4>
				</div>
				
				<div class="couple_ox">
					<a href="cultural-tour-in-india.php"><img src="image/culturetour.jpg"></a>
						<h1>Cultural Tour in India</h1>
				<h3><a href="online-booking-form.php">Click Here For Best Deal</a></h3>
					<h4><a href="cultural-tour-in-india.php">View Detail</a></h4>
				</div>
				
				<div class="couple_ox">
					<a href="south-india-spice-tours.php"><img src="image/spicetour.jpg"></a>
						<h1>South India Spice Tours</h1>
							<h3><a href="online-booking-form.php">Click Here For Best Deal</a></h3>
						<h4><a href="south-india-spice-tours.php">View Detail</a></h4>
				</div>
...
<div class="photofram">
	<img src="image/back1.jpg">
			<div class="control">
	<div class="cantantarea1">
	<h1>We Are Specialised For</h1>
				
		<div class="wrapper">
		
			<div class="class-services1">
				<img src="image/d34.png">
					<h1>Value for Money</h1>
						</div>					
					
		
			<div class="class-services1">
				<img src="image/d33.png">
