...
?>
<?php 
include 'includes/host_redirect_link_validator.php';
if($get_server_name == 'localhost'){
    $conn = mysqli_connect("localhost","root","","commonen_blogdb");
}else{
    $conn = mysqli_connect("localhost","u498549608_common","Blogdb@321","u498549608_common");
} 
    
 $query = mysqli_query($conn,"SELECT * FROM `wpblog_posts` WHERE post_status = 'publish' AND post_type = 'post' ORDER BY `ID` DESC LIMIT 6");
// Check connection
if (!$conn) {
 die("Connection failed: " . mysqli_connect_error());
   ...
   if(isset($_POST['enquiry'])) {
     if(isset($_POST['g-recaptcha-response'])){
        ...
        $secretKey = "6LfoQtkaAAAAAHVm4RXT6DDNNSZhOwzFBVhqyGf0";
 ...
 $enq_date = date("Y-m-d");
   $sql = mysqli_query($conn,"INSERT INTO `enquiry`(`first_name`, `last_name`, `query`,`contact_no`, `email`,`website_name`,`enquiry_date`) VALUES ('$first_name','$last_name','$query','$contact_no', '$email', '$website_name','$enq_date')");
...
<table>
<tr>
    <td><strong>Dear Medical Aspirants!</strong></td>
</tr>
<tr>
    <td><strong>Thanks For Connecting with Common Entrance exam Nepal Team </strong></td>
</tr>
<tr>
    <td>We would like to acknowledge that we have received your request and <br> an <strong>Enquiry Ticket</strong> has been created with <strong>Ticket ID - 5400</strong></td>
</tr>
<tr>
    <td>
       Our <strong>Medical Counselor</strong> representative will be reviewing your request <br> and will send you a personal response. 
    </td>
</tr>
<tr>
   <td>
     <strong>For More Details Please Click the Link:</strong> - https://bit.ly/3hlsuU3
   </td>
</tr>
<tr>
   <td>
     <strong style='color:red'>Connect With Us for Daily Update:-</strong>
   </td>
</tr>
<tr>
   <td>
       <ul>
           <li><strong style='color:red'>Blog :</strong> https://www.commonentranceexamnepal.com/blog/</li>
           <li><strong style='color:red'>Entrance exam Notice : </strong>https://www.besonline.in/blog/</li>
           <li><strong style='color:red'>Write For us : </strong>https://www.commonentranceexamnepal.com/all-testimonial.php</li>
           <li><strong style='color:red'>Facebook : </strong>https://www.facebook.com/nepalcommonentranceexams/</li>    
       </ul>
   </td>
</tr>
<tr>
   <td style='display:inline-block;'>
      Sincerely, <br>
      <strong>Common Entrance Exam Nepal Team</strong><br>
      Medical Counselor | E: info@besonline.in  <br>
      <strong>Website:</strong> https://bit.ly/3hlsuU3
   </td>
   <td style='display:inline;'>
        <img src='https://www.commonentranceexamnepal.com/images/nepal-flag-mail.jpg' class='img-responsive' >
    </td>
</tr>
<tr>
    <td><strong style='color:red'>India Support Team:</strong> +91-95647-33330 <br>
    <strong style='color:red'>Nepal Support Team:</strong> +977-98160-70344
    </td>
</tr>
</table>
</body>
...
// More headers
$headers .= 'From: <commonentranceexamnepal@commonentranceexamnepal.com >' . "\r\n";
mail($email_id,$subject,$reason,$headers);
...
<meta name="keywords" content="mec.gov.np, Medical Education Commision, Common Entrance Examination Nepal, Medical In Nepal, MBBS In Nepal, MBBS College in Nepal, medicaleducationcommissionnepal.com" />
<meta name="description" content="Common entrance examination in Nepal 2022 will be conducted with the aim to get students into UG courses, in the elite colleges of the country."/>
<link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico" />
        <title>Common Entrance Examination in Nepal 2022</title>
    ...
    <body>
        ...
        <?php include 'includes/testimonial-old.php'?>
        <?php include 'includes/pg_ug_exam_details.php'?>
        <?php include 'includes/featured-colleges.php'?>
        <section class="container nw-hght">
        <?php include 'includes/news-slider.php'?>
        </section>
