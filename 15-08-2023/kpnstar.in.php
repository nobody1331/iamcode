...
<html lang="zxx">
   <head>      
         ...
         <div class="main-banner item-bg1 jarallax" data-jarallax='{"speed": 0.3}'>
            <div class="d-table">
               <div class="d-table-cell">
                  <div class="container">
                     <div class="main-banner-content" style="visibility: hidden;">
                        <h1>KPN STAR BANDS </h1>
                        <p>Genuine Leather Watch Straps</p>
                        <div class="btn-box">
          ...
          <div class="main-banner item-bg4 jarallax" data-jarallax='{"speed": 0.3}'>
            <div class="d-table">
               <div class="d-table-cell">
                  <div class="container">
                     <div class="main-banner-content" style="visibility: hidden;">
          ...
          <div class="main-banner item-bg5 jarallax" data-jarallax='{"speed": 0.3}'>
            <div class="d-table">
               <div class="d-table-cell">
                  <div class="container">
                   <div class="main-banner-content" style="visibility: hidden;">
      ...
      <div class="about-section ptb-100 dark-green-bg ">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-lg-6 col-md-12">
                  <div class="about-text">
                     <span class="sub-title text-white">Who we are?</span>
                     <h2 class="text-white">Star Bands</h2>
                     <p class="text-white">Welcome to our leather watch strap manufacturing company! We have been crafting high-quality watch straps since 1984 and are proud to be a trusted name in the industry. Our passion for leather and craftsmanship is what sets us apart from other manufacturers. We use only the finest materials, leather hides, and high-quality hardware, to create durable and stylish watch straps that are made to last.</p>
                 
                     <a href="about.php" class="default-btn bg-dark" >About Us <span></span></a>
                  </div>
               </div>
               <div class="col-lg-6 col-md-12">
                  <div class="about-img">
    ...
    <!--   <section class="services-section service-bg ptb-100 jarallax" data-jarallax='{"speed": 0.3}' >
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="services-box">
                     ...
                     <a href="#" class="read-more-btn">SEE SERVICES</a>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="services-box">
     ...
     <!--  <section class="how-we-work-section ptb-100 pt-0 text-center">
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="single-process-box bg-1">
                     <div class="number">
                        <i class="fa fa-clock-o" style="    padding-top: 10px;" ></i>
                     </div>
                     <h3>Speed</h3>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="single-process-box bg-3">
                     <div class="number">                        
                       <i class="fa fa-support" style="    padding-top: 10px;"></i>
                     </div>
                     <h3>Support</h3>
                  </div>
               </div>
         ...
         <div class="about-section ptb-100 pb-100">
         <div class="container">
            <div class="row align-items-center">
...
<video width="100%" controls>
  ...
  <source src="assets/reel.ogg" type="video/ogg">
  Your browser does not support HTML video.
</video><br>
                     <a href="about.php" class="default-btn bg-dark" >Know More<span></span></a>
                  </div>
               </div>
            </div>
         </div>
...
<div class="container">
<div class="section-title">
<span class="sub-title text-white">Testimonials</span>
