...
$conn = mysqli_connect("localhost","u457388739_x7refrig_enqui","O4w~na;fUa3","u457388739_x7refrig_enqui");



//Check Already Exist Or Not//
$userIp = get_client_ip();
$site = "siliguriservicecenter";
$checkUser = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM visitorlog WHERE ip = '$userIp' AND `site`='$site'"));
$date = date("Y-m-d");
$time = time();

if($checkUser>0){
    $updateUser = mysqli_query($conn,"UPDATE visitorlog SET no_of_visit = no_of_visit+1,last_visited='$date',last_timestamp='$time' WHERE ip = '$userIp' AND `site`='$site'");
}else{
    $ip = $userIp;
$details = json_decode(file_get_contents("http://ipinfo.io/{$ip}/json"));
$details = serialize($details); // -> "Mountain View"

    $insertData = mysqli_query($conn,"INSERT INTO visitorlog (ip,last_visited,last_timestamp,no_of_visit,`site`,`details`) VALUES ('$userIp','$date','$time','1','$site','$details')");
}
?>
<!DOCTYPE html>
...
})(window,document,'script','dataLayer','GTM-TXFV98T');</script>
<!-- End Google Tag Manager -->
<!-- Meta Tags -->

<!-- Google tag (gtag.js) -->
<!--<script async src="https://www.googletagmanager.com/gtag/js?id=UA-199796257-1"></script>-->
<!--<script>-->
<!--  window.dataLayer = window.dataLayer || [];-->
<!--  function gtag(){dataLayer.push(arguments);}-->
<!--  gtag('js', new Date());-->

<!--  gtag('config', 'UA-199796257-1');-->
<!--</script>-->
...
<!-- Page Title -->
<title>Siliguri service Centre</title>
     <?php include 'includes/stylesheet.php'?>
     <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-FKGTNGS474"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-FKGTNGS474');
</script>
</head>
<body class="tm-container-1300px has-side-panel side-panel-right switchable-logo">
    <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TXFV98T"
...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content-area">
      <?php include 'includes/top-contact.php'?>
