...
<html lang="en" class="no-js">
   <head>
      <meta charset="utf-8"/>
      <title><?php require('title.php')?> | Cybona - Web Devlopment &amp; Digital Marketing Company in Patna</title>
      <meta name="description" content="Cybona is a professional IT Company serving IT Solutions in Patna to help businesses to grow. We are experts in offering web development services, web designing, mobile app development and digital marketing services in Patna. We are proud to have India’s best web developers, web designers, and digital marketers. ">
      <meta name="keywords" content="Best Web Development Company in patna, Best Web Development Company in bihar, Best Web Development Company in india, Best Web Development Company in hajipur, Best Web Designer Company in patna, Best Web Designer Company in bihar, Best Web Designer Company in india, Best Web Designer Company in hajipur, Best Web Designer in patna, Best Web Developer in patna">
      <meta name="author" content="Aditya Aryan">
      ...
      <!-- template-style-->
      <!-- <link rel="stylesheet" type="text/css" href="css/ihavecookie.css"> -->
      <link href="css/style.css" rel="stylesheet">
      <link href="css/responsive.css" rel="stylesheet">
      <link href="css/darkmode.css" rel="stylesheet">
      <script> (function(ss,ex){ window.ldfdr=window.ldfdr||function(){(ldfdr._q=ldfdr._q||[]).push([].slice.call(arguments));}; (function(d,s){ fs=d.getElementsByTagName(s)[0]; function ce(src){ var cs=d.createElement(s); cs.src=src; cs.async=1; fs.parentNode.insertBefore(cs,fs); }; ce('https://sc.lfeeder.com/lftracker_v1_'+ss+(ex?'_'+ex:'')+'.js'); })(document,'script'); })('kn9Eq4Rjryj4RlvP'); </script>
   </head>
   <body>  
            ...
            <div class="row">
               <div class="col-lg-5">
                  <div class="hero-heading-sec">
                     ...
                     <a href="get-a-quote" class="niwax-btn2 wow fadeIn"  data-wow-delay="0.8s">Get a Quote <i class="fas fa-chevron-right fa-ani"></i></a>
                     <div class="awards-block-tt  wow fadeIn" data-wow-delay="1s"><img src="new-img/awards-logo.png" alt="awards-logo" class="img-fluid"/></div>
                  </div>
               </div>
               <div class="col-lg-7">
                  <div class="hero-content-sec wow fadeIn" data-wow-delay="0.8s">
                     <!-- <div class="video-intro-pp"><a class="video-link play-video" href="https://www.youtube.com/watch?URL_HERE?autoplay=1&amp;rel=0"><span class="triangle-play"></span></a></div> -->
                        ...
                        <div class="owl-carousel service-card-prb">
                              ...
                              <a href="#">
                                 <div class="service-card-hh">
                                    <div class="image-sr-mm">
                                       <img alt="custom-sport" src="new-img/startup.png" alt="Web Development & Web Design Solutions">
                                    </div>
                                    <div class="title-serv-c"><span>Build Your Brand with Our Custom Web Development</span> Solutions</div>
                                 </div>
                              </a>
                           </div>
                           <div class="service-slide card-bg-b" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                              <a href="#">
                                 <div class="service-card-hh">
                                    <div class="image-sr-mm">
                                       <img alt="custom-sport" src="new-img/theme&layout.png" alt="Themes & Layouts">
                                    </div>
                                    <div class="title-serv-c"><span>Get Catchy and Unique Website </span> Themes and Layouts</div>
                                 </div>
                              </a>
                           </div>
                           <div class="service-slide card-bg-c" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                              <a href="#">
                                 <div class="service-card-hh">
                                    <div class="image-sr-mm">
                                       <img alt="custom-sport" src="new-img/marketing.png" alt="Digital Marketing Solutions">
                                    </div>
                                    <div class="title-serv-c"><span>Enhance Business Online Presence through </span>Digital Marketing</div>
                                 </div>
                              </a>
                           </div>
                           <div class="service-slide card-bg-d" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                              <a href="#">
                                 <div class="service-card-hh">
                                    <div class="image-sr-mm">
                                       <img alt="custom-sport" src="images/service/app-develop.png" alt="App Development Solutions">
                                    </div>
                                    <div class="title-serv-c"><span>Introduce Your App via Our Mobile App Development </span> Solutions</div>
                                 </div>
                              </a>
                           </div>
            ...
            <div class="row justify-content-center text-center">
               <div class="col-lg-10">
                  <div class="common-heading">
                     <span>We Are Creative Web Services Proivders</span>
                     <h1 class="mb30"><span class="text-second">Let Cybona</span> Serve You with the Best IT Solutions</h1>
                     <p><span class="text-radius text-light text-animation bg-b">Cybona</span> Cybona is a professional IT Company serving IT Solutions in Patna to help businesses to grow. We are experts in offering web development services, web designing, mobile app development and digital marketing services in Patna. We are proud to have India’s best web developers, web designers, and digital marketers. 
                     ...
                     <p><span class="text-bold">We're so good</span> text We're so good at what we do that you'll think we're magicians. We are the best in web design, development and digital marketing. Contact us today to see how Cybona can take your website to new heights!<!-- <span class="text-bold">printing</span> and typesetting industry. <span class="text-bold">Lorem Ipsum is simply</span> dummy text of the printing and typesetting industry. is simply dummy text of the printing and typesetting industry. --> </p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row upset">
               <div  data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-6-cus wow fadeInUp" data-wow-delay=".2s">
                  <div class="service-sec-brp srvc-bg-nx bg-gradient13 text-w">
                     ...
                     <p>What IT Services Cybona Offers?</p>
               ...
               <div  data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus wow fadeInUp" data-wow-delay=".4s">
                  <div class="service-sec-list srvc-bg-nx srcl1">
                     ...
                     <p>Cybona has expert web developers that are committed to offering dynamic and responsive websites. Our professional developers are proficient in building your websites using advanced technologies to ensure an error-free and performance-based website</p>
                  </div>
               </div>
               <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus wow fadeInUp" data-wow-delay=".6s">
                  <div class="service-sec-list srvc-bg-nx srcl2">
                     ...
                     <h5 class="mb10">Web Designing Services</h5>
                     <ul class="-service-list">
                        <li> <a href="#">HTML </a> </li>
                        <li> <a href="#">CSS</a> </li>
                     ...
                     <p>At Cybona, web designers use their expertise to bring uniqueness and creativity to web design. We help you build a unique identity for your website through attractive web designs to catch users’ attention and show what you have to offer to your clients.</p>
                  </div>
               </div>
               <div  data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus mt30- wow fadeInUp" data-wow-delay=".8s">
                  <div class="service-sec-list srvc-bg-nx srcl3">
                     ...
                     <h5 class="mb10">Digital Marketing Services</h5>
                     <ul class="-service-list">
                        <li> <a href="#">SEO</a> </li>
                        <li> <a href="#">PPC(Pay Per Click)</a> </li>
                        <li> <a href="#">SMM </a></li>
                     </ul>
                     <p>We understand that your brand is everything to you, so we ensure to promote your brand by using different platforms. In our digital marketing services, we offer social media marketing, search engine optimization and run ad campaigns on Facebook.</p>
                  </div>
               </div>
               <div  data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-3-cus mt30- wow fadeInUp" data-wow-delay="1s">
                  <div class="service-sec-list srvc-bg-nx srcl4">
                     ...
                     <h5 class="mb10">Mobile App Development Services</h5>
                     <ul class="-service-list">
                        <li> <a href="#">IOS App</a> </li>
                        <li> <a href="#">Android App</a> </li>
                        <li> <a href="#"> Integrated App</a></li>
                     </ul>
                     <p>We can help you introduce your new app by developing customized mobile apps for iOS and Android. While giving your project to us, you can be sure that your app will be bug-free. Our app developers ensure to meet customers’ requirements. </p>
                  </div>
               </div>
            ...
            <div class="-cta-btn mt70">
               <div class="free-cta-title v-center zoomInDown wow" data-wow-delay="1.4s">
                  <p>Start your career with <span>Cybona</span></p>
            ...
            <div class="row">
               <div class="col-lg-6">
                  <div class="common-heading text-l">
                     ...
                     <h2 class="mb20">Why The Cybona <span class="text-second text-bold">Ranked Top</span> Among The Leading Web & App Development Companies in Patna</h2>
                     <p>Trusting any IT Service provider might be difficult, but with us, it won’t be. By hiring our services, you can be sure that your project is in the right hands. The following are some reasons why you should count on us:</p>
                     <div class="itm-media-object mt40 tilt-3d">
                        <div class="media">
                           ...
                           <div class="media-body">
                              ...
                              <p>One of the most interesting things about Cybona is that we don’t have any hidden charges. Many times customers are afraid of hiring any company because of hidden charges, but with us, you don’t need to worry about it.</p>
                           </div>
                        </div>
                        <div class="media mt40">
                           ...
                           <div class="media-body">
                              ...
                              <p>We prioritize our customers over other things because we believe gathering customers’ requirements is the first step to meeting our client's goals. As a result, we make a plan and execute it to deliver customized websites to our customers.</p>
                           </div>
                        </div>
                        <div class="media mt40">
                           ...
                           <div class="media-body">
                              ...
                              <p>The thing that makes us unique from others is that we deliver projects to the customers on time. We ensure the projects are delivered to the clients before or on the date we committed to delivering. In this way, we successfully maintain good relations with our clients.</p>
                           </div>
                        </div>
                        <div class="media mt40">
                           <div class="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"> <img src="images/icons/deal.svg" alt="icon" class="layer"></div>
                           <div class="media-body">
                              ...
                              <p>We have employees who give their precious time and efforts to clients’ projects to ensure everything is going well. They understand their responsibility to deliver the project to the intended customer on time without any delays. </p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-6">
                  <div  data-tilt data-tilt-max="5" data-tilt-speed="1000" class="single-image bg-shape-dez wow fadeIn" data-wow-duration="2s"><img src="new-img/top-ranked.webp" alt="image" class="img-fluid"></div>
                  ...
                  <div class="cta-card mt60 text-center">
                     <h3 class="mb20">Have Any Query? <span class="text-second text-bold">Ask Us</span></h3>
                     <p>If you have any questions regarding web development, digital marketing, web designing, or mobile app development services, then you can ask us by contacting us.</p>
                     <a href="get-a-quote" class="niwax-btn1 mt30"><span>Request A Quote <i class="fas fa-chevron-right fa-icon"></i></span></a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <!--                  <a href="#"><img src="new-img/brown-bob-salon.png" alt="image" class="img-fluid" /> </a>-->
      <!--               </div>-->
      <!--               <div class="item-info">-->
      <!--                  <h4><a href="#">Brown Bob Saloon | Saloon Multi-Vendor Website</a></h4>-->
      <!--                  <p>Web Application</p>-->
      <!--               </div>-->
      <!--            </div>-->
      <!--         </div>-->
      ...
      <!--            <div class="isotope_item hover-scale">-->
      <!--               <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">-->
      <!--                  <a href="#"><img src="new-img/tagore studnet club .png" alt="Tagore Student Club" class="img-fluid" /> </a>-->
      <!--               </div>-->
      <!--               <div class="item-info">-->
      <!--                  <h4><a href="#">Tagore Student Club</a></h4>-->
      <!--                  <p>Web Application</p>-->
      <!--               </div>-->
      <!--            </div>-->
      <!--         </div>-->
      ...
      <!--            <div class="isotope_item hover-scale">-->
      <!--               <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">-->
      <!--                  <a href="#"><img src="new-img/tagoreeducons.png" alt="Tagore Educons Website" class="img-fluid" /> </a>-->
      <!--               </div>-->
      <!--               <div class="item-info">-->
      <!--                  <h4><a href="#">Tagore Educons </a></h4>-->
      <!--                  <p>Website (PHP,HTML,CSS)</p>-->
      <!--               </div>-->
      <!--            </div>-->
      <!--         </div>-->
      ...
      <!--            <div class="isotope_item hover-scale">-->
      <!--               <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">-->
      <!--                  <a href="#"><img src="new-img/edufort.png" alt="Edu Fort Website" class="img-fluid" /> </a>-->
      <!--               </div>-->
      <!--               <div class="item-info">-->
      <!--                  <h4><a href="#">Edufort </a></h4>-->
      <!--                  <p>Web Application</p>-->
      <!--               </div>-->
      <!--            </div>-->
      <!--         </div>-->
...
$sql = "SELECT * FROM clients WHERE 1 ORDER BY id DESC";
...
?>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".2s">
                           <div class="brand-logo"><img src="https://manage.cybona.in/<?php echo $row['c_img']?>" alt="clients" class="img-fluid"></div>
...
<?php } } ?>
         ...
         <div class="container">
            ...
            <div class="-cta-btn mt70">
               <div class="free-cta-title v-center wow fadeInUp" data-wow-delay="1s">
                  ...
                  <a href="tel:+91 94316 47994" class="btn-main bg-btn2 lnk">Let's Work Together<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
               </div>
            </div>
         </div>
      </section>
            ...
            <div class="row">
               <div class="col-lg-4 v-center">
                  <div class="common-heading text-l">
                     ...
                     <p>What if your business was in a constant state of transformation? Cybona is the solution for companies who want to stay on top of their game. Start with a consultation and find out how we can transform you!</p>
                  </div>
               </div>
               <div class="col-lg-8">
      ...
      <section class="testinomial-section bg-none pad-tb">
         <div class="container">
            <div class="row justify-content-center ">
               <div class="col-lg-8">
                  <div class="common-heading">
                     <span>What our clients say about Cybona.</span>
                     <h2>Over 100+ Satisfied Clients and Growing</h2>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-lg-6">
                  <div class="video-testimonials owl-carousel">
                     <div class="video-review" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                        <a class="video-link" href="https://www.youtube.com/watch?YOUR_URL?autoplay=1&amp;rel=0">
                           <img src="new-img/webdevelopment.png" alt="client" class="img-fluid">
                     ...
                     <div class="video-review" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                        <a class="video-link" href="https://www.youtube.com/watch?YOUR_URL?autoplay=1&amp;rel=0">
                           <img src="new-img/theme&layout.png" alt="client" class="img-fluid">
                           <div class="review-vid-details">
                              <div class="-vid-ico"><span class="triangle-play2"></span></div>
                              <p>Cybona</p>
                           </div>
               ...
               <div class="col-lg-6">
                  <div class="owl-carousel testimonial-card-a pl25">
                     <div class="testimonial-card">
                        <div class="t-text">
                           <p>Company provides good opportunity to upskill yourself, by providing challenging situations and helps you brush up you skills and learnings. It also give an ability to multitask yourself by managing many things at a time.</p>
                        </div>
                        <div class="client-thumbs mt30">
                           <div class="media v-center">
                              <div class="user-image bdr-radius"><img src="new-img/default.png" alt="girl" class="img-fluid" /></div>
                              <div class="media-body user-info v-center">
                                 <h5>Ramesh Kumar</h5>
                                  <p>Business Owner, <small>Patna,</small></p></p>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="testimonial-card">
                        <div class="t-text">
                           <p>It is a distinct pleasure for me to recommend Thrive Internet Marketing to any and all interested parties. They have been professional, comprehensive and competent throughout the process of our working together. We feel that we have established a relationship with them for years to come. The reaction to our new web site has been overwhelmingly positive; as one commented the site is “FANTASTIC.” The same can be said for our view of Thrive’s work for us.</p>
                        </div>
                        <div class="client-thumbs mt30">
                           <div class="media v-center">
                              <div class="user-image bdr-radius"><img src="new-img/default.png" alt="girl" class="img-fluid" /></div>
                              <div class="media-body user-info">
                                 <h5>Roshan</h5>
                                 <p>Owner GlobalMount, <small>Patna, India</small></p>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="testimonial-card">
                        <div class="t-text">
                           <p>Since having our new website built by Cybona & Team, we have seen a 200% increase in the number of online contact forms being filled out and returned to us. Aditya and his team worked closely with us to provide a site that met all of the criteria that we were looking for. The end result was a website that is attractive, organized and effective. Thanks to Thrive for all of your hard work and support!. 'Best Web Development in Patna'</p>
                        </div>
                        <div class="client-thumbs mt30">
                           <div class="media v-center">
                              <div class="user-image bdr-radius"><img src="new-img/default.png" alt="girl" class="img-fluid" /></div>
                              <div class="media-body user-info">
                                 <h5>Paras</h5>
                                 <p>Client, <small>Delhi, India</small></p>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="col-lg-12">
                  <div class="review-ref mt100">
                     ...
                     <div class="review-icons">
                        ...
                        <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".4s"><img width="100" src="new-img/linkden.webp" alt="review" class="img-fluid"></a>
                        <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".6s"><img width="100" src="new-img/justdial.png" alt="review" class="img-fluid"></a>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="common-heading">
                     ...
                     <a href="https://wa.me/+919431647994" class="btn-outline">Chat with us <i class="fas fa-chevron-right fa-icon"></i></a>
                     <p class="cta-call">Or call us now <a href="tel:+91 94316 47994"><i class="fas fa-phone-alt"></i> +91 94316 47994</a></p>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-lg-4 col-sm-12 shape-loc wow fadeInUp" data-wow-delay=".2s">
                  <div class="office-card">
                     <div class="skyline-img" data-tilt data-tilt-max="4" data-tilt-speed="1000">
                        <img src="new-img/patna.webp" alt="Patna City" class="img-fluid" />
                     </div>
                     <div class="office-text">
                        <h4>Patna, India</h4>
                        <p>8A, E Ashok Nagar Rd, Ram Lakhan Path, Lohia Nagar, patna, Bihar 800020</p>
                        <a href="javascript:void(0)" target="blank" class="btn-outline rount-btn"><i class="fas fa-map-marker-alt"></i></a>
                        <a href="tel:+91 94316 47994" target="blank" class="btn-outline rount-btn"><i class="fas fa-phone-alt"></i></a>
                        <a href="mailto:info@cybona.in" target="blank" class="btn-outline rount-btn"><i class="fas fa-envelope"></i></a>
      ...
      <script type="text/javascript" src="js/gdprcookies.js"></script> -->
      <!--common script file-->
