...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title -->
        <title>M-Tech India | Non Vacuum & Vacuum Blood Collection Tubes</title>
          ...
          <!--   <div id="ht-preloader">
            ...
            <section class="banner p-0 pos-r fullscreen-banner">
                <div class="banner-slider owl-carousel no-pb">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-6 col-md-10 col-12">
                                        <h1 class="mb-4 text-black">Welcome to <span class="text-theme"><br/><span style="color: #eb4334;">M-</span><span style="color: #0ba554;">Tech </span><span style="color: #eb4334;">India</span></span> </h1>
                                        <p class="lead font-w-5 text-black">Non Vacuum & Vacuum Blood Collection Tubes</p>
                                        <div class="btn-box mt-5">
                                            <a class="btn btn-theme" href="about-us.php"> <span>More About</span> </a>
                                            <a class="btn btn-dark" href="#"> <span>Book Appointment</span> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="item hero-overlay" data-bg-img="images/bg/06.jpg" data-overlay="6">
                        <div class="align-center pt-0">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-6 col-md-10 col-12">
                                        <h1 class="mb-4 text-black">Non Vacuum & Vacuum <span class="text-theme" style="color: #fff;"> Blood Collection Tubes</span></h1>
                                        <p class="lead font-w-5 text-black">None Sterile Urain Container 30 ml Blood Draw Volume: 1ml. 2ml. 3ml. 4ml.</p>
                                        <div class="btn-box mt-5">
                                            <a class="btn btn-theme" href="about-us.php"> <span>More About</span> </a>
                                            <a class="btn btn-dark" href="#"> <span>Book Appointment</span> </a>
                                        </div>
                                ...
                                <div class="row align-items-end">
                                    <div class="col-md-12">
                                        <div class="section-title">
                                            <h2 class="title">About <span style="color: #eb4334;">M-</span><span style="color: #0ba554;">Tech</span><span style="color: #eb4334;">India</span></h2>
                                            <p class="text-black font-w-5 mb-3">Non Vacuum & Vacuum Blood Collection Tubes</p>
                                            <p>Established in the year 2018 at Sardar Chwok, Ahmedabad, Gujarat, We "M-Tech India” are a Proprietor based firm, engaged as Manufacturer, Wholesaler and Retailer of Clot Activator Vacuum Blood Collection Tube, K3 EDTA Vacuum Blood Collection Tube, etc. Our products are high in demand due to their premium quality and affordable prices. Furthermore, we ensure to timely deliver these products to our clients, through this we have gained a huge clients base in the market.</p>
                                        </div>
                                        <a class="btn btn-theme" href="about-us.php"> <span>More About</span> </a>
                                    </div>
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-lg-7 col-12">
                                <div class="section-title mb-3">
                                    <h2 class="title mb-0">We Provide All Services & Product</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="owl-carousel" data-items="3" data-md-items="2" data-sm-items="1" data-xs-items="1" data-margin="30">
                                    <?php
                                        $query="SELECT * FROM `service` s INNER JOIN `category` c ON c.Category_id=s.Category_id GROUP BY c.Category_id";
                                        $res=mysqli_query($conn,$query);
                                        while($row=mysqli_fetch_array($res))
                                        {
                                            $desc=$row['Service_desc'];
                                            $res1=substr($desc,0,120);
                                    ?>  
                                    <div class="item">
                                        <div class="service-item style-1">
                                            <div class="service-img mx-4 z-index-1 overflow-hidden">
                                                <img class="img-fluid" src="admin/upload/<?php echo $row['Service_image'] ?>" alt="" />
                                                <div class="service-icon"><i class="flaticon-biology-1"></i></div>
                                            </div>
                                            <div class="service-desc white-bg mt-n5 pt-7">
                                                <div class="service-title">
                                                    <h4><?php echo $row['Category_title'] ?><br/><br/></h4>
                                                </div>
                                                <p></p>
                                                <a class="link-btn" href="services.php?slug=<?php echo $row['cate_slug'] ?>"><i class="las la-long-arrow-alt-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="counter d-flex">
                                                <div class="counter-icon me-3"><i class="flaticon-medical-laboratory-1"></i></div>
                                                <div class="counter-desc">
                                                    <span class="count-number text-black" data-to="24" data-speed="2000">24</span>
                                                    <h6></h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6 mt-5 mt-sm-0">
                                            <div class="counter d-flex">
                                                <div class="counter-icon me-3"><i class="flaticon-heathcare-and-medical"></i></div>
                                                <div class="counter-desc">
                                                    <span class="count-number text-black" data-to="272" data-speed="2000">272</span>
                                        ...
                                        <div class="col-lg-3 col-sm-6 mt-5 mt-lg-0">
                                            <div class="counter d-flex">
                                                <div class="counter-icon me-3"><i class="flaticon-pharmacy"></i></div>
                                                <div class="counter-desc">
                                                    <span class="count-number text-black" data-to="423" data-speed="2000">423</span>
                                        ...
                                        <div class="col-lg-3 col-sm-6 mt-5 mt-lg-0">
                                            <div class="counter d-flex">
                                                <div class="counter-icon me-3"><i class="flaticon-award"></i></div>
                                                <div class="counter-desc">
                                                    <span class="count-number text-black" data-to="576" data-speed="2000">576</span>
      ...
      <div class="col-md-8 theme-bg py-5 px-lg-8 px-5">
            ...
            <div class="testimonial text-center">
              ...
              <div class="testimonial-content">
                <div class="testimonial-caption mb-3">
                  <h5 class="text-white">Chirag Patel</h5>
                  <label class="fst-italic d-block text-light">-Customer-</label>
                </div>
                <p class="fst-italic text-light">Excellent Machine Quality..  And Best Service Provider.</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="testimonial text-center">
              ...
              <div class="testimonial-content">
                <div class="testimonial-caption mb-3">
                  <h5 class="text-white">Sanjay Patel</h5>
                  <label class="fst-italic d-block text-light">-Customer</label>
                </div>
                <p class="fst-italic text-light">Excellent machine quality nd gud services support</p>
              </div>
            </div>
          </div>
        </div>
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    <div class="item">
                                        <div class="cases-item position-relative overflow-hidden">
                                            <img class="img-fluid w-100" src="admin/upload/<?php echo $row['Gallary_image']; ?>" alt="" />
                                            <a class="popup-img" href="admin/upload/<?php echo $row['Gallary_image']; ?>"> <i class="las la-plus"></i> </a>
                                            <div class="cases-title">
                                                <span>M-Tech India</span>
                                                <h4><a href="#">Blood Collection</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                   <?php } ?>
                            ...
                            <div class="col-md-5 col-12 ms-auto mt-3 mt-lg-0">
                                <div class="d-flex align-items-start justify-content-end">
                                    <div class="text-white text-end">
                                        ...
                                        <h3 class="font-w-4"><a class="text-decoration-underline text-white" href="tel:919924066145">(+91) 99240 66145</a></h3>
                                    </div>
                                    <span class="white-bg d-inline-block p-2 ms-4"><i class="las la-phone ic-3x text-theme"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <hr class="my-5" />
                        <div class="d-flex justify-content-between align-items-center mb-8"><span class="text-muted">Subtotal:</span> <span class="text-dark">$280.00</span></div>
        ...
        <!-- <div class="color-customizer closed">
            <div class="color-button">
                <a class="opener" href="#"> <i class="las la-spinner fa-spin"></i> </a>
            </div>
        ...
        <div class="scroll-top">
            <a class="smoothscroll" href="#top"><i class="las la-location-arrow"></i></a>
        </div>
