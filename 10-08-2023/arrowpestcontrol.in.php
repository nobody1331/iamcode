...
<!-- Mirrored from roofsie-html.vercel.app/main-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2023 04:22:56 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
   <?php
   include('Meta_SEO.php');
   ?>
    <!-- favicons Icons -->
    ...
    <meta name="keywords" content="cockroach bite treatment | Best treatment for cockroaches | khatmal pest control treatment | bed bug control services
rat proof home | rat proof your home | ant pest control service | best mosquito company near me
best pest control for mosquitoes | Termite control in surat |
Termite pest control treatment treatment  |
honey bee bite treatment |
bee bite treatment |
bird pest control near me |
lizard control services near me |
house lizard pest control |
woodborer treatment |
Termite treatment in surat |
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="main-slider clearfix">
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    <?php
                    $con = mysqli_connect("localhost","u683606693_arrow","Sunil@1998","u683606693_arrow");
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url('admin/detabase/slider/<?php echo $row['bg_Image']; ?>');"></div>
                        <!-- /.image-layer -->
                            ...
                            <div class="row">
                                <div class="col-xl-7 col-lg-8">
                                    <div class="main-slider__content">
                                        ...
                                        <h2 class="main-slider__title"><?php echo $row['sd_title']; ?></h2>
                                        <p class="main-slider__text"><?php echo $row['short_description']; ?></p>
                                         <h3 class="main-slider__title"><a href="tel:918401306011" style="color: #ffffff;"><span class="icon-phone-call"></span> 84013 06011</a></h3>
                                        <div class="main-slider__btn-box">
                                            <a href="<?php echo $row['button_link']; ?>" class="thm-btn"> <i class="fa fa-arrow-right"></i>
                                              8401306011</a>
                                        </div>
                                    </div>
                                </div>
        ...
        <!--About One Start-->
         <?php 
                $sql=mysqli_query($con,"SELECT * FROM about_business");
                while ($row=mysqli_fetch_array($sql)) {
                        ...
                        <div class="about-one__left">
                            ...
                            data-wow-duration="2500ms">
                                <div class="about-one__img">
                                    <img src="admin/detabase/image/<?php echo $row['image']; ?>" alt="">
                                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title"><?php echo $row['about_title']; ?></h2>
                            </div>
                            <p class="about-one__text"><?php echo $row['about_description']; ?></p>
                           
                            <a href="<?php echo $row['button_url']; ?>" class="thm-btn about-one__btn"> <i class="fa fa-whatsapp" aria-hidden="true"></i> Get Tuch With Us</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="services-one__top-left">
                                <div class="section-title text-left">
                                    ...
                                    <h2 class="section-title__title">Pest Control Services In Surat | Pest Control Near You</h2>
                                    <div class="main-menu-three__btn-box">
                                    <a href="http://wa.me/918401306011" class="thm-btn main-menu-three__btn"> <i class="icon-phone-call"></i> 8401306011</a>
                                </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="services-one__bottom">
                    <div class="row">
                        ...
                        <?php
                        $sql=mysqli_query($con,"SELECT * FROM our_services");
                        while($row=mysqli_fetch_array($sql)){
                        ?>
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                            <div class="services-one__single">
                                <div class="services-one__img">
                                    <img src="admin/detabase/service/<?php echo $row['service_image']; ?>" alt="">
                                </div>
                                <div class="services-one__content">
                                    <!-- <div class="services-one__icon">
                                        <span class="icon-roof"></span>
                                    </div> -->
                                    <h3 class="services-one__title"><a href="single-play-roofing.html">
                                        <?php echo $row['service_title']; ?>
                                    </a></h3>
                                    <p class="services-one__text">
                                        <?php echo $row['service_short_description']; ?>
                                    </p>
                                    <div class="services-one__read-more">
                                        <a href="single-server.php?id=<?php echo $row['ser_id']; ?>">Read More <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <?php 
        $sql=mysqli_query($con,"SELECT * FROM why_choose_us");
        while ($row=mysqli_fetch_array($sql)) {
                    ...
                    <div class="col-xl-6">
                        <div class="why-choose-one__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title"><?php echo $row['title']; ?></h2>
                            </div>
                            <p class="why-choose-one__text"><?php echo $row['description']; ?></p>
                ...
                <div class="counter-one__inner">
                    <div class="counter-one__left">
                        <div class="counter-one__left-content">
                            <p class="counter-one__sub-title">Our Numbers Achievement</p>
                            <h3 class="counter-one__title">Arrow Pest Control</h3>
                    ...
                    <div class="counter-one__right">
                        <ul class="list-unstyled counter-one__list">
                            <li>
                                ...
                                <p class="counter-one__text">Projects <br> competed successfully</p>
                            ...
                            <li>
                                ...
                                <p class="counter-one__text">Awards & <br> certificates received For Pest Control</p>
                                <div class="counter-one__icon">
                            ...
                            <li>
                                ...
                                <p class="counter-one__text">industrial & corporate Project competed</p>
                                <div class="counter-one__icon">
                                    <span class="icon-construction-worker-1"></span>
                                </div>
                                <div class="counter-one__big-icon">
                                    <span class="icon-construction-worker-1"></span>
                                </div>
        ...
        <section class="project-one">
            <div class="project-one__top">
                <div class="container">
                    <div class="section-title text-center">
                        <div class="section-sub-title-box">
                            <p class="section-sub-title">Latest Projects & portfolio,work</p>
                            <div class="section-title-shape-1">
                                <img src="assets/images/shapes/section-title-shape-1.png" alt="">
                            </div>
                        </div>
            ...
            <div class="project-one__bottom">
                <div class="project-one__bottom-wrapper">
                    ...
                    <?php 
                    $sql=mysqli_query($con,"SELECT * FROM work_portfolio");
                    while($row=mysqli_fetch_array($sql)){
                    ?>
                            ...
                            <div class="project-one__single">
                                <div class="project-one__img-box">
                                    <div class="project-one__img">
                                        <img src="admin/detabase/work_portfolio/<?php echo $row['image']; ?>" alt="">
                                    </div>
                                    <div class="project-one__content">
                                        <h4 class="project-one__title"><a href="#"><?php echo $row['title']; ?></a>
                                        </h4>
                                    </div>
                                   <!--  <div class="project-one__link">
                                        <a class="img-popup" href="assets/images/project/project-1-1.jpg"><i class="fa fa-link"></i></a>
                                    </div> -->
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="testimonial-one__client-info">
                                <div class="testimonial-one__client-img-box">
                                    <div class="testimonial-one__client-img">
                                        <img src="admin/detabase/testimonials/<?php echo $row['image']; ?>" alt="">
                                    </div>
                                </div>
                                <div class="testimonial-one__client-details">
                                    <h4 class="testimonial-one__client-name"><?php echo $row['person_name']; ?></h4>
                                    <p class="testimonial-one__client-sub-title"><?php echo $row['designation']; ?></p>
                                </div>
                            </div>
                            <p class="testimonial-one__text"><?php echo $row['short_review'];?></p>
            ...
            <div class="container">
                <div class="cta-one__inner">
                    <div class="cta-one__left">
                        <p class="cta-one__sub-title">Quality Serives provider</p>
                        <h3 class="cta-one__title">Need Pest Control services?</h3>
                    </div>
                    <div class="cta-one__btn-box">
                        <a href="http://wa.me/918401306011" class="thm-btn cta-one__btn"> <i class="fa fa-arrow-right"></i>Get Serice Now</a>
                    </div>
                </div>
            </div>
        </section>
         ...
         <section class="contact-page">
            ...
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">Let's Connect With Us</h2>
                </div>
                <div class="card">
  <h5 class="card-header text-center bg-danger text-white">Pest Control Near You</h5>
  <div class="card-body">
    <div class="col-md-12 text-center">
                                <div class="comment-form__btn-box">
                                            <a href="http://wa.me/918401306011" class="thm-btn comment-form__btn"> <i
                                                    class="fa fa-arrow-right"></i> Send a message</a>
                                </div><br>
                                <div class="comment-form__btn-box">
                                    <h5 class="card-title text-center"><span class="icon-pin"></span> <b>Address :-></b> 721 , Nagsen nagar, pandesara, Gujarat 394221</h5><br>
                                </div>
    </div>
    <a href="tel:8401306011"><h5 class="card-title text-center"><span class="icon-telephone"></span> +91 84013 06011</h5></a>
    <br>
    <a href="mailto:arrowpestcontrol.in@gmail.com"><h5 class="card-title text-center"><span class="icon-email"></span> arrowpestcontrol.in@gmail.com</h5></a> 
  </div>
</div>
            </div>
        </section>
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@packageName__.com">arrowpestcontrol.in@gmail.com.com</a>
                </li>
                <li>
                    <i class="fa fa-phone-alt"></i>
                    <a href="tel:84013060011">84013060011</a>
                </li>
...
<!-- Mirrored from roofsie-html.vercel.app/main-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2023 04:23:24 GMT -->
</html>