...
<html lang="en">
<head>
    <title>Tagore Educons - Transforming Education for a Better Future</title>
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="Tagore Educons - Transforming Education for a Better Future"> 
    <meta name="description" content="Tagore Educons - Transforming education landscape with holistic guidance, support, and innovative learning approaches for students, institutions, and educators.">
    <meta name="author" content="Tagore Educons - Transforming education landscape with holistic guidance, support, and innovative learning approaches for students, institutions, and educators.">    
    ...
    <link id="theme-style" rel="stylesheet" href="custom-css.css">

    <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous"/>
    <meta name="google-site-verification" content="4hN70aTXispHjgYhuzjSUoa_XWD-SmMb40mS82XNyj0"/>
    <link rel="canonical" href="<?php echo $actual_link = (empty($_SERVER['HTTPS']) ? 'http' : 'https') . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";?>" />
</head> 
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "LocalBusiness",
  "name": "Tagore Educons",
  "image": "https://tagoreeducons.com/new-img/logo.png",
  "@id": "",
  "url": "https://tagoreeducons.com/",
  "telephone": "9835922300",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Opposite A. N. College, Boring Rd, near Roti Restaurant",
    ...
    <?php include('header.php')?>
        ...
        <div class="content container">
            <div id="promo-slider " class="slider flexslider ">
                <ul class="slides">
                    <li>
                        <!--<img src="new-img/03.jpg"  alt="" />-->
                        <img src="new-img/new-4.jpg" class="desktop-only">
                        <img src="new-img/new-4.jpg" class="mobile-only">
                        
                        <p class="flex-caption">
                            <span class="main" >Favourite Course at Dream College</span>
                            <br />
                            <span class="secondary clearfix" >Proper Counselling for Career Oriented Course at the Best College</span>
                        </p>
                    </li>
                    <li>
                        <img src="new-img/new-3.jpg" class="desktop-only">
                        <img src="new-img/new-3.jpg" class="mobile-only">
                        <p class="flex-caption">
                            <span class="main" >Trustworthy & Satisfactory</span>
                            <br />
                            <span class="secondary clearfix" >Earned the Trust of Students & Guardians for Secure & Sure Services</span>
                        </p>
                    </li>
                    <li>
                        <img src="new-img/new-2.jpg" class="desktop-only">
                        <img src="new-img/new-2.jpg" class="mobile-only">
                        <p class="flex-caption">
                            <span class="main" >Fulfilling Career Hopes</span>
                            <br />
                            <span class="secondary clearfix" >Assistance for Selection of Academics for Bright Career</span>
                        </p>
                    </li>
                    <li>
                        <img src="new-img/new-1.jpg" class="desktop-only">
                        <img src="new-img/new-1.jpg" class="mobile-only">
                        <p class="flex-caption">
                            <span class="main" >Favourite Course at Dream College</span>
                            <br />
                            <span class="secondary clearfix" >Proper Counselling for Career Oriented Course at the Best College</span>
            ...
            <section class="promo box box-dark shadow-only">     
	            <div class="row ">  
	                <div class="col-lg-9 col-12">
	                <h1 class="section-heading">Tagore Educons</h1>
	                    <p>Tagore Educons performs with the mission to make students aware of their future prospects and assist them to go for higher education and, finally, to attain their career dreams. We fulfill career hopes of students.</p>   
	                </div> 
            ...
            <section class="news shadow-blur">
...
<ul class="list-inline list-unstyled r">
    ...
    <?php 
                                    ...
                                    ?>
<li class="productbox">
    <img style="width: 75px !important;height: auto !important;" src="assets/images/news/chat.png"  alt="" />
    <h3 class="producttitle"><a href="apply_notification.php?not_id=<?php echo($res1['not_id'])?>"><?php echo($res1['header'])?></a></h3>
    <div class="producttitle"> <a href="apply_notification.php?not_id=<?php echo($res1['not_id'])?>"><?php echo($res1['description'])?></a> </div>
    <div class="producttitle"> <a class="btn btn-primary" href="apply_notification.php?not_id=<?php echo($res1['not_id'])?>">Know More</a> </div> 
</li>
 ...
 <?php $count++; }}?>
            ...
            <div class="row cols-wrapper ">
                <div class="col-lg-3 col-12">
                    <section class="events shadow-blur"  >
                        <h1 class="section-heading text-highlight"><span class="line">Top Recent Colleges</span></h1>
                        <div class="section-content">

                    <?php 
                                        $sql2 = "SELECT * FROM college ORDER BY college_name DESC LIMIT 4";
                            ...
                            <div class="event-item">
                                <p class="date-label bg-transparent">
                                 <img src="/admin/'.$res2['college_img'].'" width="40px">
                                     <!--<i class="fa fa-university" style="font-size: 35px;"></i>
                                     <span class="month">FEB</span>
                                    <span class="date-number">18</span> -->
                                </p>
                                <div class="details">
                                    <h2 class="title"><a href="/colleges-single.php?clg_id='.$res2['college_id'].'">'.$res2['college_name'].'</a></h2>
                                    <p class="time"><i class="far fa-marker-alt"></i>'.$res2['college_city'].'</p>
                                    <p class="location"><i class="fas fa-map-marker-alt"></i>'.$res2['college_state'].'</p>                            
                                </div><!--//details-->
                            </div>';
                            ...
                            <a class="read-more" href="all_colleges.php">All Colleges<i class="fas fa-chevron-right"></i></a>
                        </div><!--//section-content-->
                    </section><!--//events-->
                    <section class="links shadow-blur">
                        <h1 class="section-heading text-highlight"><span class="line">Latest Exams</span></h1>
                        <div class="section-content">
                        	<marquee width="100%" direction="up" height="150px" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">

                                <?php 
                                        $sql5 = "SELECT * FROM exam ORDER BY id DESC";
                                        $query1 = mysqli_query($conn,$sql5);
                                        
                                        if($query1->num_rows > 0)
                                        {
                                            while($res5 = mysqli_fetch_array($query1)){
                            echo'<p><a href="apply_exams.php?exm_id='.$res5['exam_id'].'"><i class="fas fa-caret-right"></i>'.$res5['exam_name'].'</a></p>';
                ...
                <div class="col-lg-6 col-12">
                    <section class="course-finder shadow-blur">
                        <h1 class="section-heading text-highlight"><span class="line">Course Finder</span></h1>
                        <div class="section-content">
                            <form class="course-finder-form" action="courseslist.php" method="post">
                                <div class="form-row">
                                    <div class="col-md-5 col-12 subject">
                                        <select class="form-control subject" name="course_name">
                                            <option selected="" disabled="">Select Course...</option>
                                           <?php

                                        $tbl_per = "SELECT * FROM category ORDER BY id";
                                        $query1 = mysqli_query($conn,$tbl_per);
                                       // echo die($query);
                                    ...
                                    <div class="col-md-7 col-12 keywords">
                                        <input class="form-control float-left" type="text" placeholder="Search keywords" name="keywords" />
                                        <button type="submit" name="butsearch" class="btn btn-theme"><i class="fas fa-search"></i></button>
                                    </div> 
                                </div>                     
                            </form><!--//course-finder-form-->
                            <a class="read-more" href="courseslist.php">View all our courses<i class="fas fa-chevron-right"></i></a>
                        </div><!--//section-content-->
                    </section><!--//course-finder-->
                    <section class="video shadow-blur">
...
<?php 
                                        $sql5 = "SELECT DISTINCT link FROM link ORDER BY id DESC LIMIT 5";
                                        $query1 = mysqli_query($conn,$sql5);
...
echo'
                                    ...
                                    <div class="carousel-item item">
                                        <div class="embed-responsive embed-responsive-16by9 mb-2">        
                                            <iframe src="https://giphy.com/embed/3oEjI6SIIHBdRxXI40" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="#">via GIPHY</a></p>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-3 col-12">
                    <section class="links shadow-blur">
                        <h1 class="section-heading text-highlight"><span class="line">Popular Courses</span></h1>
                        <div class="section-content">
                            <?php 
                                        $sql3 = "SELECT * FROM category ORDER BY id DESC LIMIT 10";
                                        $query1 = mysqli_query($conn,$sql3);
                                        
                                        if($query1->num_rows > 0)
                                        {
                                            while($res3 = mysqli_fetch_array($query1)){
                            echo'<p><a href="colleges-list.php?name='.$res3['category_name'].'&nav_id='.$res3['category_id'].'&type=Courses"><i class="fas fa-caret-right"></i>'.$res3['category_name'].'</a></p>';
                            
                        } }?>
                        </div>
                    </section><!--//links-->
                    
                    <section class="testimonials shadow-blur">
                        <h1 class="section-heading text-highlight"><span class="line">Trending Videos</span></h1>
                        <div class="carousel-controls">
                        ...
                        <div class="section-content">
                            <div id="testimonials-carousel" class="testimonials-carousel carousel slide">
                                <div class="carousel-inner">
                                    ...
                                    <?php 
                                        $sql5 = "SELECT DISTINCT link FROM link ORDER BY id ASC LIMIT 5";
                                        $query1 = mysqli_query($conn,$sql5);
                    ...
                    <section class="links shadow-blur">
                        <h1 class="section-heading text-highlight"><span class="line">Latest Scholarships Updates</span></h1>
                        <div class="section-content">
                        	<marquee width="100%" direction="up" height="150px" scrollamount="4" onmouseover="this.stop();" onmouseout="this.start();">


                                <?php 
                                        $sql4 = "SELECT * FROM scholarship ORDER BY id DESC";
                                        $query1 = mysqli_query($conn,$sql4);
                                        
                                        if($query1->num_rows > 0)
                                        {
                                            while($res4 = mysqli_fetch_array($query1)){

                           echo' <p><a href="apply_scholarship.php?s_id='.$res4['s_id'].'"><i class="fas fa-caret-right"></i>'.$res4['s_name'].'</a></p>';
    ...
    <div class="content container shadow-blur" style="margin-bottom: 10px;padding: 25px;">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title float-left">Top Colleges <small></small></h1>
                    
                </header> 
                <div class="page-content">    
                    <div class="page-row">
                        <p>Finding the right college is tough. There are so many options and deciding where to spend four years of your life can be tough.And then you have to work out what degree you want - or if a traditional university is right for you at all! Tagore Educons makes it easy by hand picking only colleges that suit an individual student, their values and interests. Say goodbye to wondering which campus culture fits who YOU are because we do the work for you.
                            </p>    
                    ...
                    <div class="row page-row">
                        ...
                        <?php 
                                        $sql2 = "SELECT * FROM college WHERE show_clg = 1 ORDER BY id DESC LIMIT 20";
                                        $query1 = mysqli_query($conn,$sql2);
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a style="background-size: cover;" href="colleges-single.php?clg_id=<?php echo($res2['college_id'])?>"><img class="img-fluid" src="admin/<?php echo($res2['college_img'])?>" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="colleges-single.php?clg_id=<?php echo($res2['college_id'])?>"><?php echo($res2['college_name'])?></a></small></h4>
                                    <p><?php echo($res2['college_city'])?>, <?php echo($res2['college_state'])?></p>
                                   <div class="text-left">
                                        <h4><?php echo($res2['vid_title'])?></h4>
                                        <a href="<?php echo($res2['vid_link'])?>"><?php echo($res2['vid_title'])?></a>
                                   </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-3.jpg" alt="" /></a>
                                <div class="desc">
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-4.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-5.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-6.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-7.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-8.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-9.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-10.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-11.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
                        ...
                        <div class="col-md-4 col-12 text-center">
                            <div class="album-cover">
                                <a href="gallery-album.php"><img class="img-fluid" src="assets/images/gallery/gallery-thumb-12.jpg" alt="" /></a>
                                <div class="desc">
                                    <h4><small><a href="#">Album Suspendisse</a></small></h4>
                                    <p>Suspendisse at purus ac neque auctor viverra vel in arcu. Quisque commodo augue nisi, ut ultrices odio suscipit et. Quisque interdum massa sem</p>
                                </div>
...
<!-- Mirrored from themes.3rdwavemedia.com/college-green/bs4/4.1.1/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Feb 2022 17:52:57 GMT -->
</html> 
