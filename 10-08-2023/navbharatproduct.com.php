...
<head>
    ...
    <title>Navbharat Product | incense sticks Row Material, incense sticks Manufacturing, Machine's Modification & Service, incense sticks Supplier</title>
    <style type="text/css">
...
<body data-bs-spy="scroll" data-bs-target="#site-navbar">
	...
	<header class="site-header" id="site-header" >
		<nav class="navbar navbar-expand-xl" id="site-navbar">
		  <div class="container">
		    <a class="navbar-brand" href="index.html"><img class="img-fluid" src="image/Navbharat Product.png" alt="Navbharat Product"></a>
			...
			<div class="hero-content d-flex justify-content-center">
				<div class="row d-flex align-items-center justify-content-center">
					...
					<div class="col-xl-6 order-xl-first content-block">
						<h1 class="hero-head"><small>Welcome to</small><span style="color:#1a75bc;">Navbharat <strong>Product</strong></h1>
						<p>
							Incense Sticks Row Material, Incense Sticks Manufacturing, Machine's Modification & Service and Incense Sticks Supplier.
						</p>
						<div class="link-group">
							<a class="btn-main" href="#contact-section">Contact Us</a>
	...
	<section class="about-section section-block" id="about-section" data-aos="fade-up">
		<div class="container">
			<div class="row">
				<div class="col-xl-5 image-block" data-aos="fade-right" data-aos-delay="200" data-aos-duration="2000">
				...
				<div class="col-xl-7 content-block" data-aos="fade-right" data-aos-delay="400" data-aos-duration="2000">
					<h2><span>About Us</span>Navbharat Product</h2>
					<p style="text-align:;" class="about-nav">
						A Navbharat Product We have established a solid reputation as a manufacturer of incense sticks <b>since 2017.</b> Our incense sticks manufacturing product line includes variety of <b>incense sticks row materials, incense sticks manufacturering, machine's modification & service and incense sticks supplier.</b> We are a leading incense sticks manufacture and provide incense sticks made from the highest quality raw materials, high-grade sticks and high quality incense stick's powder to leave a lasting impression. These materials are obtained from certified vendors in the market who have a long history of producing high-quality products.
					</p>
					
					<br/>
					<!-- <a class="btn-main" href="#">Contact Now</a> -->
				</div>
			</div> <!-- .row -->
		</div> <!-- .container -->
		<div class="design-elements">
			...
			<div class="row">
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<img src="image/portfolio/portfolio-item-02.jpg" width="100%" alt="portfolio image">
						<br/><br/>
						<h3>Incense Sticks Row Material</h3><br/>
						<!-- <a class="btn-main" href="#">Contact Now</a> -->
					</div>
				</div>
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<img src="image/portfolio/portfolio-item-01.jpg" width="100%" alt="portfolio image">
						<br/><br/>
						<h3>Incense Sticks Manufacturing </h3><br/>
						<!-- <a class="btn-main" href="#">Contact Now</a> -->
					</div>
				</div>
				...
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<img src="image/portfolio/portfolio-item-03.jpg" width="100%" alt="portfolio image">
						<br/><br/>
						<h3>Machine's Modification & Service</h3><br/>
						<!-- <a class="btn-main" href="#">Contact Now</a> -->
					</div>
				</div>
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<img src="image/portfolio/gallery-8.jpg" width="100%" alt="portfolio image">
						<br/><br/>
						<h3>Incense Sticks Supplier</h3><br/>
						<!-- <a class="btn-main" href="#">Contact Now</a> -->
					</div>
				</div>
	...
	<section class="portfolio-section section-block" id="portfolio-section">
		<div class="container">
			...
			<div class="button-group filter-button-group">
				...
				<button class="active" data-filter=".work">WorkShop</button>
				<button class="" data-filter=".gallery">Gallery</button>
				
			</div>
			<div class="row grid" data-aos="fade-up" data-aos-duration="2000">
				<div class="col-lg-3 col-md-6 grid-item work ">
					<div class="box">
			            <img src="image/portfolio/work-1.jpg" alt="portfolio image">
				...
				<div class="col-lg-3 col-md-6 grid-item work ">
					<div class="box">
			            <img src="image/portfolio/work-2.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">WorkShop</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal7"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal7" tabindex="-1" aria-labelledby="portfolioModal7" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
				...
				<div class="col-lg-3 col-md-6 grid-item work ">
					<div class="box">
			            <img src="image/portfolio/work-3.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">WorkShop</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal8"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal8" tabindex="-1" aria-labelledby="portfolioModal8" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
				...
				<div class="col-lg-3 col-md-6 grid-item gallery">
					<div class="box">
			            <img src="image/portfolio/gallery-1.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">Gallery</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal9"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal9" tabindex="-1" aria-labelledby="portfolioModal9" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
				...
				<div class="col-lg-3 col-md-6 grid-item gallery">
					<div class="box">
			            <img src="image/portfolio/gallery-2.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">Gallery</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal10"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal10" tabindex="-1" aria-labelledby="portfolioModal10" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
				...
				<div class="col-lg-3 col-md-6 grid-item gallery">
					<div class="box">
			            <img src="image/portfolio/gallery-3.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">Gallery</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal11"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal11" tabindex="-1" aria-labelledby="portfolioModal11" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
				...
				<div class="col-lg-3 col-md-6 grid-item gallery">
					<div class="box">
			            <img src="image/portfolio/gallery-4.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">Gallery</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal12"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal12" tabindex="-1" aria-labelledby="portfolioModal12" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
				...
				<div class="col-lg-3 col-md-6 grid-item gallery">
					<div class="box">
			            <img src="image/portfolio/gallery-5.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">Gallery</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal13"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal13" tabindex="-1" aria-labelledby="portfolioModal13" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
				...
				<div class="col-lg-3 col-md-6 grid-item gallery">
					<div class="box">
			            <img src="image/portfolio/gallery-7.jpg" alt="portfolio image">
			            <div class="box-content">
			            		<span class="category">Gallery</span>
			                <h3 class="title"></h3>
			            </div>
			            <div class="icon-box"><a href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal15"><i class="bi bi-plus-lg"></i></a></div>

			            <!-- Modal -->
						<div class="modal fade" id="portfolioModal15" tabindex="-1" aria-labelledby="portfolioModal15" aria-hidden="true">
						  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
						    <div class="modal-content">
			...
			<div class="row">
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<!-- <img src="image/Sandip Patel.jpg" width="100%" alt="portfolio image"> -->
						<!-- <br/><br/> -->
						<h3 style="font-size:30px;">Sandip Patel </h3>
				...
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<!-- <img src="image/AkashKumar Patel.jpg" width="100%" alt="portfolio image"> -->
						<!-- <br/><br/> -->
						<h3 style="font-size:30px;">Saurabh Patel</h3>
						<p>( Managing Director )</p>
				...
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<!-- <img src="image/AkashKumar Patel.jpg" width="100%" alt="portfolio image"> -->
						<!-- <br/><br/> -->
						<h3 style="font-size:30px;">Kushal Patel</h3>
						<p>( Production Head )</p>
					...
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<!-- <img src="image/AkashKumar Patel.jpg" width="100%" alt="portfolio image"> -->
						<!-- <br/><br/> -->
						<h3 style="font-size:30px;">Tirth Patel</h3>
				...
				<div class="col-xl-3 col-lg-6" data-aos="fade-up">
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<!-- <img src="image/AkashKumar Patel.jpg" width="100%" alt="portfolio image"> -->
						<!-- <br/><br/> -->
						<h3 style="font-size:30px;">Mitkumar Patel</h3>
						<p>( Sales Executive )</p>
					...
					<div class="content-wrapper service-tilt" data-tilt data-tilt-max="15">
						...
						<!-- <img src="image/AkashKumar Patel.jpg" width="100%" alt="portfolio image"> -->
						<!-- <br/><br/> -->
						<h3 style="font-size:30px;">AkashKumar Patel</h3>
	...
	<section class="contact-section section-block" id="contact-section">
		<div class="container">
			...
			<div class="row contact-options">
				<div class="col-lg-5 d-flex justify-content-xxl-center align-items-xl-center" data-aos="fade-down" data-aos-duration="1000">
					<div class="icon-box"><i class="pe-7s-map-marker"></i></div>
					<div class="content-wrapper">
						<h4>Address</h4>
						<address>98-99, Virat Complex, Kukarwada Road,<br/> B/H. Gurukrupa Dalbati, Ubkhal,<br/> Mehsana, Gujarat-382830</address>
					</div>
				</div>
				<div class="col-lg-3 d-flex justify-content-xxl-center align-items-xl-center" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="200">
					<div class="icon-box"><i class="pe-7s-call"></i></div>
					<div class="content-wrapper">
						<h4>Phone</h4>
						<a href="#">+91 70431 75035 <br/>+91 99984 06744
</a>
					</div>
				</div>
				<div class="col-lg-4 d-flex justify-content-xxl-center align-items-xl-center" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="400">
					...
					<div class="content-wrapper">
						<h4>Email</h4>
						<a href="#">info@navbhartproduct.com</a>
					</div>
				</div>
			</div> <!-- .row -->

			<div class="row">
				<div class="col-lg-2" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="600">
					<div class="" id="mapwrapper">
	
					</div>
				</div>
				<div class="col-lg-9 form-block" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="1100">
					<h3>Write me a message</h3>
					<div class="form-message">
						<p></p>
					</div>
					<form class="row g-3" id="fungi-contact" method="POST" action="">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="input-group mb-3">
								<label for="inputName" class="form-label visually-hidden">Phone</label>
		   						<input type="text" class="form-control" id="inputName" placeholder="Phone*" name="inputName" required>
	   						</div>
	   					</div>
	   					<div class="col-md-6">
							<div class="input-group mb-3">
								<label for="inputName" class="form-label visually-hidden">Subject</label>
		   						<input type="text" class="form-control" id="inputName" placeholder="Subject*" name="inputName" required>
	   						</div>
	   					</div>
						<div class="col-md-12">
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-lg-6 text-center branding-block">
					<a class="footer-brand" href="#"><img src="image/Navbharat Product.png" alt="Pori logo"></a>
					<p>
			...
			<div class="row footer-bottom">
				<div class="col-md-6">
					<p>All rights reserved &copy; 2017 <strong>Navbharat Product.</strong></p>
				</div>
				<div class="col-md-6">
...
<script src="js/script.js"></script>
 ...
 <style type="text/css">
    ...
    .shareiconcode a {
        ...
        box-shadow: 0px 0px 30px 5px #7d78787d;
        border-radius: 50%;
        background: #fff;
    }
    .shareiconcode img {
...
<div class="wtspwrapper shareiconcode">
    <a href="https://api.whatsapp.com/send?phone=+91 7043175035&text=Hi,%20I%20have%20an%20inquiry" target="new">
        <!-- <em class="ion ion-social-whatsapp-outline" aria-hidden="true"></em> -->
