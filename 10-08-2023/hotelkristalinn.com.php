...
<head>
   ...
   <title>Best Hotel In Bareilly| Hotel KristalInn</title>
   ...
   <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-QVBGPCKX4S">
        </script>
        <script>
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="box swiper-slide">
            <img src="images/IMG_9405.jpg" alt="">
            <div class="flex">
               <h3>Deluxe rooms</h3>
         ...
         <div class="box swiper-slide">
            <img src="images/IMG_9418.jpg" alt="">
            <div class="flex">
...
<section class="about" id="about">
   ...
   <div class="row">
      <div class="image">
         <img src="images/IMG_9442.jpg" alt="">
      </div>
      <div class="content">
         <h3>About US</h3>
         <p>Hotel Kristal Inn in Bareilly, the original Basecamp hotel, is built for exploring the incredible Food and comfortable Room in Bareilly. Our accommodations are located in the Satellite Bus Station, Pilibhit Bye Pass Road 900 MTR Distance From Satelite Bus Station. </p>
         <p> Our 15 stylish rooms are designed for adventure and relaxation seekers alike, with the amenities and style of a modern resort, but at more affordable Hotel (or inn-like) prices. Come stay with us and let our Hotel Kristal Inn be the springboard for your Bareilly adventure.</p>
         <a href="#reservation" class="btn">make a reservation</a>
      </div>
   </div>
   ...
   <div class="row revers">
      <div class="image">
         <img src="images/IMG_9429.jpg" alt="">
         <img src="images/IMG_9435.jpg" alt="">
      </div>
      <div class="content">
         <h3>best foods</h3>
         <p>Kristalinn is a Indian restaurant, famous for its hot gooey cheese bread khachapuri, juicy and flavorful dumplings khinkali, mouth-watering grilled meats and, of course, unique luscious Indian wines.</p>
...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>food & drinks</h3>
         <p>Kristalinn is a Indian restaurant, famous for its hot gooey cheese bread khachapuri.</p>
      </div>
      ...
      <div class="box">
         ...
         <h3>decorations</h3>
         <p>Hotel Kristal Inn in Bareilly, the original Basecamp hotel.</p>
      </div>
...
<section class="gallery" id="gallery">
   ...
   <div class="swiper gallery-slider">
      <div class="swiper-wrapper">
         <img src="images/IMG_9407.jpg" class="swiper-slide" alt="">
         <img src="images/IMG_9419.jpg" class="swiper-slide" alt="">
         <img src="images/IMG_9424.jpg" class="swiper-slide" alt="">
         <img src="images/IMG_9444.jpg" class="swiper-slide" alt="">
         <img src="images/IMG_9436.jpg" class="swiper-slide" alt="">
         <img src="images/IMG_9447.jpg" class="swiper-slide" alt="">
      </div>
   ...
   <div class="row">
      ...
      <div class="faq">
         ...
         <div class="box active">
            <h3>how to cancel?</h3>
            <p>You can cancel your booking easily. 100% Refundable after booking</p>
         </div>
         <div class="box">
            <h3>is there any vacancy?</h3>
            <p>Currently is not available the vacancy. If any vacancy is empty we will inform you on the Hotel website.</p>
         </div>
         <div class="box">
            <h3>what are payment methods?</h3>
            <p>There is a Razorpay payment method available. You can successfully pay your payment.</p>
         </div>
         <div class="box">
            <h3>how to claim coupons codes?</h3>
            <p>Currently is not available any Coupon options.</p>
         </div>
      </div>
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide box">
            ...
            <h3>Swati</h3>
            <p>We travelled with two six year olds and lots of luggage and despite the stairs up to the elevator this was one of the nicest places we stayed in the four weeks.</p>
         </div>
      </div>
