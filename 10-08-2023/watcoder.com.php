...
<head>
    <meta charset="utf-8">
    <title>Watcoder - Top Software Company - Website Development, Application Development, Graphic Designing, Digital Marketing | Top Software Company in Bareilly</title>
    <meta name="description" content="Unlock your digital potential with WatCoder - a leading provider of comprehensive services in website development, app development, digital marketing, graphic design, and more. Our expert team delivers tailored solutions to help businesses thrive in the online landscape. Partner with us and experience the power of innovative technology, creative designs, and effective strategies. Explore our services today and embark on a digital transformation journey with WatCoder.">
    <meta name="keywords" content="website development, app development, digital marketing, graphic design, software services, business planning, financial analysis, legal advisory, market analysis, strategic planning, cybersecurity, UI/UX design, full-stack development, backend development, frontend development, digital transformation, technology solutions, industry-leading services.">
    ...
    <link rel="icon" type="image/png" sizes="60x60" href="favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="25x25" href="favicon/favicon-16x16.png">
...
<div>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h1 class="text-white text-uppercase">Full-Stack Development Cources</h1>
                        <h3 class="display-1 text-white mb-md-4">We Provide best Solution On Your Full-Stack Development Cources</h3>
                        <a href="service.php#bookservice" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Book Services</a>
            ...
            <div class="swiper-slide">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase">Website Development</h5>
                        <h1 class="display-1 text-white mb-md-4"> If you have need any Website you can Reach us</h1>
                        <a href="service.php#bookservice" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Book Services</a>
                        <a href="contact.php" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Contact Us</a>
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase">Application Development</h5>
                        <h1 class="display-1 text-white mb-md-4"> If you have need any Appliction to grow your, business you can Reach us</h1>
                        <a href="service.php#bookservice" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Book Services</a>
                        <a href="contact.php" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Contact Us</a>
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase">Graphic designe</h5>
                        <h1 class="display-1 text-white mb-md-4"> If you have need any Graphic designe to grow your business, you can Reach us</h1>
                        <a href="service.php#bookservice" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Book Services</a>
                        <a href="contact.php" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Contact Us</a>
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px;">
                        <h5 class="text-white text-uppercase">Digital Marketing</h5>
                        <h1 class="display-1 text-white mb-md-4"> If you have need any Digital Marketing to grow your business, you can Reach us</h1>
                        <a href="service.php#bookservice" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Book Services</a>
                        <a href="contact.php" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Contact Us</a>
                    </div>
                </div>
    ...
    <!-- <div class="container-fluid p-0">
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner" style="max-hight: 400px;">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="text-white text-uppercase">Full-Stack Development Cources</h1>
                            <h3 class="display-1 text-white mb-md-4">We Provide best Solution On Your Full-Stack Development Cources</h3>
                            <a href="quote.php" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Book Services</a>
                            <a href="contact.php" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Contact Us</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-secondary p-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <h1 class="display-5 mb-4">Welcome To <span class="text-primary">WatCoder</span></h1>
                <h4 class="text-primary mb-4">If you are seeking a reliable partner for website development, app development, digital marketing, or graphic design, WatCoder is here to transform your vision into reality.</h4>
                <p class="mb-4">WatCoder is a leading software service provider operating in the dynamic field of website development, app development, digital marketing, and graphic design. As a technology-driven company, we specialize in delivering high-quality solutions to meet the diverse needs of our clients. Our team of skilled professionals at WatCoder is passionate about crafting exceptional websites that combine aesthetics with functionality. We excel in creating responsive, user-friendly websites that leave a lasting impression on visitors and drive meaningful engagement. <br><br> In the realm of app development, we leverage our expertise to design and develop innovative mobile applications across various platforms. We strive to create seamless user experiences and harness the power of mobile technology to help businesses reach their target audience effectively.</p>
                ...
                <div class="h-100 d-flex flex-column justify-content-center bg-primary p-5">
                    <div class="d-flex text-white mb-5">
                        ...
                        <div class="ps-4">
                            ...
                            <p class="mb-0">At WatCoder, we also offer comprehensive Business Planning services to assist entrepreneurs and businesses in strategizing and achieving their goals. Our experienced team of professionals understands the importance of a well-defined business plan in guiding the growth and success of your venture.</p>
                        </div>
                    </div>
                    <div class="d-flex text-white mb-5">
                        <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-white text-primary rounded-circle mx-auto mb-4" style="width: 60px; height: 60px;">
                        ...
                        <div class="ps-4">
                            ...
                            <p class="mb-0">At WatCoder, we provide comprehensive Financial Analysis services to help businesses gain a deeper understanding of their financial health, make informed decisions, and drive sustainable growth.</p>
                        </div>
                    </div>
                    <div class="d-flex text-white">
                        ...
                        <div class="ps-4">
                            ...
                            <p class="mb-0">At WatCoder, we offer comprehensive Legal Advisory services to assist businesses in navigating the complex legal landscape and ensuring compliance with applicable laws and regulations. Our team of experienced legal professionals provides expert guidance and strategic advice to help safeguard your business interests and mitigate legal risks.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">Our research team utilizes a variety of methodologies and data analysis techniques to gather, analyze, and interpret relevant information, providing you with actionable intelligence to drive strategic planning and business growth.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">We offer Strategic Planning services to help businesses develop a clear vision, define their goals, and chart a roadmap for success. Our strategic planning process involves comprehensive analysis, collaboration, and the development of actionable strategies that align with your business objectives.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0"> We provide Market Analysis services to help businesses gain a comprehensive understanding of their target market, industry trends, and competitive landscape. Our market analysis focuses on gathering and analyzing relevant data to provide valuable insights that drive informed decision-making.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0"> We offer Financial Analysis services to help businesses gain insights into their financial performance, make informed decisions, and drive financial success. Our financial analysis focuses on evaluating key financial indicators and providing actionable recommendations.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">We provide Legal Advisory services to assist businesses in navigating legal complexities, ensuring compliance, and mitigating legal risks. Our legal advisory services encompass a range of areas to safeguard your business interests.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">We offer Tax & Insurance services to help businesses effectively manage their tax obligations and mitigate insurance risks. Our services provide guidance and support in navigating complex tax regulations and ensuring adequate insurance coverage.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4">
                <div class="row g-5">
                    <div class="col-12">
                        ...
                        <p class="mb-0">At WatCoder, we strive to be the best in the industry by consistently delivering exceptional services and exceeding client expectations.</p>
                    </div>
                    <div class="col-12">
                        <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                        ...
                        <p class="mb-0">we take pride in our exceptional success rate, which stands at an impressive 99%. This success rate is a testament to our commitment to delivering high-quality services and achieving outstanding results for our clients. </p>
                    </div>
                    <div class="col-12">
                        <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                        ...
                        <h3>Award Winning</h3>
                        <p class="mb-0">we are proud to be an award-winning company, recognized for our excellence in the industry. Our commitment to delivering exceptional services and innovative solutions has been acknowledged by prestigious awards and accolades.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="d-block bg-primary h-100 text-center">
                    ...
                    <div class="p-4">
                        ...
                        There are several reasons to choose WatCoder for your business needs: <br><br>
                        1. Expertise and Experience: We have a team of highly skilled professionals with extensive expertise in various domains, including software development, website development, app development, digital marketing, graphic design, business planning, financial analysis, legal advisory, market analysis, strategic planning, and more. </p>
            ...
            <div class="col-lg-4">
                <div class="row g-5">
                    <div class="col-12">
                        ...
                        <p class="mb-0">Client-Centric Approach: We place our clients at the center of everything we do. We take the time to understand their unique needs, goals, and challenges.</p>
                    </div>
                    <div class="col-12">
                        <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                        ...
                        <p class="mb-0">We take pride in being professional advisors to our clients. As trusted advisors, we provide valuable guidance, expertise, and strategic insights to help our clients make informed decisions and achieve their business goals.</p>
                    </div>
                    <div class="col-12">
                        <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                        ...
                        <p class="mb-0">We prioritize excellent customer service, which is why we offer 24/7 customer support. We understand that our clients may have questions, concerns, or urgent needs that require immediate attention, regardless of the time of day.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid bg-secondary px-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <h1 class="display-5 mb-4">Book Your Services</h1>
                <p class="mb-4">Thank you for your interest in booking our services at WatCoder. We appreciate the opportunity to assist you with your business needs. Browse through the various services we offer, including website development, app development, digital marketing, graphic design, business planning, financial analysis, legal advisory, tax and insurance, business research, strategic planning, market analysis, and more.</p>
                <form>
                    <div class="row gx-3">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="form-floating-2" placeholder="+91 99999 99999">
                                <label for="form-floating-2">Enter Your Number</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-floating mb-3">
                        ...
                        <div class="col-6">
                            <button class="btn btn-primary w-100 h-100" type="submit">Book service</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="container-fluid py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 mb-0">Meet Our Founder</h1>
            <hr class="w-25 mx-auto bg-primary">
        </div>
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="team-item position-relative overflow-hidden">
                    <img class="img-fluid w-100" src="img/nilesh-4.jpg" alt="Nilesh Gangwar">
                    <div class="team-text w-100 position-absolute top-50 text-center bg-primary p-4">
                        <h3 class="text-white">NILESH GANGWAR</h3>
                        <p class="text-white text-uppercase mb-0">FOUNDER & CEO</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 px-5">
                <h1 class="display-5 mb-4">About the <span class="text-primary"> Nilesh Gangwar</span></h1>
                <p class="mb-4">Nilesh Gangwar is the visionary Founder and CEO of WatCoder, a leading software industry company. With a passion for technology and a strong entrepreneurial drive, Nilesh has successfully established WatCoder as a trusted service provider in website development, app development, digital marketing, graphic design, and more. <br><br> As the Founder, Nilesh's leadership and strategic direction have been instrumental in shaping the company's growth and success. With a deep understanding of the industry, market trends, and client needs, he has guided WatCoder to deliver innovative solutions that help businesses thrive in the digital landscape. <br><br>Nilesh's commitment to excellence is reflected in WatCoder's reputation for delivering high-quality services tailored to each client's unique requirements. Under his leadership, WatCoder has built a talented team of professionals who share his dedication to customer satisfaction and strive to exceed client expectations.</p>
                <h4 class="text-primary mb-4">If you have any further questions or require additional information, please feel free to ask.</h4>
                <a href="service.php" class="btn btn-primary py-md-3 px-md-5 rounded-pill">Book Your Service</a>
            </div>
        </div>
    </div>
    <!-- Team End -->
    ...
    <!-- Testimonial Start -->
    <div class="container-fluid bg-secondary p-0 mt-3 mb-4">
        <div class="row g-0">
            ...
            <div class="col-lg-6 py-6 px-5">
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item">
                        <p class="fs-4 fw-normal mb-4"><i class="fa fa-quote-left text-primary me-3"></i>I am thrilled to share my experience working with WatCoder. As a business owner in need of digital solutions, I was searching for a reliable and competent service provider, and WatCoder exceeded my expectations in every way.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="img/clints-2.png" alt="">
                            <div class="ps-4">
                                <h3>Vivek Maurya</h3>
                    ...
                    <div class="testimonial-item">
                        <p class="fs-4 fw-normal mb-4"><i class="fa fa-quote-left text-primary me-3"></i>From the very first interaction, the team at WatCoder showcased their professionalism, expertise, and commitment to delivering exceptional results. They took the time to understand my unique business needs and goals, providing tailored solutions that perfectly aligned with my vision.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="img/clints.png" alt="">
                            <div class="ps-4">
                                <h3>Amit Kumar</h3>
                                <span class="text-uppercase">Sells man</span>
                            </div>
                        </div>
                    </div>
                </div>
