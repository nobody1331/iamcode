...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v16.0" nonce="rzUYOkgy"></script>
<body>
    <!-- Preloader -->
    ...
    <aside class="kenburns-section" id="kenburnsSliderContainer" data-overlay-dark="6">
                ...
                <div class="container">
                    <div class="row h-100">
                            <div class="col-md-12 text-center">
                                <h6>DRINK - DINE - DANCE</h6>
                                <h1>Mystery of Bar<span>Restaurant & Bar</span></h1>
                                <p>sco - 6&7 ground floor, adjacent to bikanervala, <br>Sector 29, Gurugram, Haryana 122001</p>
                                <a href="menu.php" class="button-1 mt-15">Check Our Menu<span></span></a>
                            </div>
                        </div>
                </div>
            </div>
        ...
        <div class="reservation">
            <a href="tel:8551004444">
                ...
                <div class="call"><span>+91 91077 05555</span>
                    <br>Reservation
                </div>
            </a>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-30">
                    <div class="section-head mb-20">
                        <div class="section-subtitle">Mystery of Bar</div>
                        <div class="section-title">Few Words About Us</div>
                    </div>
                    <p>Welcome to Mystery of Bar in Gurgaon, Delhi NCR, Haryana! We offer a range of services to make your evening special. Whether you're looking for a home delivery, a takeaway option, a full bar, indoor seating, family-friendly dining, indulgent desserts and bakes, or live music, we've got you covered. Enjoy a delicious meal in our inviting atmosphere for just ₹1,700 for two people (approx.) without alcohol. Our menu includes a variety of dishes, from classic pub grub to classic Indian cuisine. So come join us for dinner and drinks and let us take care of the rest. We look forward to having you at Mystery of Bar!</p>
                    <!-- reservation -->
                    <div class="reservations">
                        <div class="icon"><span class="flaticon-tray-1"></span></div>
                        <div class="text">
                            <p>Reservation</p> <a href="tel:+91 91077 05555">+91 91077 05555</a>
                        </div>
                    </div>
                </div>
                <div class="col col-md-3"> <img src="new-img/img/13.webp" alt="" class="mt-90 mb-30"> </div>
                <div class="col col-md-3"> <img src="new-img/img/14.webp" alt=""> </div>
            </div>
        </div>
    </section>
    <!-- Chef -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 offset-md-1 mb-30"> 
                    <img src="new-img/img/12.webp" alt="">
                </div>
                <div class="col-md-5 valign mb-30">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-head mb-20">
                                <div class="section-subtitle">20 Year of Experience</div>
                                <div class="section-title white">Big Chef's Menu</div>
                            </div>
                            <p>Our menu is full of delicious and unique foods that you won't find anywhere else. Our specialities include exotic dishes from around the world, including Mexican, Indian, and Italian. We also offer classic burgers, pizzas, steaks, and more.<br>We have an extensive selection of cocktails, beers, and wines to choose from. Our bartenders are always happy to mix up your favorite drinks, or recommend something new. Plus, our live music plays every night from 7pm until late, so you can dance the night away. 
    ...
    <section class="chef-recommends section-padding bg-cream">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-head text-center">
                        ...
                        <div class="section-title">Best Recommends</div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="new-img/MYSTERY MIX.webp" alt=""> </div>
                        ...
                        <div class="con">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <div class="permalink">A Fiery Blend Of Homemade Spicy Syrup With Tequila Served In
                                    Chilli Flake Rimmed Glass</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="new-img/SOYA FRITERS.webp" alt=""> </div>
                        <!-- <span class="category"><a href="#0">$12.00</a></span> -->
                        <div class="con">
                            <div class="icon flaticon-salad"></div>
                            <h6>Food</h6>
                            <h5>MYSTERY SPECIAL SOYA FRITERS</h5>
                            <div class="line"></div>
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <div class="permalink">Yummy & Delecious</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="item">
                        <div class="position-re o-hidden"> <img src="new-img/THE FORBIDDEN FRUIT.webp" alt=""> </div> 
                        <div class="con">
                            <div class="icon flaticon-whisky"></div>
                            <h6>Drink</h6>
                            <h5>MYSTERY OF THE FORBIDDEN FRUIT</h5>
                            <div class="line"></div>
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <div class="permalink">(Frobidden Fruit-Apple Juice Combined Delicately With Cinnamon And Whisky)</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="background bg-img bg-fixed section-padding pb-0" data-background="img/banner5.jpg" data-overlay-dark="6">
        <div class="container">
                <div class="row">
                    <!-- Testimonials -->
                    <div class="col-md-6">
                        ...
                        <div class="testimonials-box">
                            <div class="owl-carousel owl-theme">
                                <div class="item"> <span>
                                    ...
                                    <p>I've been to Mystery of Bar twice now and it's hands down the best bar I've ever been to. The ambience is really cool with great music playing in the background and the drinks are superb. The bartenders are really friendly and knowledgeable and will make sure you get the perfect cocktail. It's not too expensive either, considering what you get in return. Highly recommend this place!</p>
                                    <div class="info">
                                        <div class="author-img"> <img src="new-img/profile.jpeg" alt=""> </div>
                                        <div class="cont">
                                            <h6>Sophia Sharma</h6> <span>Customer</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item"> <span>
                                    ...
                                    <p>Mystery of Bar is the best bar I have ever visited in Gurugram. The atmosphere is warm and inviting, and the staff are incredibly friendly. The drinks are top-notch, and the selection of food is unbeatable. I absolutely recommend Mystery of Bar to anyone looking for an amazing night out in Haryana!</p>
                                    <div class="info">
                                        <div class="author-img"> <img src="new-img/profile.jpeg" alt=""> </div>
                                        <div class="cont">
                                            <h6>Rajesh</h6> <span>Customer review</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="item"> <span>
                                    ...
                                    <p>I've been to Mystery of Bar numerous times and it never disappoints. The bar has an amazing atmosphere that sets the tone for a great night out. The drinks are top-notch, the food is delicious, and the service is always excellent. I would highly recommend Mystery of Bar to anyone looking for a great night out in Gurugram, India! It really is the best bar in town!</p>
                                    <div class="info">
                                        <div class="author-img"> <img src="new-img/profile.jpeg" alt=""> </div>
                                        <div class="cont">
                                            <h6>Kiran</h6> <span>Customer review</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5 offset-md-1">
                        <div class="opening-hours-box">
                                    ...
                                    <div class="info">
                                        <div class="row">
                                            <div class="col col-md-5">
                                                <div class="cont">
                                                    <h6 class="day">Monday to Friday</h6> <span class="time">12:00PM</span>
                                                    <p style="padding: 0;">TO</p> <span class="time">02:00AM</span>
                                                </div>
                                            </div>
                            ...
                            </div> <a href="book-a-table.php" class="button-1 mt-15">Make A Reservation</a>
                            <p><small>You can also call: <a href="tel:+91 91077 05555">+91 91077 05555</a> to make a reservation.</small></p>
                            <p class="mt-0"><a href="#0"><i class="ti-location-pin"></i></a><small>SCO - 6 & 7, Ground Floor, Sector 29, Gurugram, India, Haryana</small></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <!-- <div class="col-md-4">
                    <div class="item"> <span class="icon flaticon-cooking"></span>
                        <div class="cont">
                            <h5>Breakfast</h5>
                            <p>If you're looking for an interesting breakfast spot, Mystery of Bar is the place to go. This enigmatic eatery located in the heart of the city is the perfect spot to start your day.
                ...
                <div class="col-md-6">
                    <div class="item"> <span class="icon flaticon-tray-2"></span>
                        <div class="cont">
                            <h5>Lunch</h5>
                            <p>Mystery of Bar serves tantalizing dishes that are sure to tantalise your taste buds. From their juicy burgers to mouthwatering wraps, there's something for everyone. The atmosphere is vibrant and the service is impeccable. What's more, the prices are incredibly reasonable! Whether you're looking for a quick bite to eat or a leisurely lunch, make sure you visit the Mystery of Bar.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="item"> <span class="icon flaticon-chef-1"></span>
                        <div class="cont">
                            <h5>Dinner</h5>
                            <p>Looking to enjoy a night out at Mystery Bar? Consider their extensive menu of drinks and delicious dinner options. From classic cocktails to craft beers, they have something to please every palate. Their dinner selections include classic pub fare like burgers, sandwiches, and tacos, as well as dishes inspired by global cuisine such as curry and paella. For a special treat, try their selection of specialty drinks made with premium spirits like whiskey, brandy, and vodka</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="first-class-services section-padding">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="square-flip">
                        ...
                        <div class="square2">
                            <div class="square-container2">
                                <h6>Current Menu</h6>
                                <h4>Delicious Menu</h4>
                                <p><i>If you're looking for a night of mystery and intrigue, the Bar of Mystery will have you covered! This unique dining experience offers up a selection of tantalizing dishes that are sure to satisfy even the pickiest of eaters.</i></p>
                                <a href="menu.php" class="button-4 mt-15">View Menu<span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="square-flip">
                        <div class="square bg-img" data-background="new-img/img/11.webp">
                            <div class="square-container d-flex align-items-end justify-content-end">
                                <div class="box-title">
                        ...
                        <div class="square2">
                            <div class="square-container2">
                                <h6>Address of Taste</h6>
                                <h4>Fresh Ingredient Meals</h4>
                                <p><i>Mystery Bar offers delicious and healthy meals made with fresh, locally-sourced ingredients. Enjoy their amazing selection of locally-grown produce, grass-fed meats, freshly-caught seafood and locally-made sauces.</i></p>
                                <a href="menu.php" class="button-4 mt-15">View Menu<span></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="square-flip">
                        ...
                        <div class="square2">
                            <div class="square-container2">
                                <h6>Executive Chefs</h6>
                                <h4>Senior & Talented Chefs</h4>
                                <p><i>Mystery Bar is a prestigious restaurant that features senior and talented chefs who are renowned for their creative and exquisite dishes. Their unique dishes, made with quality ingredients, offer a tantalizing experience that will take your taste buds on a journey.</i></p>
                                <a href="menu.php" class="button-4 mt-15">Our Chefs<span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mb-30 mt-60">
                        ...
                        <div class="reservations mb-10">
                            ...
                            <div class="text">
                                <p class="color-1">Reservation</p> <a class="color-1" href="tel:+91 91077 05555">+91 91077 05555</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="booking-box">
                            ...
                            <div class="booking-inner clearfix">
                                <form class="form1 clearfix" method="POST" action="book-a-table.php">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input1_wrapper">
                                                <label>Phone</label>
                                                <div class="input2_inner">
                                                    <input type="number" class="form-control input" name="mobile" placeholder="Enter Phone Number" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" name="submit" value="submit" class="btn-form1-submit mt-15">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <div class="row">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="clients-logo">
                        <a href="#0"><img style="border-radius: 200px;height: 100px;" src="new-img/brands/1.png" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img style="border-radius: 200px;height: 100px;" src="new-img/brands/2.png" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img style="border-radius: 200px;height: 100px;" src="new-img/brands/3.png" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img style="border-radius: 200px;height: 100px;" src="new-img/brands/5.png" alt=""></a>
                    </div>
                    <div class="clients-logo">
                        <a href="#0"><img style="border-radius: 200px;height: 100px;" src="new-img/brands/6.png" alt=""></a>
                    </div>
                </div>
                </div>
            </div>
...
<!-- Mirrored from duruthemes.com/demo/html/candore/demo2/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Feb 2023 10:27:51 GMT -->
</html>
