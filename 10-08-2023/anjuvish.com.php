...
<head>
  ...
  <title>ANJUVISH</title>
  <meta content="" name="ANJU">
  <meta content="" name="HEALTH,FITNESS,WEIGHT LOSS">


  <link href="img/A.png" rel="icon">
  <link href="img/A1.png" rel="A1">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.php">ANJUVISH</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services" target="_blank">Yoga</a></li>
          <li><a class="nav-link scrollto " href="#counts">Our Team</a></li>
          ...
          <li class="dropdown"><a href="#"><span>All Services</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="portfolio-details.php" target="_blank"><span>Comming Soon</span> <i class="bi bi-chevron-right"></i></a>
                <!--<ul>
                  <li><a href="portfolio-details.php" target="_blank">Comming Soon</a></li>
          ...
          <li><a class="getstarted scrollto" href="signup.html" target="_blank">Join US</a></li>
        </ul>
      ...
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Become a Trainer</h2>
                <p class="animate__animated animate__fadeInUp">Our Team is here to Help You.</p>
                <div>
                  <a href="signup.html" target="_blank" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url(img/slide/slide-2.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Join ANJUVISH Team</h2>
                <p class="animate__animated animate__fadeInUp">Team of Expertise</p>
                <div>
                  <a href="signup.html" target="_blank" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
                </div>
              </div>
          ...
          <div class="carousel-item" style="background-image: url(img/slide/slide-3.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Health is a Wealth</h2>
                <p class="animate__animated animate__fadeInUp">If Health is Good We can handle any Circumstances</p>
                <div>
                  <a href="signup.html" target="_blank" class="btn-get-started animate__animated animate__fadeInUp scrollto">Join Us</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row no-gutters">
		 ...
		 <!-- <iframe width="475px" height="385px" src="https://www.youtube.com/embed/szfVRo2OxdY" title="Technoz" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
        </iframe>-->
        
          <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              <h3>ANJUVISH</h3>
              <p>Our Goal is to Make People Health Conscious</p>
              <div class="row">
                <div class="col-md-6 icon-box">
                  <i class="bx bx-receipt"></i>
                  <h4>Increase LifeSpan</h4>
                  <p>We will Teach how to Increase LifeSpan Naturally</p>
                </div>
                <div class="col-md-6 icon-box">
                  <i class="bx bx-cube-alt"></i>
                  <h4>Loss Weight</h4>
                  <p>Increasing Weight is Serious Problem, Start Lossing Your Weight, Right Now</p>
                </div>
                <div class="col-md-6 icon-box">
                  <i class="bx bx-images"></i>
                  <h4>Boost Up Mental Health</h4>
                ...
                <div class="col-md-6 icon-box">
                  ...
                  <p>Come and Join Us, We Will Help You and Your Loving Onces.
and Help Others</p>
                </div>
              </div>
            </div><!-- End .content-->
...
<!--<iframe width="684" height="385" 
src="https://www.youtube.com/embed/szfVRo2OxdY" 
title="Technoz" frameborder="0" allow="accelerometer; 
autoplay; 
clipboard-write; 
encrypted-media; 
gyroscope; 
...
<div class="elfsight-app-1b155db0-76e2-4307-b475-6776dd3b37ec"></div>
...
<!-- Whatsaap -->
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Our Happy Memeber's</strong> Become Healthy and Fitness Conscious</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Joined AnjuVish</strong> Stay Motivated</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Member's at Your Support</strong> 24X7</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Trainers - </strong> Learn, Track, Measure and bring to daily Routine</p>
            </div>
          </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Change your Life and Make a Story </p>
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><i class="bi bi-briefcase"></i></div>
            <h4 class="title"><a href="">Health or Wealth, Which one is Important to You?</a></h4>
            
          </div>
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><i class="bi bi-card-checklist"></i></div>
            <h4 class="title"><a href="">Loss Your Weight Naturally Without any Medication</a></h4>
                      </div>
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><i class="bi bi-bar-chart"></i></div>
            <h4 class="title"><a href="">Boost Your Mental Health</a></h4>

          </div>
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><i class="bi bi-binoculars"></i></div>
            <h4 class="title"><a href="">Control Your BMI</a></h4>

          </div>
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><i class="bi bi-brightness-high"></i></div>
            <h4 class="title"><a href="">Glow Your Skin Naturaly, Zero Side Effects	</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><i class="bi bi-calendar4-week"></i></div>
            <h4 class="title"><a href="">Lower the Risk of Heart Attack</a></h4>
          </div>
        </div>
    ...
    <section id="why-us" class="why-us">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Why Us?</h2>
          <p>We are here to support you with only any Expectation, that we Help you, and you Help Others </p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box">
              <span>Lower Risk of Heat Attack, Control Diabetes </span>
              <h4>know How we Do That?</h4>
              <p>Join Us, and we will let you Know how can you do that</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              ...
              <h4>Loss your Weight and Control your BMI </h4>
              <p>Start Lossing Weight from Third day of Joining</p>
            </div>
          </div>

          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              <span>Boost Mental Health</span>
              <h4>Does It Matter?</h4>
              <p>Mental health awareness is something that can help the millions of people who are impacted by mental health issues throughout
the Nation. Its Emotionally, Physicaly, Ecomically lower's the your Mental Health and You Feel Stressed  </p>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Weight Loss</li>
              <li data-filter=".filter-card">Brain Booster</li>
              <li data-filter=".filter-web">Daily Nutrition</li>
            </ul>
          </div>
        </div>
...
<?php 
                    ...
                    $select ="select * from tbl_product order by product_id desc limit 6";
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="admin/prod_pic/<?php echo substr($row['pic'], 0,200) ;?>" style="height:415px; width:100%;" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><?php echo substr($row['title'], 0,100) ;?></h4>
                <p><?php echo substr($row['category'], 0,100) ;?></p>
                <div class="portfolio-links">
                  <a href="admin/prod_pic/<?php echo substr($row['pic'], 0,200) ;?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.php?id=<?php echo $row['product_id'];?>" target="_blank" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container">
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">My age is 35 and Weight is 135 Kg How can i Loss My weight<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
        Yes, But it is Challanging to you, We will help you out and you will start lossing your Weight. Your BMI will Become Normal We are there to Help                 </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">I am a Heart Paitent, I have an surgery also i fell very Low<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                <p>
                  You need to boost your physical Health Contact us we will provide you proper training Programme                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">My age is 42 and I am Suffering From 
Blood Sugur how it will Help Me<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                <p>
                  Yes, It will help you it will Controll your Blood Sugur after that you don't need to have a medicine to control it        </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">I am 31 years Old and I am Healthy
do i also need to join your Programm <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                <p>
                  Yes, Sure you need to Join our Programm. you Feel that you are Healthy but to be Healthy and Fit for the lifetime and Increase LifeSpan you Should join our Programm and become Consious.   </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="400">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">My Weight is 95 kg and age is 26 I feel very Depressed <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                <p> I can Understand that overweight is very big problem, But by joining our Programm you will Start reducing your weight and weight will be according to your BMI
ans.                </p>
              </div>
            </li>
...
<!-- End Frequently Asked Questions Section -->
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>House No. 779 SS II Sector D-1 L.D.A. Colony Kanpur Road Lucknow- 226012</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+91 9935201574"> +91 9935201574</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="info@anjuvish.com">info@anjuvish.com</a></p>
            </div>
          </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>ANJUVISH</h3>
              <p>House No. 779 SS II Sector D-1 L.D.A. Colony Kanpur Road Lucknow- 226012<br>
                <br><br>
                <strong>Mobile:</strong> +91 9935201574<br>
		    <strong>Phone:</strong> 0522- 4324377<br>

                <strong>Email:</strong> info@anjuvish.com<br>
              </p>
              <div class="social-links mt-3">
                <a href="https://twitter.com/@anjuvish15" target="_blank" class="twitter"><i class="bx bxl-twitter"></i></a>
                <a href="https://www.facebook.com/Anjuvish1984" target="_blank" class="facebook"><i class="bx bxl-facebook"></i></a>
                <a href="https://www.instagram.com/anjuvishwakarma09" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
                <a href="https://join.skype.com/invite/wzpl1ES8eNtT" target="_blank" class="google-plus"><i class="bx bxl-skype"></i></a>
                <a href="https://www.linkedin.com/in/anju-vish-214b65244/" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Yoga</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
             <!-- <li><i class="bx bx-chevron-right"></i> <a href="portfolio-details.html" target=_blank">Comming Soon</a></li>-->
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Our Newsletter</h4>
            <p>Join Us for getting latest update</p>
    ...
    <div class="container">
      <div class="copyright">
        Copyright &copy; 2022 <strong><span>ANJUVISH</span></strong>. All Rights Reserved
      </div>
     <!-- <div class="credits">
