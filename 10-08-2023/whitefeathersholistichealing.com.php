...
//$dbname = "gujarqtk_wfhh";


$username = "dewloabo_white";
$password = "white123@@@";
$dbname = "dewloabo_whitewp";
...
<html>
	...
	<title>Crystal Healing - Best Academy and Courses Healing Crystal, Angel Therapy, Aroma Therapy, Animal Healing, Reiki in Ahmedabad, India - Sonal Bhola</title>
	<meta content="width=device-width; initial-scale=1.0; maximum-scale=1.0;   user-scalable=0;" name="viewport">
	<meta name="description" content="Best Academy and courses for Healing Crystal,Crystal Reiki, Reiki, Crystal Healing, Angel therapy, Animal Healing at most lowest price by Holistic Healer Sonal Bhola at White Feathers Holistic Healing. Best quality of Crystals, Reiki master, Fenshui, Animal Therapy, Angel Therapy, Aroma Therapy's courses and products available in Ahmedabad, Gujarat, India." />
	<meta name="keywords" content="Holistic healing, angel healing, Animal Healing, Reiki, Crystal Healing, Sonal Bhola, Crystals, WFHH" />
	<meta name="author" content="white feather holistic healing" />

  	<!-- Facebook and Twitter integration -->
	<meta property="og:title" content="White Feathers Holistic Healing, Crystal Healing, Angel Therapy, Aroma Therapy, Animal Healing, Reiki - Sonal Bhola"/>
	<meta property="og:image" content="https://www.whitefeathersholistichealing.com/images/slider121.jpg"/>
	<meta property="og:url" content="https://www.whitefeathersholistichealing.com/"/>
	<meta property="og:site_name" content="White Feathers Holistic Healing"/>
	<meta property="og:description" content="White Feather Holistic Healing, Crystal Healing, Reiki, Angel therapy, Animal Healing at most lowest price by Holistic Healer Sonal Bhola. Best quality of Crystals, Reiki, Fenshui, Animal Therapy, Angel Therapy, Aroma Therapy's courses and products available @ nominal price."/>
	<meta name="twitter:title" content="White Feathers Holistic Healing, Crystal Healing, Angel Therapy, Aroma Therapy, Animal Healing, Reiki - Sonal Bhola" />
	<meta name="twitter:image" content="https://www.whitefeathersholistichealing.com/images/slider121.jpg" />
	<meta name="twitter:url" content="https://www.whitefeathersholistichealing.com/" />
...
<div><marquee style="color:Purple"><img src="/images/NEW GIF.gif 
" alt="heart" height="50" width="100"><b>Check out some exciting new courses under the dropdown - COURSES</b>..<b><img src="/images/aug1.gif
" alt="heart" height="50" width="50"><b>For upcoming batches click WHAT'S NEW </b></marquee></div>
<div class="img-responsive" id="slider">
<figure>

<img class="img-responsive" src="images/NEW WFHH BANNER.png" alt>
<img class="img-responsive" src="images/WFHH BANNER 2.png" alt>
<img class="img-responsive" src="images/WFHH BANNER 3.png" alt>
<img class="img-responsive" src="images/WFHH BANNER 4.png" alt>
<img class="img-responsive" src="images/WFHH BANNER 5.png" alt>
</figure>
</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t" align="left">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<p><img class="img2" src="images/crystal.jpg" alt="WH Logo" title="WH Logo" height="150" width="100%" >
					  </p>
                     
				    <h3><b><font color="#BA55D3">Crystal Healing</font></b></h3>
						<p>Crystal Healing is an Alternative Holistic, Non-invasive, Vibrational Energy-based System of Healing.</p><br>
						<p><a href="crystal-healing.php" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<img class="img2" src="images/reiki.jpg" alt="WH Logo" title="WH Logo" height="150" width="100%">
					  </p>
						<h3><b><font color="#BA55D3">Reiki</font></b></h3>
						<p>Reiki is another Alternative Healing Modality which was rediscovered in 1922 by Dr.Mikao Usui.</p><br>
						<p><a href="reiki.php" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<img class="img2" src="images/crystalreiki.jpg" alt="WH Logo" title="WH Logo" height="150" width="100%">
					  </p>
                        			<h3><b><font color="#BA55D3">Crystal Reiki</font></b></h3>

						<p>Crystal Reiki Masters is a course in which the Reiki Practice is integrated with the Healing Power of Crystals.</p><br>
						<p><a href="crystal-reiki.php" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="fh5co-services" class="fh5co-bg-section">
		<div class="container">
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<img class="img2" src="images/animalreiki.jpg" alt="WH Logo" title="WH Logo" height="150" width="100%">
					  </p>
						<h3><b><font color="#BA55D3">ANIMAL REIKI</font></b></h3>
						<p>Animal Reiki is a wonderful Non-invasive Alternative Therapy for Animals and can be safely used on Animals.</p>
						<p><a href="animal-healing.php" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<img class="img2" src="images/angelreiki1.jpg" alt="WH Logo" title="WH Logo" height="150" width="100%">
					  </p>
						<h3><b><font color="#BA55D3">Angel Therapy</font></b></h3>
						<p>Angel Therapy is a Divine Healing Modality from the Angelic Realms who have been with us from the beginning of our Life.</p>
						<p><a href="angel-therapy.php" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						<img class="img2" src="images/aromatharepy2.jpg" alt="WH Logo" title="WH Logo" height="150" width="100%">
					  </p>						<h3><b><font color="#BA55D3">Aroma Therapy</font></b></h3>

						<p>Aromatherapy is a Practice of using Essential Oils extracted from the Flowers, Stems, Barks, Roots, Leaves and other parts of the plants. </p>
						<p><a href="aroma-therapy.php" class="btn btn-primary btn-outline btn-sm">More <i class="icon-arrow-right"></i></a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2><b>SONAL BHOLA</b></h2><p>Certified Crystal Healer | Usui Reiki Master | Angel Therapist | Aroma Therapist | Animal Reiki Practioner | Angel Oracle Card Reader | Master Candle Therapist | Spell Caster </p>
				
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-4 animate-box">
					<div class="trainer">
						<a href="#"><img class="img-responsive" src="images/Sonal Bhola1.jpg" alt="trainer"></a>
						<div class="title">
							<h3><a href="#">Sonal Bhola</a></h3>
							<span>Holistic Healing Coach</span>
						</div>
						<div class="desc text-center">
							<ul class="fh5co-social-icons">
									<li><a href="https://twitter.com/Sonal_WFHH"><i class="icon-twitter"></i></a></li>
								<li><a href="https://www.facebook.com/whitefeathersholistichealing"><i class="icon-facebook"></i></a></li>
								<li><a href="https://www.youtube.com/channel/UC6zsZB_00csAQPgBMLYpRJw"><i class="icon-youtube"></i></a></li>
									<li><a href="https://www.instagram.com/sonalbhola_crystal_healer/"><i class="icon-instagram"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-8 animate-box" align="justify">
			
						<p><font face="Verdana" size="4" color="#BA55D3"><b>Feathers appear when angels are near…</b></font><br>Namaste! My name is Sonal Bhola. I would be your Personal Holistic and Spiritual Healing coach during this exciting journey of learning ancient healing modalities.</p>
                        <p>Before giving my introduction, I would like to extend a sincere gratitude to all my trainers and mentors who have guided and directed me at every step of my learnings and have helped me to achieve my dream to have my own healing academy <font color="#BA55D3"><b>White Feathers Holistic Healing</b></font>. Without their trainings, guidance and support, I would not have been what I am today. A BIG THANKS to all of them. I would also mention a special thanks to my parents, my husband and my furry baby Maggi for supporting me always.</p>
        				 <p>I am the founder of White Feathers Holistic Healing based at Ahmedabad India. I am a Spiritual and Holistic Healing Coach, a Certified Crystal Healer, Usui Reiki Master, Angel Therapist, Master Candle Therapist and an Aroma Therapist. I am also into Angel Oracle Card Readings and various Modern Divination Therapies like Pendulum Dowsing, Crystal Ball Scrying etc. I am also well known for my sucessfull Spell Casting Services.
        				 <p>I also work with the Moon Phases and perform Moon Rituals and Spells. I am a big devotee of the Moon Goddess as I have got many of my life's biggest blessings because of her including the reincarnation journey of my baby Maggie. I have been working with the powerful healing properties of Crystals and Gemstones since almost a decade and I just love Crystals and Animals. And this is what makes me a sucessful Animal Reiki Practitioner also. 
        				 <p>Are you thinking there is so much on my platter? Well :-) I believe spirituality and holiness doesnot have an end and there are many more exciting paths I need to walk on still...  </p>
        				  <p>I feel so blessed to live my dream of having my own healing academy <font color="#BA55D3"><b>White Feathers Holistic Healing</b></font>, as this venture is a result of my loads of hard work, late night studies, dedication, extensive and rigorous learnings and trainings that I took from my mentors, along with practice, time and patience. WFHH aims to provide healing sessions as well as training courses to all people who are drawn towards Alternative Medicine and believe in the healing powers of such Complementary and Holistic Healing Modalities. Not to forget my favourite furry angels and the most innocent souls on this Earth - Animals, Yes! we provide healing therapies for them too!</p>
        				  <p>Please visit the courses available on this website; and I am sure you will be interested in knowing many of them. I assure you, you will love the experience of holistic healing therapies regardless of whether it is taking healing sessions or enrolling for a course.</p>
        				  
        				  
        				   <p>Do not forget to read more about White Feathers Holictic Healing in the "ABOUT" section of this page!</div>
                    ...
                    <p>Wishing you all a very joyful and healthy life.</p>
<p><b>Love, Light & Blessings !</b></p><br>
<p>
						</div>
					</div>
				</div>
    ...
    <div hidden id="fh5co-schedule" class="fh5co-bg" style="background-image: url(images/img_bg_1.jpg);">
		<div class="container">
			<div class="row">
	...
	<div id="fh5co-testimonial" class="fh5co-bg-section">
		<div class="container">
			...
			<div class="item">
			        ...
			        <div class="col-md-3" >
			            <img src="images/maggi.jpg" alt="maggi" height="200px" width="200px">
			        </div>
			        <div class="col-md-9">
			           <h3><span>Maggi Parihar - <a href="#" class="twitter">My Furry Baby</a></span></h3>
									<blockquote>
										<p>&ldquo;I am Maggi,<br>
Mumma loves me a lot and cares for me unconditionally. I m 8 years old. I m very naughty and highly pampered by my parents.
I love Crystal Healing, Reiki and Angel Therapy too. Whenever i am anxious and restless she gives me Crystal Healing and Reiki. I love taking it.
Love you Mumma 😘🐾🐾&rdquo;</p>
									</blockquote>
			        </div>
			    </div>
			    	<div class="item">
			        ...
			        <div class="col-md-3" >
			            <img src="images/ruchika.jpg" alt="maggi" height="200px" width="180px">
			        </div>
			        <div class="col-md-9">
			           <h3><span>Ruchika Dhingra - <a href="#" class="twitter">Academician</a></span></h3>
																		<blockquote>
										<p>&ldquo;I am a spiritual person and I believe everything is destined and whatever happens, happens for the good of all. I have been taking Crystal Healing Sessions from Sonal. I must say that Crystal Healing is really a soul enriching experience and worth taking. I know Sonal since 7 years. I soon plan to take her courses too. I am very excited to know more about Reiki and Angel Therapy too.&rdquo;</p>
									</blockquote>
			        </div>
			    </div>
			    <div class="item">
			        ...
			        <div class="col-md-3" >
			            <img src="images/ashaben.jpg" alt="maggi" height="200px" width="200px">
			        </div>
			        <div class="col-md-9">
			           <h3><span>Asha Shah - <a href="#" class="twitter">House Wife and a Pet Parent</a></span></h3>
									<blockquote>
										<p>&ldquo;We as a family know Sonal since 5-6 years. Sonal is a very fine person at heart. Very caring and can do anything for the benefit of Animals. My dog Roxy who is no more with us was suffering from Liver Failure Disease. He was undergoing continuous painful treatments. During his last months he couldn’t eat at all and we had to put him on liquid food, drips, syringes and blood transfusion. He was even unable to get up. But to appreciate when Sonal intervened during his last days and gave her Crystal Healing my little Roxy started improving. He started eating on his own and was able to recover. I regret that we couldn’t take her help in his early months of illness due to our own busy schedule but we are happy we she gave Roxy his normal life in the last few weeks. He use to wag his tail, move around, eat normally have water and do his daily morning routine. I am thankful to her for her selfless nature, love for Roxy and her eagerness to give him healing therapy. We were totally unaware of this holistic therapy but her confidence and treatment for Roxy made us have faith in the miracles of Crystal Healing. Roxy transitioned happily during his last days and left us forever but we cannot forget the Crystal Healing that benefited him in last few weeks.&rdquo;</p>
									</blockquote>
			        </div>
			    </div>
			    <div class="item">
			        ...
			        <div class="col-md-3" >
			            <img src="images/siddhant.jpg" alt="maggi" height="200px" width="200px">
			        </div>
			        <div class="col-md-9">
			           <h3><span>Siddhant Parihar - <a href="#" class="twitter">Owner - A Class Holidays</a></span></h3>
												<blockquote>
										<p>&ldquo;I am very new to Reiki and Crystal Healing, infact I was totally unaware of these healing modalities. Sonal gave me an abundance mojo bag and made the Healing Grid in my office which is used to attracting abundance and prosperity in life. I could actually find the difference in my life and my Business. I could suddenly feel that my clientele had increased. She is a very simple person but has lots of knowledge about small ways in which we can enhance our lives..&rdquo;</p>
									</blockquote>
			        </div>
			    </div>
			     <div class="item">
			        ...
			        <div class="col-md-3" >
			            <img src="images/Amritbhola.jpg" alt="maggi" height="200px" width="200px">
			        </div>
			        <div class="col-md-9">
			           <h3><span>Amrit Kumar Bhola - <a href="#" class="twitter">Father(English Teacher) </a></span></h3>
											<blockquote>
										<p>&ldquo;Initially I never heard about the Crystal Healing. Crystal Healing is not very popular in India but yes once more and more people are aware of the benefits of the therapy it’s going to be a one of the best healing modalities. Sonal loves animals and she is very calm and sweet by nature and when such person is your energy healer. In these days full of stress and responsibility holistic health is very much required. Once you enrol for her courses you come to know the difference between traditional medications and alternative healing therapies.&rdquo;</p>
									</blockquote>
			        </div>
			    </div>
			    </div>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
						    <div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="images/maggi.jpg" alt="user">
									</figure>
									<span>Maggi Parihar - <a href="#" class="twitter">My Furry Baby</a></span>
									<blockquote>
										<p>&ldquo;I am Maggi,<br>
Mumma loves me a lot and cares for me unconditionally. I m 6 years old. I m very naughty and highly pampered by my parents.
I love Crystal Healing, Reiki and Angel Therapy too. Whenever i am anxious and restless she gives me Crystal Healing and Reiki. I love taking it.
Love you Mumma 😘🐾🐾&rdquo;</p>
									</blockquote>
								</div>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="images/ruchika.jpg" alt="user">
									</figure>
									<span>Ruchika Dhingra - <a href="#" class="twitter">Academician</a></span>
									<blockquote>
										<p>&ldquo;I am a spiritual person and I believe everything is destined and whatever happens, happens for the good of all. I have been taking Crystal Healing Sessions from Sonal. I must say that Crystal Healing is really a soul enriching experience and worth taking. I know Sonal since 4 years. She is my colleague and one of my best friends. I soon plan to take her courses too. I am very excited to know more about Reiki and Angel Therapy too.&rdquo;</p>
									</blockquote>
								</div>
							</div>
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="images/ashaben.jpg" alt="user">
									</figure>
									<span>Asha Shah - <a href="#" class="twitter">House Wife and a Pet Parent</a></span>
									<blockquote>
										<p>&ldquo;We as a family know Sonal since 5-6 years. Sonal is a very fine person at heart. Very caring and can do anything for the benefit of Animals. My dog Roxy who is no more with us was suffering from Liver Failure Disease. He was undergoing continuous painful treatments. During his last months he couldn’t eat at all and we had to put him on liquid food, drips, syringes and blood transfusion. He was even unable to get up. But to appreciate when Sonal intervened during his last days and gave her Crystal Healing my little Roxy started improving. He started eating on his own and was able to recover. I regret that we couldn’t take her help in his early months of illness due to our own busy schedule but we are happy we she gave Roxy his normal life in the last few weeks. He use to wag his tail, move around, eat normally have water and do his daily morning routine. I am thankful to her for her selfless nature, love for Roxy and her eagerness to give him healing therapy. We were totally unaware of this holistic therapy but her confidence and treatment for Roxy made us have faith in the miracles of Crystal Healing. Roxy transitioned happily during his last days and left us forever but we cannot forget the Crystal Healing that benefited him in last few weeks.&rdquo;</p>
									</blockquote>
								</div>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="images/siddhant.jpg" alt="user">
									</figure>
									<span>Siddhant Parihar - <a href="#" class="twitter">Owner - A Class Holidays</a></span>
									<blockquote>
										<p>&ldquo;I am very new to Reiki and Crystal Healing, infact I was totally unaware of these healing modalities. Sonal gave me an abundance mojo bag and made the Healing Grid in my office which is used to attracting abundance and prosperity in life. I could actually find the difference in my life and my Business. I could suddenly feel that my clientele had increased. She is a very simple person but has lots of knowledge about small ways in which we can enhance our lives. I have currently enrolled for her Crystal Reiki Class and I look forward to gain much out of it.&rdquo;</p>
									</blockquote>
								</div>
								</div>
								<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="images/Amritbhola.jpg" alt="user">
									</figure>
									<span>Amrit Kumar Bhola - <a href="#" class="twitter">Father</a></span>
									<blockquote>
										<p>&ldquo;Initially I never heard about the Crystal Healing. Sonal had an interest of collecting Gemstones and Crystals though she was not using them. Then she had enrolled for the courses and started her practice. She gave me volunteer sessions some days as a part of her assignments. I could then believe in the metaphysical properties of the gemstones and crystals. Crystal Healing is not very popular in India but yes once more and more people are aware of the benefits of the therapy it’s going to be a one of the best healing modalities. Sonal loves animals and she is very calm and sweet by nature and when such person is your energy healer, you can imagine the positive impact it would have on your holistic health. In these days full of stress and responsibility holistic health is very much required. I request all the viewers to please enrol for her course to know the difference between traditional medications and alternative healing therapies.&rdquo;</p>
									</blockquote>
								</div>
							</div>
						</div>
	...
	<div id="fh5co-blog" class="fh5co-bg-section">
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h2>Recent Blog</h2>
					<p>Hello viewers, read my latest blogs. Please leave your valuable comments..!!!!</p>
				</div>
			</div>
			<div class="row row-bottom-padded-md">
			     <?php  while($wp = mysqli_fetch_assoc($result)): ?>
				<div class="col-lg-4 col-md-4 cc">
					<div class="fh5co-blog animate-box">
						<a href="#"><img class="img-responsive img1" src="https://www.whitefeathersholistichealing.com/white/blog-sonal-bhola/wp-content/uploads/<?php echo $wp['meta_value']; ?>" alt=""></a>
						<div class="blog-text">
							<h3><a href="#"><?php echo $wp['post_title'];  ?></a></h3>
							<?php $dd=date_create($wp['post_date']); ?>
							<span class="posted_on"><?php echo date_format($dd,"M-d"); ?></span>
							
							<p><?php  $string =$wp['post_content']; $string= preg_replace("/[^a-zA-Z0-9`_.,;@#%~'\"\+\*\?\[\^\]\$\(\)\{\}\=\!\<\>\|\:\-\s\\\\]+/", '',$string); $string=str_replace("&nbsp;"," ",$string); echo  strip_tags(substr($string,0,200)); ?></p>
						<a href="<?php echo $wp['guid']; ?>" class="btn btn-primary">Read More</a>	
						</div>
