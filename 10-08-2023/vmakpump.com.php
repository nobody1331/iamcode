...
<title>VMak Pump | Submersible Pump, Openwell Pump in Ahmedabad, Gujarat, India</title>

<meta name="description" content="Raj Industries Is the Industrial Company brand VMak Pump, Welgro Pump  For the Submersible Pump Sets,Submersible Pumps Manufacturers,Suppliers In Ahmedabad,Gujarat,India.We are Provide Best Services to All Customers Regarding Submerisble Pump Sets.">
    
<meta name="keywords" content="VMak Pump Industries,Submersible Pump Sets,Submersible Pumps Manufacturers,Suppliers In Ahmedabad,Gujarat,India,Submersible Pump Sets Manufacturers,Suppliers,Submersible Pump Sets,Submersible Pumps">

<meta name="robots" content="index, follow">
<meta name="author" content="http://vmakpump.com/">
...
<div class="tp-banner-container">
  <div class="tp-banner">
    <ul>
      <li data-slotamount="7" data-transition="3dcurtain-horizontal" data-masterspeed="1000" data-saveperformance="on"> <img alt="" src="images/dummy.png" data-lazyload="images/slider2.png">
        <div class="caption lft large-title tp-resizeme slidertext1" data-x="left" data-y="130" data-speed="600" data-start="1600">Raj Industries</div>
        <div class="caption lft large-title tp-resizeme slidertext2" data-x="left" data-y="210" data-speed="600" data-start="2200"></div>
        <div class="caption lfb large-title tp-resizeme slidertext3" data-x="left" data-y="270" data-speed="600" data-start="2800">Industries is a Leading Manufacturer Brand Vmak Pump<br/>Open Well submersible Pump, Submersible Pump</div>
        <div class="caption lfb large-title tp-resizeme slidertext4" data-x="left" data-y="350" data-speed="600" data-start="3500"><a href="contact.php">Contact Us</a></div>
      </li>
      <li data-slotamount="7" data-transition="slotzoom-horizontal" data-masterspeed="1000" data-saveperformance="on"> <img alt="" src="images/dummy.png" data-lazyload="images/slider3.png">
        <div class="caption lft large-title tp-resizeme slidertext1" style="text-transform: capitalize!important;" data-x="left" data-y="130" data-speed="600" data-start="1600">Vmak Pump</div>
        <div class="caption lft large-title tp-resizeme slidertext2" data-x="left" data-y="210" data-speed="600" data-start="2200"></div>
        <div class="caption lfb large-title tp-resizeme slidertext3" data-x="left" data-y="270" data-speed="600" data-start="2800">All Type Of Pumps Manufacturing In Ahmedabad<br/>
        0.5 HP, 1 HP, 2 HP 5 HP Single Phase, Three Phase</div>
        <div class="caption lfb large-title tp-resizeme slidertext4" data-x="left" data-y="350" data-speed="600" data-start="3500"><a href="contact.php">Contact Us</a></div>
      </li>
    </ul>
  </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="about_right">
          <div class="title">
            <p>About</p>
            <h1><span> Raj</span> Industries</h1>
          </div>
          <p>"Raj Industries" is the leading manufacturer of outstanding pumping solutions, providing technically modern, amazing energy-efficient, and durable pumping equipments all over the world. We are the top manufacturer of openwell pumps, submersible motors, and high-quality submersible pumps.</p>
          <p>Raj Industries is a focused on value company built on the solid pillars of confidence, innovation, and revolutionary technology, all of which work to maximise highly satisfied customer satisfaction on a global level.</p>
          <p>In order to ensure the lowest cost use, the highest output, and long durability, Vmak Pump is constantly committed to manufacturing, researching, and developing a range of submersible pumping products with the highest energy efficiency. Maximising customer satisfaction is the ultimate goal.Manufacturer of submersible pump sets and pumps in Ahmedabad, Gujarat, India.</p>
          <div class="readbtn"><a href="#">Read More <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="aboutImg"><img src="images/aboutImg1.png" alt=""> </div>
      </div>
    </div>
  </div>
</div>
...
<div class="get-wrap">
  <div class="container">
    <div class="title">
      <h1><span>Raj Industries</span> India’s largest Manufacturing Submersible Pumps in Ahmedabad. Please Call Me? </h1>
    </div>
    <p></p>
    <div class="readmore readbtn"><a href="contact.php">Get a Quote <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
  </div>
</div>
<!--Get Quote End--> 
    ...
    <div class="row"> 
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-service-item">
          <div class="img-holder"> <img src="images/0.5hp-01.jpg" alt="Awesome Image">
            <div class="overlay"></div>
          </div>
          <div class="text-holder">
            <center>
            <div class="text">
              <h3><a href="0.5-HP-Domestic.php">0.5 HP Domestic</a></h3>
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> -->
              <div class="readmore readbtn"><a href="0.5-HP-Domestic.php">Read More.. <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
            </div>
            </center>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-service-item">
          <div class="img-holder"> <img src="images/1-hp-01.jpg" alt="Awesome Image">
            <div class="overlay"></div>
          </div>
          <div class="text-holder">
            <center>
            <div class="text">
              <h3><a href="1-HP-Domestic.php">1 HP Domestic</a></h3>
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> -->
              <div class="readmore readbtn"><a href="1-HP-Domestic.php">Read More.. <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
            </div>
            </center>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-service-item">
          <div class="img-holder"> <img src="images/img-3.jpg" alt="Awesome Image">
            <div class="overlay"></div>
          </div>
          <div class="text-holder">
            <center>
            <div class="text">
              <h3><a href="V7-2-HP-domestic-agriculture.php">V7 2 HP SS Domestic Agriculture</a></h3>
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> -->
              <div class="readmore readbtn"><a href="V7-2-HP-domestic-agriculture.php">Read More.. <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
            </div>
            </center>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-service-item">
          <div class="img-holder"> <img src="images/img-4.jpg" alt="Awesome Image">
            <div class="overlay"></div>
          </div>
          <div class="text-holder">
            <center>
            <div class="text">
              <h3><a href="V7-3-HP-CI-agriculture.php">V7 3 HP SS Agriculture</a></h3>
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> -->
              <div class="readmore readbtn"><a href="V7-3-HP-CI-agriculture.php">Read More.. <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
            </div>
            </center>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-service-item">
          <div class="img-holder"> <img src="images/img-6.jpg" alt="Awesome Image">
            <div class="overlay"></div>
          </div>
          <div class="text-holder">
            <center>
            <div class="text">
              <h3><a href="V9-5-HP-Agriculture.php">V7 5 HP Agriculture</a></h3>
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> -->
              <div class="readmore readbtn"><a href="V9-5-HP-Agriculture.php">Read More.. <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
            </div>
            </center>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-service-item">
          <div class="img-holder"> <img src="images/mix.jpg" alt="Awesome Image">
            <div class="overlay"></div>
          </div>
          <div class="text-holder">
            <center>
            <div class="text">
              <h3><a href="V4-mixflow.php">V4 MixFlow</a></h3>
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> -->
              <div class="readmore readbtn"><a href="V4-mixflow.php">Read More.. <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
            </div>
            </center>
          </div>
        </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-service-item">
          <div class="img-holder"> <img src="images/ridal.jpg" alt="Awesome Image">
            <div class="overlay"></div>
          </div>
          <div class="text-holder">
            <center>
            <div class="text">
              <h3><a href="V4-radial-flow.php">V4 Radial Flow</a></h3>
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p> -->
              <div class="readmore readbtn"><a href="V4-radial-flow.php">Read More.. <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
            </div>
            </center>
          </div>
        </div>
