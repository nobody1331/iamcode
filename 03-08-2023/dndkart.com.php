...
<html class="no-js" lang="en">
    <head>
        ...
        <style>
           .btn-carosel    {    color: #066DE6;
    background-color: #fff;
    border: 2px solid #066DE6;
    padding: 6px 20px;
    border-radius: 4px;
}
...
.blog-image img {
    ...
    max-width: 220px;
    margin: 10px auto;
    }.blog-two-area .blog-text > h3, .blog-three-area .blog-text > h3 {
    padding-top: 3px;
    text-align: center;
    font-size: 19px;}
        </style>
...
$url = 'slider-images.php';
$array = fetch($post,$url);
$slider_images=$array->data;
...
?>
    <div class="carousel-item <?=$i?>">
      ...
      <?php if($value->type!='default'){ ?>
                                        ...
                                        <a class="btn btn-carosel btn-primary" href="<?=$value->type.'.php?id='.$value->type_id; ?>">shop now</a>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
	    ...
	    <!-- Banner Area End -->
        <!-- Product Area Start -->
 <div class="blog-two-area fix pt-10 pb-10 mt-30 mb-30  box">
            <div class="container-fluid">
                <div class="blog-carousel-2 owl-carousel carousel-style-one carousel-style-dot-2">
...
$url='get-subcategories-by-category-id.php';
$array1= fetch($post,$url);	
$subcategory=$array1->data;

if(!empty($subcategory)) foreach ($subcategory as $value1)
{?>

 
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="collection.php?id=<?=$value1->id;?>&<?=urlencode($value1->name)?>">
                                <img src="<?=$value1->image?>" alt="">
                            </a>
                        </div>
                        <div class="blog-text">
                            <h3><a href="collection.php?id=<?=$value1->id;?>&<?=urlencode($value1->name)?>"><?=$value1->name?></a></h3>
...
?>      <div class="product-area pt-10 pb-10 mt-30 mb-30  box">
            <div class="container-fluid">
...
{
    $pvid= $products->variants[0]->id;
   $p= $products->price;
    $d= $products->discounted_price;
?>                                 
                               <div class="custom-col">
                                    <div class="single-product-item">
                                         <div class="product-image">
                                            <a href="product.php?id=<?=$products->id?>&<?=urlencode($products->name)?>">
                                        <img src="<?=$products->image?>" alt="">
                                            </a>  
                                          
                                        </div>
                                        <div class="product-text">
                                            <h5><a href="product.php?id=<?=$products->id?>&<?=urlencode($products->name)?>"><?=$products->name?></a></h5>
                                            <div class="pro-price">
                                                <span class="old-price">₹ <?=$p?></span> 
                                                <span class="new-price">₹ <?=$d?></span>
                                            </div>
        ...
        <!-- Product Area End -->
         ...
         <div class="banner-area product-area pt-10 pb-10 mt-30 mb-30  box">
	        <div class="container-fluid  ">
	            <div class="row">
	                ...
	                <div class="col-lg-4 col-md-4 mb-2">
                        <a class="category banner-image" href="category.php?id=<?=$value->id;?>&<?=urlencode($value->name)?>"><img src="<?=$value->image?>" alt=""><h2><?=$value->name?></h2></a>
	                </div>
	                 <?php }?>
	            </div>
	        </div>
	    ...
	    <div class="banner-two-area fix pt-10 pb-10 mt-30 mb-30  box">
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
   ...
   <div class="col-lg-4 col-md-4">
                        <a class="banner-image" href="#"><img src="<?=$admin_url?><?=$row["image"]?>" alt="" style="    max-height: 268px;
    object-fit: cover;"></a>
	                </div>
            <?php
  }}
