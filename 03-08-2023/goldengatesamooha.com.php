...
<html lang="en">
    <head>
        ...
        <title>Open plots near Hyderabad pharma city | Samooha Projects</title>
        <meta property="og:title" content="Open plots near Hyderabad pharma city | Samooha Projects"/>
        <meta property="og:description" content="Exclusive plotted development near Hyderabad Pharma City. Golden Gate by Samooha Projects comprises Grandeur Villas, Commercial Building, Open Plots &amp; Parks just 10 mins from Hyderabad Pharma City and 20 Min from Hyderabad International Airport – with high appreciation potential. "/>
        <meta property="og:image" content="https://static.wixstatic.com/media/ed19e4_c18405ac2ed54edebdcf7ea45f322863%7Emv2.png/v1/fit/w_2500,h_1330,al_c/ed19e4_c18405ac2ed54edebdcf7ea45f322863%7Emv2.png"/>
        <meta property="og:image:width" content="2500"/>
        <meta property="og:image:height" content="1330"/>
        <meta property="og:url" content="https://www.samoohagoldengate.com"/>
        <meta property="og:site_name" content="Samooha Golden Gate "/>
        <meta property="og:type" content="website"/>
        <meta name="fb_admins_meta_tag" content="samoohaprojects"/>
        <meta name="google-site-verification" content="CuRPWpC5UNO3GoISuruwbZvUjNMVcEHTsQuOeWvtKHk" />
        <meta property="fb:admins" content="samoohaprojects"/>
        <meta name="twitter:card" content="summary_large_image"/>
        <meta name="twitter:title" content="Open plots near Hyderabad pharma city | Samooha Projects"/>
        <meta name="twitter:description" content="Exclusive plotted development near Hyderabad Pharma City. Golden Gate by Samooha Projects comprises Grandeur Villas, Commercial Building, Open Plots &amp; Parks just 10 mins from Hyderabad Pharma City and 20 Min from Hyderabad International Airport – with high appreciation potential. "/>
        <meta name="twitter:image" content="https://static.wixstatic.com/media/ed19e4_c18405ac2ed54edebdcf7ea45f322863%7Emv2.png/v1/fit/w_2500,h_1330,al_c/ed19e4_c18405ac2ed54edebdcf7ea45f322863%7Emv2.png"/>

        <link href="assets/css/main.css" rel="stylesheet">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.6.4/css/bootstrap-datepicker.css" type="text/css" />
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css">
        <link rel="stylesheet" href='https://fonts.googleapis.com/css?family=Open+Sans:400,400italic,600,700&#038;subset=latin,latin-ext' type='text/css'>
    ...
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-N68BTCYLC0"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-N68BTCYLC0');
</script>
    </head>
    <body>
        <section class="msheader">
            <div class="container">
                <div class="row">
                    <div class="col-md-2 col-6">
                        <img src="assets/img/sammoha.png" width="120px">
                    </div>
                    <div class="col-md-2 col-6">
                    <img src="assets/img/goldengate.png" width="130px">
                    </div>
                    <div class="col-md-8">
                        <div class="header_menu">
                            <ul>
                                <li> <a href="#homepage">Home</a> </li>
                                <li> <a href="#venturehighlights">Venture Highlights</a> </li>
        ...
        <section class="msbanner" id="homepage">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        &nbsp;
                    ...
                    <div class="col-md-4">
                        <div class="callusbox mobile_none">
                            <ul>
                                <li><a href="tel:+919121111258"><i class="fa fa-phone"></i> Call Us +91-9121111258</a></li>
                            </ul>
                        </div>
                        <div class="formsbox mobile_none">
                            <h4>Book Now and Save Big</h4>
                            <form class="contact_form" action="index.php" method="post" name="form">
                                <div class="form-group">
                                    <input type="text" placeholder="Name" name="c_name" class="form-control" required>
                                </div>
                                <div class="form-group">
                                <input type="email" placeholder="Email" name="c_email" class="form-control" required>
                                </div>
                                <div class="form-group">
                                <input type="number" placeholder="Phone Number" name="c_contact" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" id="txtDate" placeholder="Date and Time" required name="c_datetime" class="form-control date-input" readonly="readonly">
                                        <label class="input-group-btn" for="txtDate">
                                            <span class="btn btn-warning" style="height: 47px;">
                                ...
                                <div class="form-group">
                                <input type="submit" style="height: 47px;font-size: 17px;" value="Submit" name="submit" class="btn btn-block btn-success btn-sm" data-animation="fadeInRight" data-delay=".8s">
                                </div>
        ...
        <section class="mshomecontent">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="content_box_img">
                            <img src="assets/img/goldentitle.png" width="400px">
                        </div>
                        <div class="content_box_title">
                            <h4>An exclusive plotted development near Hyderabad Pharma City</h4>
                            <h5>An Investment that continuously appreciates in value</h5>
                        </div>
                        <div class="content_box_text">
                            <p>
                            If you are looking for a premium yet affordable real estate investment to 
                            create an enduring legacy for generations to come, Samooha Golden Gate 
                            Township is a perfect destination for you! Nestled in lush green 
                            surroundings, Samooha Golden Gate is located at Yacharam, Sagar 
                            Highway, Hyderabad. Vastu compiled and approved by DTCP, the property 
                            is a magnificent combination of an elegant lifestyle and ROI!
                            </p>
                            <p>
                            As you enter Samooha Golden Gate, you will get lured by spacious villa plots, 
                            a commercial complex, green parks, and a school. The township is near Hyderabad 
                            Pharma City, making it ideal for corporates who want to experience a luxurious 
                            lifestyle and save time and money commuting. Last but not least the area has 
                            excellent connectivity. The development is only 20 mins from Hyderabad International 
                            Airport.
                            </p>
                        </div>
                    </div>
        ...
        <section class="mshomeoverview">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="over_titlebox">
                            <h4>Overview</h4>
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
                    ...
                    <div class="col-md-8">    
                        <div class="over_list">
                            <ul>
                                <li>Project Area <span>70 Acres</span></li>
                                <li>Landmark <span>Yacharam, Sagar Highway</span></li>
                                <li>Plot Sizes <span>From 183 to 400 Sq Yards</span></li>
                                <li>RERA Id <span>P02400002122</span></li>
                                <li class="text-center">Close to Regional Ring Road</li>
                                <li class="text-center">Best Emerging Location in the City</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-2"></div>    
        ...
        <section class="mshomehighilights" id="venturehighlights">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="highilets_titlebox">
                            <h4>Venture Highlights </h4>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/commercial.jpg">
                            <h3>Commercial Complex</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/villa.jpg">
                            <h3>Villa Plots</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/roads.jpg">
                            <h3>60, 40, 33 ft Black Top Roads</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/parks.jpg">
                            <h3>Parks</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/schools.jpg">
                            <h3>Schools</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/entrance.jpg">
                            <h3>Entrance Gate with Arch</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/underground.png">
                            <h3>Underground Drainage</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/plantation.jpg">
                            <h3>Avenue Plantation</h3>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="pop_img">
                            <img src="assets/img/gallery/maintenance.jpg">
        ...
        <section class="mshomelocation">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="assets/img/root.jpg">
                    </div>
                    <div class="col-md-6 loca_flex">
                        <div class="location_titlebox">
                            <h4>Location Advantages </h4>
                        </div>
                        <div class="location_list mt-4">
                            <ul>
                                <li>Adjacent to <span>Pharma City Gate</span>​</li>
                                <li>Nearby <span>Eliminedu Aerospace</span>​</li>
                                <li>Nearby <span>BEL Company</span>​</li>
                                <li>Close to <span>Amazon Data Center Campus</span>​</li>
                                <li>20 Min from <span>Hyderabad International Airport</span>​</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="mshomedremsec">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mshomedremsec_titlebox">
                            <h4>Turn your dream into reality, by investing next to an emerging location </h4>
                            <h5>Hyderabad Pharma City</h5>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <section class="mshomeareab">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="area_box">
                            <img src="assets/img/icon.png">
                            <h4> 19,333 Acres Pharma SEZ</h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="area_box">
                            <img src="assets/img/icon2.png">
                            <h4> Employment Over 5 Lakhs</h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="area_box">
                            <img src="assets/img/icon3.png">
                            <h4>Investment Potential 1 Lakh Cr+</h4>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <section class="mshomefaqs">
            <div class="container">
                <div class="row">
        ...
        <section class="mshomefotter" id="contact">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="ftr_log">
                            <img src="assets/img/sammoha.png">
                        </div>
                        <div class="ftr_social">
                            <ul>
                                <li><a target="_blank" href="https://www.facebook.com/GoldenGateSamooha/"><i class="fa fa-facebook"></i></a></li>
                                <li><a target="_blank" href="https://www.instagram.com/goldengatesamooha/"><i class="fa fa-instagram"></i></a></li>
                                <!-- <li><a target="_blank" href="https://twitter.com/samoohaprojects"><i class="fa fa-twitter"></i></a></li> -->
                                <!-- <li><a target="_blank" href="https://www.linkedin.com/company/samoohaprojects/"><i class="fa fa-linkedin"></i></a></li> -->
                            </ul>
                        </div>    
                    </div>
                    <div class="col-md-6 loca_flex">
                        <div class="ftr_address">
                            <p>
                            1-57/1038/B, Teja Residency, <br>
                            Street Number 6, Sri Ram Nagar,  <br>
                            Kondapur, Hyderabad,  <br>
                            Telangana 500084
                            </p>
                            <p>Call to : 9121111258, 9550652789</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="ftr_copy">
                            <p>
                            © Copyright 2022. All rights reserved with Samooha Projects Pvt Limited.
                            </p>
                        </div>
                    </div>
                </div>
...
<a href="https://api.whatsapp.com/send?phone=9121111258&text=Hi." class="float" target="_blank">
