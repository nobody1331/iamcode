...
<main class="main">
    <div class="home-slider slide-animate owl-carousel owl-theme show-nav-hover nav-big mb-2 text-uppercase" data-owl-options="{
        ...
        <div class="home-slide home-slide1 banner">
            <img class="slide-bg" src="assets/images/demoes/demo4/slider/s1.jpg" alt="slider image">
        ...
        <div class="home-slide home-slide2 banner banner-md-vw">
            <img class="slide-bg" src="assets/images/demoes/demo4/slider/s2.jpg" alt="slider image">
            <div class="container d-flex align-items-center">
        ...
        <div class="info-boxes-slider owl-carousel owl-theme mb-2" data-owl-options="{
            ...
            <div class="info-box info-box-icon-left">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text-body">Free Shipping On All Orders PAN India.</p>
                </div>
            ...
            <div class="info-box info-box-icon-left">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text-body">Always Genuine Quality Products Assured</p>
                </div>
                <!-- End .info-box-content -->
            </div>
            <!-- End .info-box -->
            ...
            <div class="info-box info-box-icon-left">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text-body">We Are Just A Call Away From You.</p>
                </div>
                <!-- End .info-box-content -->
            </div>
            <!-- End .info-box -->
    ...
    <section class="featured-products-section">
        <div class="container">
            <h2 class="section-title heading-border ls-20 border-0">Our Top categories</h2>
            ...
            <div class="products-slider custom-products owl-carousel owl-theme nav-outer show-nav-hover nav-image-center" data-owl-options="{
                ...
                <?php
                $result = mysqli_query($link, "select * from eltra_category order by id desc") or die(mysqli_error($link));
                ...
                ?>
                        <div class="product-default appear-animate" data-animation-name="fadeInRightShorter">
                            <figure>
                                <img src="admin/<?php echo $row['file']; ?>" alt="product" style="width: 100%; height: 250px; object-fit: cover;">
                            </figure>
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="single_category.php?id=<?php echo $row['id']; ?>" class="btn-icon btn-add-cart"><i class="fa fa-arrow-right"></i><span>View</span></a>
                                </div>
                            </div>
                        </div>
                <?php
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="feature-box px-sm-5 feature-box-simple text-center">
                        ...
                        <div class="feature-box-content p-0">
                            ...
                            <p>We at gatedekho.com care about you. Purchasing gate at our website is made super easy with 100% free support, as you like.</p>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="feature-box px-sm-5 feature-box-simple text-center">
                        ...
                        <div class="feature-box-content p-0">
                            ...
                            <p>At gatedekho.com, you can choose your favourite gate from a wide variety of available gate options in only few minutes.</p>
                        </div>
                        <!-- End .feature-box-content -->
                    </div>
                    <!-- End .feature-box -->
                ...
                <div class="col-md-4">
                    <div class="feature-box px-sm-5 feature-box-simple text-center">
                        ...
                        <div class="feature-box-content p-0">
                            <h3>FREE DELIVERY</h3>
                            <h5>Purchase Made Easier</h5>

                            <p>At gatedekho.com, we provide pan India free gate delivery. May you order from anywhere, we will deliver it safely.</p>
                        </div>
                        <!-- End .feature-box-content -->
                    </div>
                    <!-- End .feature-box -->
    ...
    <section class="promo-section bg-dark" data-parallax="{'speed': 2, 'enableOnMobile': true}" data-image-src="">
        <div class="promo-banner banner container text-uppercase">
            <div class="banner-content row align-items-center text-center">
                <div class="col-md-4 ml-xl-auto text-md-right appear-animate" data-animation-name="fadeInRightShorter" data-animation-delay="600">
                    <h2 class="mb-md-0 text-white text-center">Top Products</h2>
                </div>
                <div class="col-md-4 col-xl-3 pb-4 pb-md-0 appear-animate" data-animation-name="fadeIn" data-animation-delay="300">
                    <a href="product.php" class="btn btn-dark btn-black ls-10">View More</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="blog-section pb-0">
        <div class="container">
            <div class="row">
                <?php
                $result = mysqli_query($link, "select * from eltra_products order by id desc");
                $i = 0;
                while ($row = mysqli_fetch_array($result)) {
                    $i++;
                ?>
                    <div class="col-6 col-sm-4">
                        <div class="product-default" style="border: 1px solid #ccc;">
                            <figure>
                                <img src="admin/<?php echo $row['file']; ?>" alt="<?php echo base64_decode($row['title']); ?>" style="height: 250px; width: 100%; object-fit: cover;">
                            </figure>
                            <div class="product-details">
                                <h3 class="product-title"><?php echo base64_decode($row['title']); ?></h3>
                                <div class="price-box">
                                    <?php
                                    if ($row['price'] != "") {
                                    ?>
                                ...
                                <div class="product-action">
                                    <a href="single_pro.php?id=<?php echo $row['id']; ?>" class="btn-icon btn-add-cart"><i class="fa fa-arrow-right"></i><span>View Details</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
