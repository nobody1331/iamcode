...
<body class="">
    <div id="page" class="site">
        ...
        <div id="content" class="site-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h1 class="banner-stitle m-b55 xs-m-b40">Boost Your Online<br><span class="text-second">Visibility</span></h1>
                                <!-- <h2 class="banner-stitle m-b55 xs-m-b40">Boost Your Online<br><span class="text-second">Visibility</span></h2> -->
                                <div class="wpcf7">
                                    <div class="screen-reader-response"></div>
                                    <form action="submitform.php" method="POST" class="wpcf7-form">
                                        <div class="seo-score one-line-form">
                                            <span class="wpcf7-form-control-wrap your-url">
                                                <input type="text" name="name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-url" placeholder="Your Name" required="">
                                            </span>

                                            <span class="wpcf7-form-control-wrap your-email">
                                                <input type="text" id="" class="wpcf7-form-control wpcf7-text wpcf7-url" name="number" size="40" placeholder="Your Contact Number" required="">
                                            </span>

                                            <button type="submit" class="octf-btn octf-btn-icon octf-btn-primary" name=submit value="submit">Get Call Back<i class="flaticon-right-arrow-1"></i></button>
                                        </div>
                                    </form>
                                    <?php
                                    if (isset($_SESSION['message'])) {
                                    ?>
                                        <h6 class="banner-title m-b0"><?php echo $_SESSION['message'] ?></h6>
                                    <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <div class="top-up">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                <div class="icon-box s3 box-hover-gradient text-center">
                                    ...
                                    <div class="action-box">
                                        <a href="about/" class="octf-btn octf-btn-icon octf-btn-white">Learn More<i class="flaticon-right-arrow-1"></i></a>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 m-t50">
                                <div class="icon-box s3 box-hover-gradient text-center">
                                    ...
                                    <div class="content-box">
                                        <h5> Solutions to your problems </h5>
                                    </div>
                                    <div class="action-box">
                                        <a href="about/" class="octf-btn octf-btn-icon octf-btn-white">Learn More<i class="flaticon-right-arrow-1"></i></a>
                                    </div>
                ...
                <div class="container">
                    <div class="row flex-row">
                        <div class="col-lg-6 col-md-12 col-xs-12 xs-p-b50 text-center">
                            <img src="<?php echo $baseurl ?>images/5149654.gif" class="" alt="onum">
                        </div>
                        <div class="col-lg-6 col-md-12 col-xs-12 p-l95 xs-p-l15 p-r0 xs-p-r15 align-self-center">
                            <div class="ot-heading left-align">
                                <h6><span>about us</span></h6>
                                <h2 class="main-heading m-b20">Hit The Target You Craved For</h2>
                            </div>
                            <p class="m-b0 p-b45">Pionifty Infotech Pvt Ltd is a digital marketing and web development company that excels at customizing services to meet each client's specific requirements. Depending on your objectives and goals, Pionifty can help you develop in any field, including app development, business web development, website design, and digital marketing. By using engineering and design thinking, as well as a special combination of velocity, scale, and proficiency, our team helps the business increase productivity, enhance customer experiences, and develop new digital services.</p>
                            <div class="ot-button">
                                <a href="about/" class="octf-btn octf-btn-secondary octf-btn-icon"><span>Learn More <i class="flaticon-right-arrow-1"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
            </section> <!-- ABT SECTION eND -->
            ...
            <section class="p-t120 p-b290 bg-pricing">
                <div class="container">
                    <div class="ot-heading text-center">
                        ...
                        <h2 class="main-heading">Offering Our Best Services</h2>
                    </div>
                    <p class="text-center m-b40">We always provide services beyond your expectations because customer satisfaction is our foremost priority.</p>
                    <div class="row">
                        <div class="col-md-4 sm-p-b60">
                            <div class="ot-pricing-table bg-shape s1">
                                <span class="title-table">Web Design</span>
                                <div class="inner-table">
                                    <!-- <img src="<?php echo $baseurl ?>images/internet.png" alt="Standard"> -->
                                    <img src="<?php echo $baseurl ?>images/services_img_1.png" alt="Standard">
                                    <p class="text-center m-b40">Your website is the biggest statement of who you are and what you do online; you need to get it right.</p>
                                </div>
                                <a href="web/" class="octf-btn octf-btn-icon octf-btn-secondary">Read More <i class="flaticon-right-arrow-1"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4 sm-p-b60">
                            <div class="ot-pricing-table bg-shape s2">
                                <span class="title-table">Digital Marketing</span>
                                <div class="inner-table">
                                    <!-- <img src="<?php echo $baseurl ?>images/social-media.png" alt="Economy"> -->
                                    <img src="<?php echo $baseurl ?>images/services_img_2.png" alt="Economy">
                                    <p class="text-center m-b40">Every business requires the backbone to reach out to potential clients by utilizing Digital marketing channels.</p>
                                </div>
                                <a href="digital/" class="octf-btn octf-btn-icon octf-btn-third">Read More <i class="flaticon-right-arrow-1"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="ot-pricing-table bg-shape s3">
                                <span class="title-table">App Development</span>
                                <div class="inner-table">
                                    <!-- <img src="<?php echo $baseurl ?>images/app_development.png" alt="Executive" style=> -->
                                    <img src="<?php echo $baseurl ?>images/services_img_3.png" alt="Executive" style=>
                                    <p class="text-center m-b40">Mobile app development is the act or process by which a mobile app is developed for mobile devices.</p>
                                </div>
                                <a href="app/" class="octf-btn octf-btn-icon octf-btn-primary">Read More <i class="flaticon-right-arrow-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 5rem;">
                        <div class="col-md-4 sm-p-b60">
                            <div class="ot-pricing-table bg-shape s1">
                                <span class="title-table">End To End Service</span>
                                <div class="inner-table">
                                    <!-- <img src="<?php echo $baseurl ?>images/route.png" alt="Standard"> -->
                                    <img src="<?php echo $baseurl ?>images/services_img_4.png" alt="Standard">
                                    <p class="text-center m-b40">End-to-end suppliers usually deal with all of a system’s hardware and software, together with installation, implementation, and maintenance.</p>
                                </div>
                                <a href="endtoend/" class="octf-btn octf-btn-icon octf-btn-secondary">Read More <i class="flaticon-right-arrow-1"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4 sm-p-b60">
                            <div class="ot-pricing-table bg-shape s2">
                                <span class="title-table">E-Commerce Development</span>
                                <div class="inner-table">
                                    <!-- <img src="<?php echo $baseurl ?>images/shopping.png" alt="Economy"> -->
                                    <img src="<?php echo $baseurl ?>images/services_img_5.png" alt="Economy">
                                    <p class="text-center m-b40">No matter which type of ecommerce site you plan to build, the first thing you need is an ecommerce platform to create best ecommerce store.</p>
                                </div>
                                <a href="ecommerce" class="octf-btn octf-btn-icon octf-btn-third">Read More <i class="flaticon-right-arrow-1"></i></a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="ot-pricing-table bg-shape s3">
                                <span class="title-table">SEO</span>
                                <div class="inner-table">
                                    <!-- <img src="<?php echo $baseurl ?>images/seo.png" alt="Executive"> -->
                                    <img src="<?php echo $baseurl ?>images/services_img_6.png" alt="Executive">
                                    <p class="text-center m-b40">We analyzes your website and gives you tips on optimizing your site for a long-term success in search engine optimization.</p>
                                </div>
                                <a href="seo/" class="octf-btn octf-btn-icon octf-btn-primary">Read More <i class="flaticon-right-arrow-1"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="p-b420 pt-40rem" style="padding-bottom: 0;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="partners">
                                <div class="ot-heading text-center">
                                    <h2 class="main-heading">Our Clients</h2>
                                </div>
                                <div class="owl-carousel home-client-carousel">
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <!-- <img class="partners-slide-image" src="./images/logo/03.png" alt="clients"> -->
                                            <img class="partners-slide-image" src="./images/logo/logo_1.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_2.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_3.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_4.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_5.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_6.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_7.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_8.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_9.png" alt="clients">
                                        </figure>
                                    </div>
                                    <div class="partners-slide">
                                        <figure class="partners-slide-inner">
                                            <img class="partners-slide-image" src="./images/logo/logo_10.png" alt="clients">
                                        </figure>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- ACTIVE Client STRTS-->
            <section style="margin-top: 250px" class="p-b130 bg-counter">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="row flex-row align-items-end">
                                    <div class="col-lg-6 col-md-12 col-xs-12 xs-m-b40">
                                        <div class="ot-heading">
                                            ...
                                            <h2 class="main-heading">We Innovate Excellent<br> Ideas For Your Growth.</h2>
                                        </div>
                                        <div class="ot-accordions">
                                            <div class="acc-item current">
                                                <span class="acc-toggle"> Customer Services Is The Face Of Our Company <i class="down flaticon-arrow-pointing-to-down"></i><i class="up flaticon-arrow-pointing-to-up"></i></span>
                                            ...
                                            <div class="acc-item">
                                                <span class="acc-toggle">Achieving Your Goal Is Our Priority <i class="down flaticon-arrow-pointing-to-down"></i><i class="up flaticon-arrow-pointing-to-up"></i></span>
                                                <div class="acc-content">
                                                    <p>We have experts to make perfections with creativity in our services.</p>
                                                </div>
                                            </div>
                                            <div class="acc-item">
                                                <span class="acc-toggle">Transparency With Clients<i class="down flaticon-arrow-pointing-to-down"></i><i class="up flaticon-arrow-pointing-to-up"></i></span>
                                                <div class="acc-content">
                                                    <p>We maintain transparency about our work with customers to make them understand details.</p>
                                                </div>
                                            </div>
                                            <div class="acc-item">
                                                <span class="acc-toggle">Convenient Work Process<i class="down flaticon-arrow-pointing-to-down"></i><i class="up flaticon-arrow-pointing-to-up"></i></span>
                                                <div class="acc-content">
                                                    <p>We design our work as per your needs and goals to make you grow faster</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-xs-12 text-center">
                                        <img src="<?php echo $baseurl ?>/images/whyus-home1.gif" alt="seo">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex-row">
                        <div class="col-md-4 col-xs-12 align-self-center">
                            <div class="ot-heading heading-testimonials left-align">
                                ...
                                <h2 class="main-heading">Check What<br>Our Clients <br>Says.</h2>
                            </div>
                            ...
                            <div class="ot-testimonials">
                                <div class="testimonial-wrap">
                                    <div class="testimonial-inner ot-testimonials-slider">
                                        <div>
                                            <img src="<?php echo $baseurl ?>/images/Tanvi_Gupta.webp" alt="Michael Terry">
                                            <div class="ttext">
                                                It is reassuring to work with people who treat your properties as their own and think pro-actively
                                            </div>
                                            <div class="tinfo">
                                                <h6>Leena Tripathi </h6>
                                            </div>
                                        </div>
                                        <div>
                                            <img src="<?php echo $baseurl ?>/images/Screenshot-150x150.jpg" alt="Emilia Clarke">
                                            <div class="ttext">
                                                Pionifty has been a fantastic partner in helping us define and optimize our digital objectives.
                                            </div>
                                            <div class="tinfo">
                                                <h6>Amesh Mishra</h6>
                                            </div>
                                        ...
                                        <div>
                                            <img src="<?php echo $baseurl ?>/images/Shreeya_Parikh.webp" alt="Cristian Torres">
                                            <div class="ttext">
            ...
            <section class="p-t330 p-b210 cta bg-cta particles-js" data-color="#fe4c1c,#00c3ff,#0160e7" data-id="i1-1">
                ...
                <div class="container">
                    <div class="cta-content text-center">
                        <h2 style="font-size: 3rem;" class="m-b20">Take Your Business At The Highest Level Of Success With Us. </h2>
                        <p class="m-b35">Create, Advertise and Optimize with Pionifty!</p>
                        <div class="ot-button">
                            <a href="contact/" class="octf-btn octf-btn-primary octf-btn-icon"><span>Start Now<i class="flaticon-right-arrow-1"></i></span></a>
                        </div>
                    </div>
                </div>
            </section>
