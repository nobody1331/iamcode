                ...
                <div class="col-lg-10">
                    <div class="banner_text text-center">
                        <div class="banner_text_iner">
                            <h5>Since <span>1967</span> </h5>
                            <h1> Sandhu Auto Engineer!</h1>
                            <h3>Automotive Components, Fasteners, Industrial Fasteners, Bolts, Carriage Bolts, Socket Head Screws, Special Bolts and Stainless Steel.</h3>
                            <a href="about.php" class="btn_1">learn more </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-6">
                    <div class="about_img">
                        <img src="img/product/about.png" alt="">
                    </div>
                </div>
                <div class="col-md-5 col-lg-5">
                    <div class="about_text">
                        <h2>About us</h2>
                        <h4>Well facilitated with state-of-the-art machinery and latest technologies, we, Sandhu Auto Engineers, have established a strong foothold in the field of manufacturing automotive and other industrial components. Incepted in the year 1967, we have been following a client oriented approach in all our operations along with adhering to set industry standards. This has won us great accolades from all across the globe. Over the years, we have developed core competency in designing and developing a superlative range of Automotive Components, Fasteners, and more. As a renowned manufacturer, exporter and supplier of these products, we never compromise with the quality of our range. We export our qualitative assortment to Europe, USA, Canada, and CIS Countries.
</h4>
                        <!--<h3>Automotive Components<br> Fasteners</h3>-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-columns">
						...
						$x="select * from tb_category order by rand() limit 2";
                        ...
                        <div class="card ">
                            <div class="card_iner overlay">
                                <img src="admin/<?php echo $row['image']; ?>" class="card-img-top" alt="..." style="max-height:450px;">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $row['category']; ?></h5>
                                    <p class="card-text"><?php echo $row['description']; ?> </p>
                                    <a href="sub_product.php?sno=<?php echo $row['sno']; ?>" class="portfolio_btn">View more <img
                        ...
                        <div class="card see_more_project">
                            <blockquote class="blockquote mb-0">
                                <a href="product.php" class="btn_1">more product</a>
                            </blockquote>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-sm-6 col-md-6">
                    <div class="single_service_part">
                        ...
                        <span class="line"></span>
                        <h3>Contact</h3>
                       <p>Contact Detail About Our Company here .</p>
                    </div>
                </div>
