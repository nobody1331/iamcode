    ...
    <div class="container-fluid hero-header bg-light py-5 mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <p class="text-primary text-uppercase mb-2 animated slideInDown">Welcome To Gurukrupa</p>
                    <h1 class="display-4 mb-3 animated slideInDown"> Led Sign Board Manufacturers
 </h1>
                    <p class="animated slideInDown">The interface is clear and simple, every action is straightforward. Creating a new SIGN BOARD
                ...
                <div class="col-lg-6 animated fadeIn">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white p-3 w-100 mb-3" src="img/banner1.jpg" alt="">
                            <img class="img-fluid bg-white p-3 w-80" style="height: 200px; width: 400px;" src="img/banner3.PNG" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white p-3 w-100 mb-3" style="height: 300px; width: 700px;" src="img/banner4.PNG" alt="">
                            <img class="img-fluid bg-white p-3 w-100" src="img/banner2.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="row g-3 img-twice position-relative h-100">
                        <div class="col-6">
                            <img class="img-fluid bg-light p-3" style="width:200Px;height: 300px;" src="img/about2.jpeg" alt="">
                        </div>
                        <div class="col-6 align-self-end">
                            <img class="img-fluid bg-light p-3"  style="width:500Px;height: 400px;"  src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <h1 class="display-6 mb-4"><?php echo $list['about']?></h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-5">The Leading ACP LED BOARD</h1>
            </div>
            <div class="row g-3">
              ...
              foreach ($get_services as $list) {
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fact-item bg-light text-center h-100 p-5">
                        <h1 class="display-2 text-primary mb-3" data-toggle="counter-up"><?php echo $list['services']?></h1>
                    ...
                    <div class="service-item d-flex flex-column bg-white p-3 pb-0">
                        <div class="position-relative">
                            ...
                            <div class="service-overlay">
                                <a class="btn btn-lg-square btn-outline-light rounded-circle" href="categories.php?id=<?php echo $list['id']?>"><i class="fa fa-link text-primary"></i></a>
                            </div>
                        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-0">Discover Our Unique And Creative ACP LED BOARD
</h1>
            </div>
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid"  style="height: 300px;" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="">
                                <a class="project-title h5 mb-0" href="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" data-lightbox="project">
                                   <?php echo $list['name']?>
                                </a>
                            </div>
                        </div>  
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <?php
              $get_client=get_client($con,6);
              foreach ($get_client as $list) {
                  ?>
                <div class="testimonial-item bg-white p-4">
                    <div class="d-flex align-items-center mb-4">
                        <img class="flex-shrink-0 rounded-circle border p-1" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="">
                        <div class="ms-4">
                            <h5 class="mb-1"><?php echo $list['client']?></h5>
                            <span>Profession</span>
                        </div>
                    </div>
                    <p class="mb-0"><?php echo $list['description']?></p>
                </div><?php
              } ?>
