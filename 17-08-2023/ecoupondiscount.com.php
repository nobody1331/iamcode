...
$limit='set';
$categories= MasterFunctions::get_categories($limit);
$brand_image= MasterFunctions::get_brand_image();
session_start();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5YMJY13TY5"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5YMJY13TY5');
</script>
        <meta charset="utf-8" />
                ...
                <div id="content">
                   <?php  include_once('header.php');  ?>
                    ...
                    <section class="homepage-search-block position-relative">
                        <div class="container">
                            <div class="row">
                                <div class="owl-carousel owl-theme restaurant-slider homepage-great-deals-carousel">
                                    <?php foreach ($banner as $key => $row) : ?>  
                                    <div class="item">
                                        <img class="img-fluid" src="<?= WEBSITE_BASE_URL.'uploads/banners/'.$row['image']; ?>" width="100%" />
                                    </div>
                           <?php endforeach; ?>
                    ...
                    <section class="section-padding homepage-view-offers">
                        <div class="container">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h5 mb-0 text-gray-900">Coupon Deals</h1>
                                <a href="coupon.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-eye fa-sm text-white-50"></i> View All</a>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-sm-6 mt-2">
                                    <div class="custom-card shadow-sm h-100">
                                        <div class="custom-card-image">
                                            <a href="coupan-details.php?brand=<?php echo $row['id'];  ?>">
                                                <img class="img-fluid item-img" src="<?= WEBSITE_BASE_URL.'uploads/categories/'.$row['image']; ?>" />
                                            </a>
                                        ...
                                        <div class="p-3 pt-4">
                                            <div class="custom-card-body">
                                                <h6 class="mb-3"><a class="text-gray-900" href="coupan-details.php?brand=<?php echo $row['id'];  ?>"><?= $row['category']; ?></a></h6>
                                                <p class="text-gray-500"><i class="icofont-location-pin "></i> <?= $row['address']; ?></p>
                                            </div>
                                            <div class="custom-card-footer d-flex align-items-center">
                                                <span class="text-danger"><i class="icofont-sale-discount"></i> PRICE ₹ <?= $row['price']; ?></span>
                                         
                                         &nbsp;  &nbsp;  &nbsp;
                                         
                                           <button type="button" class="btn btn-primary shadow-sm" data-toggle="modal" data-target="#myModal<?php echo $row['id'];  ?>" >Buy Now</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form action="controllers/master.php" method="post">
  <div class="form-group">
    <label for="email">Brand:</label>
    <input type="text" name="brand" class="form-control" id="email" value="<?= $row['category']; ?>">
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" name="address" class="form-control" id="pwd">
     ...
     <div class="form-group">
    <label for="pwd">Amount: ₹  <?= $row['price']; ?></label>
    <input type="hidden" name="amount" class="form-control" value="<?= $row['price']; ?>" id="pwd">
  </div>
 <input type="hidden" name="brand_id" value="<?php echo $row['id'];  ?>" class="form-control" id="pwd">
  <input type="hidden" name="c1e7c5cfd3d06ee8ef28b5c807d50f3b" value="buy_booklet">
  <button type="submit" name="submit" class="btn btn-primary">Submit</button>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <!--    <div class="container">-->
                    <!--        <div class="d-sm-flex align-items-center justify-content-between mb-4">-->
                    <!--            <h1 class="h5 mb-0 text-gray-900">Top E-Card Deals</h1>-->
                    ...
                    <!--                                    <span class="badge badge-success"><i class="icofont-star"></i> 3.1</span>-->
                    <!--                                </div>-->
                    <!--                            </div>-->
                    <!--                            <div class="p-3">-->
                    <!--                                <div class="custom-card-body">-->
                    <!--                                    <h6 class="mb-0"><a class="text-gray-900" href="#">The Home Depot, Inc.</a></h6>-->
                    <!--                                    <p class="text-gray-500 mb-2">Andheri East Office, Mumbai</p>-->
                    <!--                                    <p class="text-gray-500 mb-0"><span class="text-gray-900">Variety store</span></p>-->
                    <!--                                </div>-->
                    <!--                            </div>-->
                    ...
                    <!--                            <div class="p-3">-->
                    <!--                                <div class="custom-card-body">-->
                    <!--                                    <h6 class="mb-0"><a class="text-gray-900" href="#">Target Corporation</a></h6>-->
                    <!--                                    <p class="text-gray-500 mb-2">Andheri East Office, Mumbai</p>-->
                    <!--                                    <p class="text-gray-500 mb-0">-->
                    <!--                                        <span class="text-warning"><i class="icofont-clock-time"></i> Time Left : 2 days: 3 Hrs</span>-->
                    <!--                                    </p>-->
                    <!--                                </div>-->
                    <!--                            </div>-->
                    <!--                            <div class="p-3 border-top">-->
                    ...
                    <!--                        <div class="custom-card bg-white shadow-sm h-100 stor-card">-->
                    <!--                            <div class="custom-card-image">-->
                    <!--                                <div class="member-plan"><span class="badge badge-info">Silver Member</span></div>-->
                    <!--                                <a href="#">-->
                    ...
                    <!--                            <div class="p-3">-->
                    <!--                                <div class="custom-card-body">-->
                    <!--                                    <h6 class="mb-0"><a class="text-gray-900" href="#">Phoenix Market City</a></h6>-->
                    <!--                                    <p class="text-gray-500 mb-2">Andheri East Office, Mumbai</p>-->
                    <!--                                    <p class="text-gray-500 mb-0"><span class="text-gray-900">Variety store</span></p>-->
                    <!--                                </div>-->
                    <!--                            </div>-->
                    ...
                    <!--                            <div class="p-3">-->
                    <!--                                <div class="custom-card-body">-->
                    <!--                                    <h6 class="mb-0"><a class="text-gray-900" href="#">Amazon.com, Inc.</a></h6>-->
                    <!--                                    <p class="text-gray-500 mb-2">Andheri East Office, Mumbai</p>-->
                    <!--                                    <p class="text-gray-500 mb-0">-->
                    <!--                                        <span class="text-warning"><i class="icofont-clock-time"></i> Time Left : 2 days: 3 Hrs</span>-->
                    <!--                                    </p>-->
                    ...
                    <!--                            <div class="p-3 border-top">-->
                    <!--                                <div class="custom-card-badge">-->
                    <!--                                    <span class="badge badge-info"><i class="icofont-sale-discount"></i> OFFER</span>-->
                    ...
                    <section class="section-padding homepage-coupon">
                        <div class="container">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h5 mb-0 text-gray-900">Top Brands</h1>
                             
                            </div>
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="owl-carousel owl-theme owl-carousel-four homepage-coupon-carousel">
                                      <?php foreach ($brand_image as $key => $row) : ?>
                                        <div class="item ">
                                            <div class="bg-white p-4 shadow-sm text-center h-100 border-radius">
                                                <div class="all-coupon">
                                                    <img class="img-responsive" src="<?= WEBSITE_BASE_URL.'uploads/categories/'.$row['image']; ?>" style="width:100%; height: 125px " />
