...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/product/banner1.jpg" alt="Los Angeles" class="d-block" style="width:100%">
    </div>
    <div class="carousel-item">
      <img src="images/product/banner2.jpg" alt="Chicago" class="d-block" style="width:100%">
    </div>
    <div class="carousel-item">
      <img src="images/product/banner3.jpg" alt="New York" class="d-block" style="width:100%">
    </div>
  </div>
  
  <!-- Left and right controls/icons -->
  <button class="carousel-control-prev" type="button" data-bs-target="#demo" data-bs-slide="prev" style="opacity:0;">
    <span class="carousel-control-prev-icon" style="color:#d92828;"></span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="#demo" data-bs-slide="next" style="opacity:0;">
    <span class="carousel-control-next-icon" style="color:#d92828;"></span>
  </button>
</div>
        </section>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 noPaddingRight">
                        <div class="video_01 mrm15 text-right">
                            <img src="images/product/about2.jpg" alt=""/>
                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="about_us_content">
                            ...
                            <h2 class="sec_title">
                                Kalyan Singh Kirpal Singh & Sons
                            </h2>
                            <p class="ind_lead"></p>
                            <p class="mb28">
                                Established in 1964 , Kalyan Singh Kirpal Singh & sons has made a name for itself in the list of top Manufacturers & Traders of Ladies Hair Pins and All Types of Machinery in India. The supplier company is located in Amritsar, Punjab and is one of the leading sellers of listed products.
Kalyan Singh Kirpal Singh & sons is listed in Trade India's list of verified sellers offering supreme quality of Camy Hair Pins etc. Buy hair pins in bulk from us for the best quality products and service. </p>
...
<!--<section class="commonSection clientSecion1">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 text-center">
                        <h6 class="sub_title light_sub_title"></h6>
                        <h2 class="sec_title with_bar light_sec_title">
                            <span>Only Hindi Lnguage And English Language known Person Contact me Please.</span>
                        </h2>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="icon_box_01 text-center">
                            <i class="bigger icofont-listing-box"></i>
                            <i class="smaller icofont-listing-box"></i>
                            <span></span>
                            <h3>Good Products</h3>
                            <p>
                                We are Supply of  Good Quality Products ... 
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="icon_box_01 text-center">
                            <i class="bigger icofont-thumbs-up"></i>
                            <i class="smaller icofont-thumbs-up"></i>
                            <span></span>
                            <h3>Quality</h3>
                            <p>
                                100% Best Quality Of Product .. 
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="icon_box_01 text-center">
                            <i class="bigger icofont-users-alt-2"></i>
                            <i class="smaller icofont-users-alt-2"></i>
                            <span></span>
                            <h3>Support</h3>
                            <p>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 noPadding">
                        <div class="video_02 withBGImg">
                            <!--<a class="videoPlay1 videoPlayer" href="https://youtu.be/Uf_dadmTnIA"><i class="fas fa-play"></i></a>-->
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-6 noPaddingRight">
                        <div class="whyChooseUsContent">
                            <h6 class="sub_title">Get To Know Us</h6>
                            <h2 class="sec_title dark_sec_title">
                                <span>Kalyan Singh Kirpal Singh & Sons</span>
                            </h2>
                            <p>
                              Kalyan Singh Kirpal Singh & sons is  list of verified sellers offering supreme quality of Camy Hair Pins etc. Buy hair pins in bulk from us for the best quality products and service. Since 1964, Kalyan Singh Kirpal Singh & sons has made a name for itself in the list of top suppliers of hair pins in India. The supplier company is located in Amritsar, Punjab and is one of the leading sellers of listed products. 
                            </p>
                            <a href="contact.php" class="ind_btn"><span>get a quote</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="commonSection casestudysection">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 text-center">
                        <h6 class="sub_title">Product</h6>
                        <h2 class="sec_title with_bar">
                            <span>Our Recent Product</span>
                        </h2>
                    </div>
                </div>
				...
				include_once("admin/includes/connect.php");
						$x="select * from tb_product order by rand() limit 6";
						$res=mysqli_query($con,$x);
						while($row=mysqli_fetch_array($res))
						{
				?>
                    <div class="col-xl-4 col-md-6 col-lg-4 shaf_itme" >
                        <div class="singlefolio" style="border: 3px solid #d92828;">
                            <img src="admin/<?php echo $row['image']; ?>" alt="" style="max-height:500px;"/>
                            <div class="folioHover">
                                
                                <h4><a href="<?php echo $row['slug']; ?>"><?php echo $row['product']; ?></a></h4>
                            </div>
                        </div>
                    </div>
                    <?php
        ...
        <section class="commonSection clientSecion">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h5 class="sub_title light_sub_title text-center">
                                <span class="icofont-location-arrow"> <a href="enquiry.php" style="color:#fff;">For Any Information Contact here.</a></span>
                            </h5>
                    </div>
                </div>
            </div>
