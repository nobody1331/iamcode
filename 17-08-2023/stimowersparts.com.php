...
<?php
    ...
    <section class="main-slider">
        ...
        <div class="main-slider-carousel owl-carousel owl-theme">
            ...
            <div class="slide style-two" style="background-image:url(images/banner1.png)">
                <div class="auto-container">
                	<!--<div class="content clearfix">
						<div class="title">Industrial Manufacturing</div>
						<h2>Best Industrial Service</h2>
						<div class="text">We are the best guarenteed company to serve you. We are <br> dedicated to help you any time.</div>
                    	<div class="link-box">
            ...
            <div class="slide style-two" style="background-image:url(images/banner2.png)">
                <div class="auto-container">
                	<!--<div class="content clearfix">
						<div class="title">Industrial Manufacturing</div>
						<h2>Smart Partnerships</h2>
						<div class="text">To take advantage of digitization, industrial manufacturers <br> need new operating models.</div>
                    	<div class="link-box">
							<a href="about.html" class="theme-btn btn-style-one">Our Service</a> <a href="contact.html" class="theme-btn btn-style-three">Contact Us</a>
						</div>
                    </div>-->
                </div>
            </div>
            
            <div class="slide style-two" style="background-image:url(images/banner3.png)">
                <div class="auto-container">
                	
                </div>
            </div>
			<div class="slide style-two" style="background-image:url(images/banner4.png)">
                <div class="auto-container">
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="video-box">
						<div class="image">
							<a href="images/sti.mp4" class="lightbox-image overlay-box"><span class="flaticon-play-button"><i class="ripple"></i></span></a>
							<img src="images/used autopart.jpg" alt="">
						</div>
					</div>
				</div>
					...
					<div class="inner-column">
						...
						<div class="sec-title">
							<div class="title-inner">
								...
								<h2>STI MOWERS PARTS</h2>
							</div>
						</div>
						<div class="text">Established in 2017, we, Sti Mowers Parts are a reliable Exporter, Manufacturer, Supplier of Automotive Parts, Agriculture parts,Trailer Parts etc. Sti Mowers Parts is one of Trade India's verified and trusted sellers providing satisfactory range of Automotive Parts, Agriculture parts at affordable prices.</div>
			...
			<div class="row clearfix">
				<?php
					...
					<div class="services-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<img src="admin/<?php echo $row['image']; ?>" alt="" style="background-color:#e5e1e1;"/>
							</div>
							<h3><a href="product.php?x=<?php echo $row['sno']; ?>"><?php echo $row['category']; ?></a></h3>
			...
			<div class="row clearfix">
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<img src="images/resource/rotary_mowers.png" alt="" />
						</div>
					</div>
				</div>
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="sec-title">
							<div class="title-inner">
								<div class="title">Why is Merit Selection Better</div>
								<h2>Why Choose Us</h2>
							</div>
						</div>
						<div class="text">
							<p>Manufacturing industry became a key sector of production and labour in European and North American countries during the Industrial Revolution, upsetting previous mercantile and feudal economies.</p>
	...
	<section class="project-section">
		<div class="auto-container">
			...
			<div class="four-item-carousel owl-carousel owl-theme">
				<?php
										include_once("admin/includes/connect.php");
										$x="SELECT * FROM `tb_product` WHERE `category` LIKE '3' OR `category` LIKE '2' order by rand() limit 15";
							$res=mysqli_query($con,$x);
							while($row=mysqli_fetch_array($res))
										{
											$x1="select * from tb_category where sno='$row[category]' ";
							$res1=mysqli_query($con,$x1);
				...
				<div class="project-block">
					<div class="inner-box">
						<div class="image">
							<img src="admin/<?php echo $row['image']; ?>" alt="" / style="border:1px solid #000;">
							<!-- Overlay Box -->
							<div class="overlay-box">
								<div class="icons">
									<a class="plus" href="admin/<?php echo $row['image']; ?>" data-fancybox="gallery-1" data-caption=""><span class="flaticon-plus-symbol"></span></a>
									<a class="link" href="product_detail.php?x=<?php echo $row['sno']; ?>"><span class="icon flaticon-link"></span></a>
								</div>
								<div class="overlay-inner">
									<div class="overlay-content">
										<h3><a href="product_detail.php?x=<?php echo $row['sno']; ?>"><?php echo $row['product']; ?></a></h3>
										<div class="category"><?php echo $row1['category']; ?></div>
									</div>
								</div>
							</div>	
