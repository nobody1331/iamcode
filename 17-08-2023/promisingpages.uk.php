...
<?php
session_start();
include_once('models/masterfunctions.php');
$banner = MasterFunctions::get_banner_images();

$downloads = MasterFunctions::get_downloads();
?>
<!doctype html>
<html lang="en">
...
<?php include_once('header.php'); ?>
    ...
    <section id="slider-part" class="slider-active">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(<?= SERVER_BASE_URL.'uploads/banner/'.$row['image']; ?>)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
                            <h1 data-animation="bounceInLeft" data-delay="1s">More than 5,000+ promising to develop your skills</h1>
                            <a data-animation="fadeInUp" data-delay="1.3s" href="contact.php" class="main-btn">Contact Us</a>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-30">
                    <!-- <div class="category-2-items pt-30">
                        <div class="row">
                            <div class="col-md-6"> -->
                                <h3 > Sample </h3>
                                <h4 class="pt-20">Download Now </h4>
                                <p>Download samples of our work here. you can also
request for more samples by filling up the form in
our contact us page.</p>
<div class="main-form">

             <?php foreach ($downloads as $key => $row) : ?>
                            <form action="#">
                                <div class="single-form pt-20">
                                    <button class="main-btn" type="button"><a href="<?= SERVER_BASE_URL.'uploads/downloads/'.$row['image']; ?>" target="_blank">Download Now</a></button>
                                </div>
                            </form>
                             <?php endforeach; ?>
                        </div>
                        ...
                        <div class="main-form">
                            <form action="mail.php" method="post">
                                <div class="single-form">
                                    <input type="text" id="name" name="name" placeholder="Your University name">
                                </div>
                                <div class="single-form">
                                    <input type="email" id="email" name="email" placeholder="Your Mail">
                                </div>
                                <div class="single-form">
                                   <input type="text" name="contact" pattern="^(0|[1-9][0-9]*)$" maxlength="10" placeholder="Your Contact Number" required="">
                                </div>
                                 <div class="single-form">
                                    <input type="text" id="academicLevel" name="academicLevel" placeholder="Your AcademicLevel">
                                </div>
                                 <div class="single-form ">
                                    <input type="text" id="DesiredService" name="DesiredService" placeholder="Your Desired Service Required">
                                </div>
                                 <div class="single-form ">
                                    <input type="text" id="topic" name="topic"  placeholder="Your Topic">
                                </div>
                                <div class="single-form ">
                                    <input type="text" id="submission" name="submission" placeholder="Date of Submission (DD-MM-YYYY)" required="">
    ...
    <!--====== promising PART START ======-->
    
       <section id="event-page" class="pt-30 pb-120 gray-bg">
        <div class="container">
               ...
               <div class="col-lg-4">
                   <div class="single-event-list-2 mt-30">
                       ...
                       <div class="event-cont">
                            ...
                            <p class="mt-2">We know the value of on-time submission and for this purpose we always deliver your order before deadline</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-4">
                   <div class="single-event-list-2 mt-30">
                       ...
                       <div class="event-cont">
                            ...
                            <p class="mt-2">Our target market is student and we know the financial condition, thats why we offer low prices so everyone can afford</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-4">
                   <div class="single-event-list-2 mt-30">
                       ...
                       <div class="event-cont">
                            ...
                            <p class="mt-2">We always provide exceptional quality assistance to the students
for their university or college project.</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-4">
                   <div class="single-event-list-2 mt-30">
                       ...
                       <div class="event-cont">
                            <h4>Plagriarism</h4>
                            <p  class="mt-2">We have solid policy regarding plagiarism, our quality department check every mistake and make correction.</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-4">
                   <div class="single-event-list-2 mt-30">
                       ...
                       <div class="event-cont">
                            <h4>Free Revision</h4>
                            <p class="mt-2">We never forget our customer thats why we offer free revision for those clients who want to make some changes.</p>
                       </div>
                   </div>
               </div>
               <div class="col-lg-4">
                   <div class="single-event-list-2 mt-30">
                       ...
                       <div class="event-cont">
                          <h4>24 Hour Support</h4>
                            <p class="mt-2" >We are open 24 hours 7 days in a week for your support, our talented staff resolve your issues in a minutes.</p>
                       </div>
                   </div>
               </div>
        ...
        <div class="container">
          ...
          <div class="section-title mt-50">
                ...
                <div class="col-lg-12 mt-50">
                    <h3 class="text-center">How should I use the model answer?</h3>
                    <div class="teachers-right mt-50">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="dashboard-cont">
                                    <div class="single-dashboard pt-40">
                                        <h5>When you receive your order from us:</h5>
                                        <p><i class="fa fa-angle-right pr-3"></i>Read through the model answer so that you understand how the question has been answered.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>Try to develop your own ideas and arguments.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i> Look up the material that your writer has found, and use this to find more material.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>Use the essay that our researcher has produced as a guide to producing your own work.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>Ensure that your final piece of work is 100% original and formulated using your own creative thoughts.</p>
                                        <p>This might take a bit more effort than simply submitting our work as your own, but it does mean that you’ll learn the topic and will be prepared for your examinations.</p>
                                    </div> 
                                     <!-- single dashboard -->
                                </div> <!-- dashboard cont -->
                            </div>
                ...
                <div class="col-lg-12 mt-50">
                    <h3 class="text-center">Will I get caught if I hand in the work?</h3>
                    <div class="teachers-right mt-50">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="dashboard-cont">
                                    <div class="single-dashboard pt-40">
                                        <h5>As tempting as it may be to submit your custom written essay, dissertation, or assignment as your own, this isn’t how our service is designed to be used.</h5>
                                        <p><i class="fa fa-angle-right pr-3"></i>Our work is 100% original, written to your specification, and will never be uploaded to the web.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>This means that if the custom work was handed in to a university then the university would not know (from using a plagiarism scanner alone) that you have used our services.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i> The custom research we provide will be of far greater benefit to you if you use it in accordance with this fair use policy.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>You’ll improve your grade, learn how to write a great essay and feel a great sense of satisfaction for having done a good job, on your own merit.</p>
                                    </div> 
                                     <!-- single dashboard -->
                                </div> <!-- dashboard cont -->
                            </div>
                ...
                <div class="col-lg-12 mt-50">
                    <h3 class="text-center">So why should I buy a model answer?</h3>
                    <div class="teachers-right mt-50">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="dashboard-cont">
                                    <div class="single-dashboard pt-40">
                                        <h5>To make the most of any of our model answer services, you should take the work we provide as a basis for your own further research, and build on the knowledge to create your own original work.</h5>
                                        <p><i class="fa fa-angle-right pr-3"></i>Save precious time as students do not have to read through a vast amount of research material which may or may not be relevant.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>Provides students with the full list of references which most students struggle write.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i> One of the best ways of learning as students get a model essay and practical knowledge is easy to acquire.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>Custom model essays are best research tools a student could wish for.</p>
                                        <p><i class="fa fa-angle-right pr-3"></i>Students can learn different new ways of tackling the questions.</p>
                                        <p>If you have any further questions about our fair use policy, or terms and conditions, please don’t hesitate to contact a member of our friendly Customer Experience team.</p>
                                    </div> 
                                     <!-- single dashboard -->
                                </div> <!-- dashboard cont -->
                            </div>
