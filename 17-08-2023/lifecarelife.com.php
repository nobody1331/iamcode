...
include('db.php');
$nm=$_COOKIE["nm"];
$laser_query=mysqli_query($as,"select * from `admin` where `admlogin`='$nm'");
$fetch_laserid=mysqli_fetch_array($laser_query);
$lnou=$fetch_laserid['lno'];
$adminid=$fetch_laserid['id'];
$gm=$fetch_laserid['gm'];
include('header.php');
...
?>
	...
	?>
            <div class="row">
                <div class="col-md-6 banner-left d-flex align-items-center pl-lg-5">
                    <div>
                        <h3 class="text-white mb-4">Welcome to 
 <br>
                             <span class="type-js"><span class="text-js">Life care Life !</span></span></h3>
                        <p class="banner-text text-white">
						online solution to all your healthcare needs. - <span> 24 x 7
</span>
                        </p><br>
				<center>		<img src='images/Screenshot_4.png' width='80%' ></img></center><br>
                        <a class="btn btn-style-white btn-style-border mt-5" href="#">Learn More</a>
                    </div>
                </div>
        ...
        <div class="team py-5">
            <div class="container py-md-5 py-4">
                <h3 class="title-style text-white text-center">Our Services</h3>
                <div class="row team-row mt-md-5 mt-4">
				
				<a class="team-title" href="hosplist.php">
                    <div class="col-lg-6 col-6 team-wrap">
                        <div class="team-member text-center">
                            <div class="team-img">
                                <img src="images/doctor (1).png" alt="" class="radius-image">
                            </div>
                        Doctors/Hospitals
							</a>
                    ...
                    <a class="btn btn-style-white btn-style-border mt-5" href="hosplist.php">View More</a>
					...
					<!--a class="team-title" href="path_booking.php?tp=Laboratory">
                    <div class="col-lg-3 col-6 team-wrap">
                        <div class="team-member text-center">
                            <div class="team-img">
                                <img src="images/3468258.png" alt="" class="radius-image">
                            </div>
                           Pathalogy
							</a>
                            <div class="team-details text-center">
                    ...
                    <a class="btn btn-style-white btn-style-border mt-5" href="path_booking.php?tp=Laboratory">View More</a>
 ...
 include('store/accounts/db1.php');
$qradds1="SELECT * from `category` where `top`='1' and status=1 order by sort_order ";
$resadds1=mysqli_query($con,$qradds1);
for($i=1;$i<=mysqli_num_rows($resadds1);$i++)
{	
	$arr=mysqli_fetch_array($resadds1);
	$category_id=$arr['category_id'];
	$image=$arr['image'];
$qradds1x="SELECT * from `category_description` where `category_id`='$category_id' ";
$resadds1x=mysqli_query($con,$qradds1x);
 
	$arrx=mysqli_fetch_array($resadds1x);
	$sname=$arrx['name'];	

?>				
					<a class="team-title" href="view.php?tp=<?php echo $sname; ?>">
                    <div class="col-lg-6 col-6 team-wrap">
                        <div class="team-member text-center">
                            <div class="team-img">
                                <img src="store/image/<?php echo $image; ?>" alt="" class="radius-image">
                            </div>
                            <?php echo $sname; ?>
							</a>
                            <div class="team-details text-center">
                    ...
                    <a class="btn btn-style-white btn-style-border mt-5" href="view.php?tp=<?php echo $sname; ?>">View More</a>
...
?>	               
    ...
    <!-- //banner section 
	  ...
	  <h3 class="title-style text-white text-center">Laboratory Packages</h3>
<?php

$laser_query=mysqli_query($as,"select * from `package` where `sex`!=''");
for($i=0;$i<=mysqli_num_rows($laser_query)-1;$i++)
{
$fetch_laserid=mysqli_fetch_array($laser_query);
  $table_id=$fetch_laserid['id'];
 $name=$fetch_laserid['name'];
 $amount=$fetch_laserid['amount'];
 $dper=$fetch_laserid['dper'];
 echo "<br>";
 if($dper>=1){$amt=$amount-($amount*$dper/100);}
 else{$amt=$amount;}
$qraddq="SELECT * from `pack_list` where `pack_id`='$table_id'";
$resaddq=mysqli_query($as, $qraddq);
$numt=mysqli_num_rows($resaddq);
 ?>
 <div class="col-md-10 ">
            <div class="">
                <div class="">
                    <div class="contact-info">
											 <a href="path_booking.php?table_id=<?php echo $table_id; ?> " class="b-link-stripe b-animate-go  swipebox">

						<table width='99%' border='0'><tr>
						<td width='100%'><h4><font color='orange'><?php echo $name; ?></font></h4></td>
						
						</tr>
						</table>
						<table width='99%'><tr><td width='15%' align='center'>
										<h5>₹<?php echo $amt; ?></h5></td>
										
										<?php
										if($dper>=1)
										{
											echo "<td width='15%' align='center'><h5><del>₹ $amount</del></h5></td>
											<td width='30%'  > <span style='background-color: #FFCC66'><h5>$dper % off</h5></span> </td>";
										}
										?>
										</tr></table>
										<table width='99%'><tr>
										<td width='15%'></td>
										<td width='50%' align='center'><h6><?php echo $numt; ?> Lab Tests</h6></td>
										<td align='center'><button class="btn btn-warning">Book Now</button></td>
										</tr></table>
										</a>
        ...
        <div class="container py-md-5 py-4">
            <div class="row">
                <div class="col-md-7 pr-lg-5">
                    <h5 class="text-new mb-4">Hello. <br>We're dedicated to giving you the very best of daily use Products/Services !
                    </h5>
                    <p class="mb-3">With a focus on dependability, customer service and uniqueness.
                    </p>
                    <p>We hope you enjoy our Products/Services as much as we enjoy offering them to you. If you have any questions or comments, please don't hesitate to contact us.</p>
                ...
                <div class="col-md-5 mt-md-0 mt-5">
                    ...
                    <div class="counter text-center mt-5">
                        ...
                        <p class="count-text mt-2">verified shops</p>
                    </div>
                    <div class="counter text-center mt-5">
